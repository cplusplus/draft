...
# Add the stylesheet
s,<HEAD>,<HEAD><style type="text/css">.latex {color: #444444; background: #dddddd; font-family: monospace; }</style>,

# Inline code
s,<TT>,<span class="latex">\\tcode{</span><TT>,g
s,</TT>,</TT><span class="latex">}</span>,g

# Bullets
#
# Disabled for now, since these don't interact very well with bnf grammars and things
#
# s,<UL>,<span class="latex">\\begin{itemize}</span><UL>,g
# s,<LI>,<LI><span class="latex">\\item</span>,g
# s,</UL>,</UL><span class="latex">\\end{itemize}</span>,g

# Notes and examples
s,\[<I>Note:</I>,<span class="latex">\\enternote</span>,g
s,&#8212;<I>end note</I>\],<span class="latex">\\exitnote</span>,g
s,\[<I>Example:</I>,<span class="latex">\\enterexample</span>,g
s,&#8212;<I>end example</I>\],<span class="latex">\\exitexample</span>,g

# Footnotes
s,<I>\[Footnote:</I>,<span class="latex">\\footnote{</span>,g
s,\[<I>Footnote:</I>,<span class="latex">\\footnote{</span>,g
