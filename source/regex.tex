%!TEX root = std.tex
\subclause0[re]{Regular expressions library}
\indextext{regular expression|(}

\subclause1[re.general]{General}
...
\subclause1[re.req]{Requirements}
...
\subclause1[re.syn]{Header \tcode{<regex>} synopsis}
...
\subclause1[re.const]{Namespace \tcode{std::regex_constants}}

\subclause2[re.const.general]{General}
...
\subclause2[re.synopt]{Bitmask type \tcode{syntax_option_type}}
...
\subclause2[re.matchflag]{Bitmask type \tcode{match_flag_type}}
...
\subclause2[re.err]{Implementation-defined \tcode{error_type}}
...
\subclause1[re.badexp]{Class \tcode{regex_error}}
...
\subclause1[re.traits]{Class template \tcode{regex_traits}}
...
\subclause1[re.regex]{Class template \tcode{basic_regex}}

\subclause2[re.regex.general]{General}
\indexlibraryglobal{basic_regex}%
...
\subclause2[re.regex.construct]{Constructors}
...
\subclause2[re.regex.assign]{Assignment}
...
\subclause2[re.regex.operations]{Constant operations}
...
\subclause2[re.regex.locale]{Locale}%
\indexlibraryglobal{locale}
...
\subclause2[re.regex.nonmemb]{Non-member functions}
...
\subclause1[re.submatch]{Class template \tcode{sub_match}}

\subclause2[re.submatch.general]{General}
\pnum
...
\subclause2[re.submatch.members]{Members}
...
\subclause2[re.submatch.op]{Non-member operators}
...
\subclause1[re.results]{Class template \tcode{match_results}}

\subclause2[re.results.general]{General}
\pnum
...
\subclause2[re.results.const]{Constructors}
...
\subclause2[re.results.state]{State}
...
\subclause2[re.results.size]{Size}
...
\subclause2[re.results.acc]{Element access}
...
\subclause2[re.results.form]{Formatting}
...
\subclause2[re.results.all]{Allocator}%
...
\subclause2[re.results.swap]{Swap}
...
\subclause2[re.results.nonmember]{Non-member functions}
...
\subclause1[re.alg]{Regular expression algorithms}

\subclause2[re.except]{Exceptions}
\pnum
...
\subclause2[re.alg.match]{\tcode{regex_match}}
...
\subclause2[re.alg.search]{\tcode{regex_search}}
...
\subclause2[re.alg.replace]{\tcode{regex_replace}}
...
\subclause1[re.iter]{Regular expression iterators}

\subclause2[re.regiter]{Class template \tcode{regex_iterator}}

\subclause3[re.regiter.general]{General}
\pnum
...
\subclause3[re.regiter.cnstr]{Constructors}
...
\subclause3[re.regiter.comp]{Comparisons}
...
\subclause3[re.regiter.deref]{Indirection}
...
\subclause3[re.regiter.incr]{Increment}
...
\subclause2[re.tokiter]{Class template \tcode{regex_token_iterator}}

\subclause3[re.tokiter.general]{General}
...
\subclause3[re.tokiter.cnstr]{Constructors}
...
\subclause3[re.tokiter.comp]{Comparisons}
...
\subclause3[re.tokiter.deref]{Indirection}
...
\subclause3[re.tokiter.incr]{Increment}
...
\subclause1[re.grammar]{Modified ECMAScript regular expression grammar}
