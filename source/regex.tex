...
\indextext{locale}%
In \tref{re:RegexpTraits} \tcode{X} denotes a traits class
...
\tref{re:syntaxoption}.  A valid value of type
...
\pnum
\postconditions  \tcode{getloc() == loc}.
\end{itemdescr}
...
\pnum
\requires
\tcode{InputIterator} shall satisfy the
...
\pnum\postconditions  \tcode{*this} contains the regular expression
...
satisfying the same postconditions as \tref{re:results:assign}. Additionally,
...
function are indicated in \tref{re:results:assign}.
\end{itemdescr}
...
are indicated in \tref{re:results:assign}.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\requires \tcode{ready() == true} and \tcode{OutputIter} shall satisfy the requirements for a
...
\pnum\postconditions  \tcode{*this} contains the sequence of matched
...
\pnum
\requires
The type \tcode{BidirectionalIterator} shall satisfy the
...
\pnum
\requires
Type \tcode{BidirectionalIterator} shall satisfy the
\oldconcept{BidirectionalIterator} requirements\iref{bidirectional.iterators}.
