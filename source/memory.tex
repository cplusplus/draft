...
\pnum
\mandates
\tcode{T} is an implicit-lifetime type.
...
as follows:
% FIXME: One expects a process to follow; what are we saying here?
an object \placeholder{a} of type \tcode{T}, whose address is \tcode{p}, and
...
\pnum
\returns
% FIXME: What is "a"? We need to introduce "a" outside of the \effects clause
A pointer to \placeholder{a}.
\end{itemdescr}
...
\pnum
\constraints
\tcode{T} is a specialization of \tcode{pair}, and
