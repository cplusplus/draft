%!TEX root = std.tex
\subclause0[localization]{Localization library}

\subclause1[localization.general]{General}
...
\subclause1[locale.syn]{Header \tcode{<locale>} synopsis}
...
\subclause1[locales]{Locales}

\subclause2[locale]{Class \tcode{locale}}

\subclause3[locale.general]{General}
...
\subclause3[locale.types]{Types}

\subclause4[locale.category]{Type \tcode{locale::category}}
...
\subclause4[locale.facet]{Class \tcode{locale::facet}}
...
\subclause4[locale.id]{Class \tcode{locale::id}}
...
\subclause3[locale.cons]{Constructors and destructor}
...
\subclause3[locale.members]{Members}
...
\subclause3[locale.operators]{Operators}
...
\subclause3[locale.statics]{Static members}
...
\subclause2[locale.global.templates]{\tcode{locale} globals}
...
\subclause2[locale.convenience]{Convenience interfaces}

\subclause3[classification]{Character classification}
...
\subclause3[conversions.character]{Character conversions}
...
\subclause1[locale.categories]{Standard \tcode{locale} categories}

\subclause2[locale.categories.general]{General}
...
\subclause2[category.ctype]{The \tcode{ctype} category}

\subclause3[category.ctype.general]{General}
...
\subclause3[locale.ctype]{Class template \tcode{ctype}}

\subclause4[locale.ctype.general]{General}
...
\subclause4[locale.ctype.members]{\tcode{ctype} members}
...
\subclause4[locale.ctype.virtuals]{\tcode{ctype} virtual functions}
...
\subclause3[locale.ctype.byname]{Class template \tcode{ctype_byname}}
...
\subclause3[facet.ctype.special]{\tcode{ctype<char>} specialization}

\subclause4[facet.ctype.special.general]{General}
...
\subclause4[facet.ctype.char.dtor]{Destructor}
...
\subclause4[facet.ctype.char.members]{Members}
...
\subclause4[facet.ctype.char.statics]{Static members}
...
\subclause4[facet.ctype.char.virtuals]{Virtual functions}
...
\subclause3[locale.codecvt]{Class template \tcode{codecvt}}

\subclause4[locale.codecvt.general]{General}
...
\subclause4[locale.codecvt.members]{Members}
...
\subclause4[locale.codecvt.virtuals]{Virtual functions}
...
\subclause3[locale.codecvt.byname]{Class template \tcode{codecvt_byname}}
...
\subclause2[category.numeric]{The numeric category}

\subclause3[category.numeric.general]{General}
...
\subclause3[locale.num.get]{Class template \tcode{num_get}}

\subclause4[locale.num.get.general]{General}
...
\subclause4[facet.num.get.members]{Members}
...
\subclause4[facet.num.get.virtuals]{Virtual functions}
...
\subclause3[locale.nm.put]{Class template \tcode{num_put}}

\subclause4[locale.nm.put.general]{General}
...
\subclause4[facet.num.put.members]{Members}
...
\subclause4[facet.num.put.virtuals]{Virtual functions}
...
\subclause2[facet.numpunct]{The numeric punctuation facet}

\subclause3[locale.numpunct]{Class template \tcode{numpunct}}

\subclause4[locale.numpunct.general]{General}
...
\subclause4[facet.numpunct.members]{Members}
...
\subclause4[facet.numpunct.virtuals]{Virtual functions}
...
\subclause3[locale.numpunct.byname]{Class template \tcode{numpunct_byname}}
...
\subclause2[category.collate]{The collate category}

\subclause3[locale.collate]{Class template \tcode{collate}}

\subclause4[locale.collate.general]{General}
...
\subclause4[locale.collate.members]{Members}
...
\subclause4[locale.collate.virtuals]{Virtual functions}
...
\subclause3[locale.collate.byname]{Class template \tcode{collate_byname}}
...
\subclause2[category.time]{The time category}

\subclause3[category.time.general]{General}
...
\subclause3[locale.time.get]{Class template \tcode{time_get}}

\subclause4[locale.time.get.general]{General}
...
\subclause4[locale.time.get.members]{Members}
...
\subclause4[locale.time.get.virtuals]{Virtual functions}
...
\subclause3[locale.time.get.byname]{Class template \tcode{time_get_byname}}
...
\subclause3[locale.time.put]{Class template \tcode{time_put}}
...
\subclause4[locale.time.put.members]{Members}
...
\subclause4[locale.time.put.virtuals]{Virtual functions}
...
\subclause3[locale.time.put.byname]{Class template \tcode{time_put_byname}}
...
\subclause2[category.monetary]{The monetary category}

\subclause3[category.monetary.general]{General}
...
\subclause3[locale.money.get]{Class template \tcode{money_get}}
...
\subclause4[locale.money.get.members]{Members}
...
\subclause4[locale.money.get.virtuals]{Virtual functions}
...
\subclause3[locale.money.put]{Class template \tcode{money_put}}
...
\subclause4[locale.money.put.members]{Members}
...
\subclause4[locale.money.put.virtuals]{Virtual functions}
...
\subclause3[locale.moneypunct]{Class template \tcode{moneypunct}}

\subclause4[locale.moneypunct.general]{General}
...
\subclause4[locale.moneypunct.members]{Members}
...
\subclause4[locale.moneypunct.virtuals]{Virtual functions}
...
\subclause3[locale.moneypunct.byname]{Class template \tcode{moneypunct_byname}}
...
\subclause2[category.messages]{The message retrieval category}

\subclause3[category.messages.general]{General}

\pnum
Class \tcode{messages<charT>}
implements retrieval of strings from message catalogs.

\subclause3[locale.messages]{Class template \tcode{messages}}

\subclause4[locale.messages.general]{General}
...
\subclause4[locale.messages.members]{Members}
...
\subclause4[locale.messages.virtuals]{Virtual functions}
...
\subclause3[locale.messages.byname]{Class template \tcode{messages_byname}}
...
\subclause1[c.locales]{C library locales}

\subclause2[clocale.syn]{Header \tcode{<clocale>} synopsis}
...
\subclause2[clocale.data.races]{Data races}
