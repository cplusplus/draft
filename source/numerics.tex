...
\pnum
The contents of the header \tcode{<cfenv>} are the same as
the C standard library header \tcode{<fenv.h>.}
The meaning of the contents of this header is the same as in 7.6 in the C standard library.
\begin{note}
...
namespace std {
  ...
  float fabs(float x);  // see \ref{c.math}
  double fabs(double x);
  long double fabs(long double x);  // see \ref{c.math}
  float fabsf(float x);
...
\pnum
The contents of the header \tcode{<cmath>} are the same as the C standard library
header \tcode{<math.h>}, with the addition of 
...
\end{note}
The meaning of the contents of this header is the same as in 7.12 in the C standard library.
...
\pnum
The contents of the header \tcode{<cstdlib>} are the same as the C standard library
header \tcode{<stdlib.h>}.
\begin{note}
Several functions have additional overloads in this International Standard,
but they have the same behavior as in the C standard.
\end{note}
The meaning of the contents of this header is the same as in 7.22 in the C standard library.
