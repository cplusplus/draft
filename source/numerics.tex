...
\indexlibrary{\idxcode{piecewise_constant_distribution}!\idxcode{densitities}}%
\indexlibrary{\idxcode{densitities}!\idxcode{piecewise_constant_distribution}}%
\begin{itemdecl}
vector<result_type> densities() const;
\end{itemdecl}
...
\indexlibrary{\idxcode{piecewise_linear_distribution}!\idxcode{densitities}}%
\indexlibrary{\idxcode{densitities}!\idxcode{piecewise_linear_distribution}}%
\begin{itemdecl}
vector<result_type> densities() const;
\end{itemdecl}
...
template object which has reference semantics to the orginal array, working in
