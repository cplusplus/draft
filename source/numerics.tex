...
\pnum
\returns
The value given by \eqref{sf.cmath.assoc.laguerre},
where
$n$ is \tcode{n},
$m$ is \tcode{m}, and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.assoc.legendre},
where
$l$ is \tcode{l},
$m$ is \tcode{m}, and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.beta},
where
$x$ is \tcode{x} and
$y$ is \tcode{y}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.comp.ellint.1},
where
$k$ is \tcode{k}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.comp.ellint.2},
where
$k$ is \tcode{k}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.comp.ellint.3},
where
$k$ is \tcode{k} and
$\nu$ is \tcode{nu}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.cyl.bessel.i},
where
$\nu$ is \tcode{nu} and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.cyl.bessel.j},
where
$\nu$ is \tcode{nu} and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.cyl.bessel.k},
where
$\nu$ is \tcode{nu} and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.cyl.neumann},
where
$\nu$ is \tcode{nu} and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.ellint.1},
where
$k$ is \tcode{k} and
$\phi$ is \tcode{phi}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.ellint.2},
where
$k$ is \tcode{k} and
$\phi$ is \tcode{phi}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.ellint.3},
where
$\nu$ is \tcode{nu},
$k$ is \tcode{k}, and
$\phi$ is \tcode{phi}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.expint},
where
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.hermite},
where
$n$ is \tcode{n} and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.laguerre},
where
$n$ is \tcode{n} and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.legendre},
where
$l$ is \tcode{l} and
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.riemann.zeta},
where
$x$ is \tcode{x}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.sph.bessel},
where
$n$ is \tcode{n} and
$x$ is \tcode{x}.
...
\pnum
\returns
$\mathsf{Y}_\ell^m(\theta, 0)$ using \eqref{sf.cmath.sph.legendre},
where
$l$ is \tcode{l},
$m$ is \tcode{m}, and
$\theta$ is \tcode{theta}.
...
\pnum
\returns
The value given by \eqref{sf.cmath.sph.neumann},
where
$n$ is \tcode{n} and
$x$ is \tcode{x}.
