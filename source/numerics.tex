...
\pnum\requires
  ...
  of an input iterator (\tref{iterator.input.requirements}) type.
  Moreover,
...
\requires
\begin{itemize}
\item \tcode{T} shall be \tcode{MoveConstructible} (\tref{moveconstructible}).
...
\indextext{Eulerian integral of the first kind|see{beta}}%
