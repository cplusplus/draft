...
\pnum
The contents of the headers \tcode{<cmath>} and \tcode{<cstdlib>}
are the same as the C standard library headers
\tcode{<math.h>}
and
\tcode{<stdlib.h>}
...
but they have the same behavior as in the C standard.
\end{note}
...
namespace std {
  float acos(float x);  // see \ref{c.math}
  double acos(double x);
  long double acos(long double x);  // see \ref{c.math}
  float acosf(float x);
  long double acosl(long double x);

  float asin(float x);  // see \ref{c.math}
  double asin(double x);
  long double asin(long double x);  // see \ref{c.math}
  float asinf(float x);
  long double asinl(long double x);

  float atan(float x);  // see \ref{c.math}
  double atan(double x);
  long double atan(long double x);  // see \ref{c.math}
  float atanf(float x);
  long double atanl(long double x);

  float atan2(float y, float x);  // see \ref{c.math}
  double atan2(double y, double x);
  long double atan2(long double y, long double x);  // see \ref{c.math}
  float atan2f(float y, float x);
  long double atan2l(long double y, long double x);

  float cos(float x);  // see \ref{c.math}
  double cos(double x);
  long double cos(long double x);  // see \ref{c.math}
  float cosf(float x);
  long double cosl(long double x);

  float sin(float x);  // see \ref{c.math}
  double sin(double x);
  long double sin(long double x);  // see \ref{c.math}
  float sinf(float x);
  long double sinl(long double x);

  float tan(float x);  // see \ref{c.math}
  double tan(double x);
  long double tan(long double x);  // see \ref{c.math}
  float tanf(float x);
  long double tanl(long double x);

  float acosh(float x);  // see \ref{c.math}
  double acosh(double x);
  long double acosh(long double x);  // see \ref{c.math}
  float acoshf(float x);
  long double acoshl(long double x);

  float asinh(float x);  // see \ref{c.math}
  double asinh(double x);
  long double asinh(long double x);  // see \ref{c.math}
  float asinhf(float x);
  long double asinhl(long double x);

  float atanh(float x);  // see \ref{c.math}
  double atanh(double x);
  long double atanh(long double x);  // see \ref{c.math}
  float atanhf(float x);
  long double atanhl(long double x);

  float cosh(float x);  // see \ref{c.math}
  double cosh(double x);
  long double cosh(long double x);  // see \ref{c.math}
  float coshf(float x);
  long double coshl(long double x);

  float sinh(float x);  // see \ref{c.math}
  double sinh(double x);
  long double sinh(long double x);  // see \ref{c.math}
  float sinhf(float x);
  long double sinhl(long double x);

  float tanh(float x);  // see \ref{c.math}
  double tanh(double x);
  long double tanh(long double x);  // see \ref{c.math}
  float tanhf(float x);
  long double tanhl(long double x);

  float exp(float x);  // see \ref{c.math}
  double exp(double x);
  long double exp(long double x);  // see \ref{c.math}
  float expf(float x);
  long double expl(long double x);

  float exp2(float x);  // see \ref{c.math}
  double exp2(double x);
  long double exp2(long double x);  // see \ref{c.math}
  float exp2f(float x);
  long double exp2l(long double x);

  float expm1(float x);  // see \ref{c.math}
  double expm1(double x);
  long double expm1(long double x);  // see \ref{c.math}
  float expm1f(float x);
  long double expm1l(long double x);

  float frexp(float value, int* exp);  // see \ref{c.math}
  double frexp(double value, int* exp);
  long double frexp(long double value, int* exp);  // see \ref{c.math}
  float frexpf(float value, int* exp);
  long double frexpl(long double value, int* exp);

  int ilogb(float x);  // see \ref{c.math}
  int ilogb(double x);
  int ilogb(long double x);  // see \ref{c.math}
  int ilogbf(float x);
  int ilogbl(long double x);

  float ldexp(float x, int exp);  // see \ref{c.math}
  double ldexp(double x, int exp);
  long double ldexp(long double x, int exp);  // see \ref{c.math}
  float ldexpf(float x, int exp);
  long double ldexpl(long double x, int exp);

  float log(float x);  // see \ref{c.math}
  double log(double x);
  long double log(long double x);  // see \ref{c.math}
  float logf(float x);
  long double logl(long double x);

  float log10(float x);  // see \ref{c.math}
  double log10(double x);
  long double log10(long double x);  // see \ref{c.math}
  float log10f(float x);
  long double log10l(long double x);

  float log1p(float x);  // see \ref{c.math}
  double log1p(double x);
  long double log1p(long double x);  // see \ref{c.math}
  float log1pf(float x);
  long double log1pl(long double x);

  float log2(float x);  // see \ref{c.math}
  double log2(double x);
  long double log2(long double x);  // see \ref{c.math}
  float log2f(float x);
  long double log2l(long double x);

  float logb(float x);  // see \ref{c.math}
  double logb(double x);
  long double logb(long double x);  // see \ref{c.math}
  float logbf(float x);
  long double logbl(long double x);

  float modf(float value, float* iptr);  // see \ref{c.math}
  double modf(double value, double* iptr);
  long double modf(long double value, long double* iptr);  // see \ref{c.math}
  float modff(float value, float* iptr);
  long double modfl(long double value, long double* iptr);

  float scalbn(float x, int n);  // see \ref{c.math}
  double scalbn(double x, int n);
  long double scalbn(long double x, int n);  // see \ref{c.math}
  float scalbnf(float x, int n);
  long double scalbnl(long double x, int n);

  float scalbln(float x, long int n);  // see \ref{c.math}
  double scalbln(double x, long int n);
  long double scalbln(long double x, long int n);  // see \ref{c.math}
  float scalblnf(float x, long int n);
  long double scalblnl(long double x, long int n);

  float cbrt(float x);  // see \ref{c.math}
  double cbrt(double x);
  long double cbrt(long double x);  // see \ref{c.math}
  float cbrtf(float x);
  long double cbrtl(long double x);

  int abs(int j);  // see \ref{c.math}
  long int abs(long int j);  // see \ref{c.math}
  long long int abs(long long int j);  // see \ref{c.math}
  float abs(float j);  // see \ref{c.math}
  double abs(double j);
  long double abs(long double j);  // see \ref{c.math}
  float fabs(float x);
  ...
  float hypot(float x, float y);  // see \ref{c.math}
  double hypot(double x, double y);
  long double hypot(double x, double y);  // see \ref{c.math}
  float hypotf(float x, float y);
  long double hypotl(long double x, long double y);

  float hypot(float x, float y, float z);  // see \ref{c.math}
  double hypot(double x, double y, double z);  // see \ref{c.math}
  long double hypot(long double x, long double y, long double z);  // see \ref{c.math}

  float pow(float x, float y);  // see \ref{c.math}
  double pow(double x, double y);
  long double pow(long double x, long double y);  // see \ref{c.math}
  float powf(float x, float y);
  long double powl(long double x, long double y);

  float sqrt(float x);  // see \ref{c.math}
  double sqrt(double x);
  long double sqrt(long double x);  // see \ref{c.math}
  float sqrtf(float x);
  long double sqrtl(long double x);

  float erf(float x);  // see \ref{c.math}
  double erf(double x);
  long double erf(long double x);  // see \ref{c.math}
  float erff(float x);
  long double erfl(long double x);

  float erfc(float x);  // see \ref{c.math}
  double erfc(double x);
  long double erfc(long double x);  // see \ref{c.math}
  float erfcf(float x);
  long double erfcl(long double x);

  float lgamma(float x);  // see \ref{c.math}
  double lgamma(double x);
  long double lgamma(long double x);  // see \ref{c.math}
  float lgammaf(float x);
  long double lgammal(long double x);

  float tgamma(float x);  // see \ref{c.math}
  double tgamma(double x);
  long double tgamma(long double x);  // see \ref{c.math}
  float tgammaf(float x);
  long double tgammal(long double x);

  float ceil(float x);  // see \ref{c.math}
  double ceil(double x);
  long double ceil(long double x);  // see \ref{c.math}
  float ceilf(float x);
  long double ceill(long double x);

  float floor(float x);  // see \ref{c.math}
  double floor(double x);
  long double floor(long double x);  // see \ref{c.math}
  float floorf(float x);
  long double floorl(long double x);

  float nearbyint(float x);  // see \ref{c.math}
  double nearbyint(double x);
  long double nearbyint(long double x);  // see \ref{c.math}
  float nearbyintf(float x);
  long double nearbyintl(long double x);

  float rint(float x);  // see \ref{c.math}
  double rint(double x);
  long double rint(long double x);  // see \ref{c.math}
  float rintf(float x);
  long double rintl(long double x);

  long int lrint(float x);  // see \ref{c.math}
  long int lrint(double x);
  long int lrint(long double x);  // see \ref{c.math}
  long int lrintf(float x);
  long int lrintl(long double x);

  long long int llrint(float x);  // see \ref{c.math}
  long long int llrint(double x);
  long long int llrint(long double x);  // see \ref{c.math}
  long long int llrintf(float x);
  long long int llrintl(long double x);

  float round(float x);  // see \ref{c.math}
  double round(double x);
  long double round(long double x);  // see \ref{c.math}
  float roundf(float x);
  long double roundl(long double x);

  long int lround(float x);  // see \ref{c.math}
  long int lround(double x);
  long int lround(long double x);  // see \ref{c.math}
  long int lroundf(float x);
  long int lroundl(long double x);

  long long int llround(float x);  // see \ref{c.math}
  long long int llround(double x);
  long long int llround(long double x);  // see \ref{c.math}
  long long int llroundf(float x);
  long long int llroundl(long double x);

  float trunc(float x);  // see \ref{c.math}
  double trunc(double x);
  long double trunc(long double x);  // see \ref{c.math}
  float truncf(float x);
  long double truncl(long double x);

  float fmod(float x, float y);  // see \ref{c.math}
  double fmod(double x, double y);
  long double fmod(long double x, long double y);  // see \ref{c.math}
  float fmodf(float x, float y);
  long double fmodl(long double x, long double y);

  float remainder(float x, float y);  // see \ref{c.math}
  double remainder(double x, double y);
  long double remainder(long double x, long double y);  // see \ref{c.math}
  float remainderf(float x, float y);
  long double remainderl(long double x, long double y);

  float remquo(float x, float y, int* quo);  // see \ref{c.math}
  double remquo(double x, double y, int* quo);
  long double remquo(long double x, long double y, int* quo);  // see \ref{c.math}
  float remquof(float x, float y, int* quo);
  long double remquol(long double x, long double y, int* quo);

  float copysign(float x, float y);  // see \ref{c.math}
  double copysign(double x, double y);
  long double copysign(long double x, long double y);  // see \ref{c.math}
  ...
  float nextafter(float x, float y);  // see \ref{c.math}
  double nextafter(double x, double y);
  long double nextafter(long double x, long double y);  // see \ref{c.math}
  float nextafterf(float x, float y);
  long double nextafterl(long double x, long double y);

  float nexttoward(float x, long double y);  // see \ref{c.math}
  double nexttoward(double x, long double y);
  long double nexttoward(long double x, long double y);  // see \ref{c.math}
  float nexttowardf(float x, long double y);
  long double nexttowardl(long double x, long double y);

  float fdim(float x, float y);  // see \ref{c.math}
  double fdim(double x, double y);
  long double fdim(long double x, long double y);  // see \ref{c.math}
  float fdimf(float x, float y);
  long double fdiml(long double x, long double y);

  float fmax(float x, float y);  // see \ref{c.math}
  double fmax(double x, double y);
  long double fmax(long double x, long double y);  // see \ref{c.math}
  float fmaxf(float x, float y);
  long double fmaxl(long double x, long double y);

  float fmin(float x, float y);  // see \ref{c.math}
  double fmin(double x, double y);
  long double fmin(long double x, long double y);  // see \ref{c.math}
  float fminf(float x, float y);
  long double fminl(long double x, long double y);

  float fma(float x, float y, float z);  // see \ref{c.math}
  double fma(double x, double y, double z);
  long double fma(long double x, long double y, long double z);  // see \ref{c.math}
...
\pnum
The meaning of the contents of this header is the same as in 7.20 in the C standard.

\indextext{special functions|(}

\rSec2[sf.cmath]{Additions to header \tcode{<cmath>}}%
...
namespace std {
  ...
  float abs(float j);  // see \ref{c.math}
  double abs(double j);  // see \ref{c.math}
  long double abs(long double j);  // see \ref{c.math}

  div_t div(int numer, int denom);
  ldiv_t div(long int numer, long int denom);  // see \ref{c.math}
  lldiv_t div(long long int numer, long long int denom);  // see \ref{c.math}
...
\pnum
The meaning of the contents of this header is the same as in 7.22 in the C standard.
