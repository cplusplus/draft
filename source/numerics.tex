%!TEX root = std.tex
\subclause0[numerics]{Numerics library}

\subclause1[numerics.general]{General}
...
\subclause1[numeric.requirements]{Numeric type requirements}
...
\subclause1[cfenv]{The floating-point environment}
\subclause2[cfenv.syn]{Header \tcode{<cfenv>} synopsis}
...
\subclause2[cfenv.thread]{Threads}
...
\subclause1[complex.numbers]{Complex numbers}

\subclause2[complex.numbers.general]{General}
...
\subclause2[complex.syn]{Header \tcode{<complex>} synopsis}
...
\subclause2[complex]{Class template \tcode{complex}}
...
\subclause2[complex.special]{Specializations}
...
\subclause2[complex.members]{Member functions}
...
\subclause2[complex.member.ops]{Member operators}
...
\subclause2[complex.ops]{Non-member operations}
...
\subclause2[complex.value.ops]{Value operations}
...
\subclause2[complex.transcendentals]{Transcendentals}
...
\subclause2[cmplx.over]{Additional overloads}
...
\subclause2[complex.literals]{Suffixes for complex number literals}
...
\subclause2[bit.cast]{Function template \tcode{bit_cast}}
...
\subclause2[bit.pow.two]{Integral powers of 2}
...
\subclause2[bit.rotate]{Rotating}
...
\subclause1[rand]{Random number generation}

\subclause2[rand.general]{General}
...
\subclause2[rand.synopsis]{Header \tcode{<random>} synopsis}
...
\subclause2[rand.req]{Requirements}%
...
\subclause3[rand.req.genl]{General requirements}%
...
\subclause3[rand.req.seedseq]{Seed sequence requirements}%
...
\subclause3[rand.req.urng]{Uniform random bit generator requirements}%
...
\subclause3[rand.req.eng]{Random number engine requirements}%
...
\subclause3[rand.req.adapt]{Random number engine adaptor requirements}%
...
\subclause3[rand.req.dist]{Random number distribution requirements}%
...
\subclause2[rand.eng]{Random number engine class templates}%

\subclause3[rand.eng.general]{General}%
...
\subclause3[rand.eng.lcong]{Class template \tcode{linear_congruential_engine}}%
...
\subclause3[rand.eng.mers]{Class template \tcode{mersenne_twister_engine}}%
...
\subclause3[rand.eng.sub]{Class template \tcode{subtract_with_carry_engine}}%
...
\subclause2[rand.adapt]{Random number engine adaptor class templates}

\subclause3[rand.adapt.general]{In general}
...
\subclause3[rand.adapt.disc]{Class template \tcode{discard_block_engine}}%
...
\subclause3[rand.adapt.ibits]{Class template \tcode{independent_bits_engine}}%
...
\subclause3[rand.adapt.shuf]{Class template \tcode{shuffle_order_engine}}%
...
\subclause2[rand.predef]{Engines and engine adaptors with predefined parameters}%
...
\subclause2[rand.device]{Class \tcode{random_device}}%
...
\subclause2[rand.util]{Utilities}%
\indextext{random number generation!utilities|(}%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% class seed_seq:

\subclause3[rand.util.seedseq]{Class \tcode{seed_seq}}%
...
\subclause3[rand.util.canonical]{Function template \tcode{generate_canonical}}%
...
\subclause2[rand.dist]{Random number distribution class templates}%
\indextext{random number generation!distributions|(}

\subclause3[rand.dist.general]{In general}
...
\subclause3[rand.dist.uni]{Uniform distributions}%
...
\subclause4[rand.dist.uni.int]{Class template \tcode{uniform_int_distribution}}%
...
\subclause4[rand.dist.uni.real]{Class template \tcode{uniform_real_distribution}}%
...
\subclause3[rand.dist.bern]{Bernoulli distributions}%
...
\subclause4[rand.dist.bern.bernoulli]{Class \tcode{bernoulli_distribution}}%
...
\subclause4[rand.dist.bern.bin]{Class template \tcode{binomial_distribution}}%
...
\subclause4[rand.dist.bern.geo]{Class template \tcode{geometric_distribution}}
...
\subclause4[rand.dist.bern.negbin]{Class template \tcode{negative_binomial_distribution}}
...
\subclause3[rand.dist.pois]{Poisson distributions}%
...
\subclause4[rand.dist.pois.poisson]{Class template \tcode{poisson_distribution}}%
...
\subclause4[rand.dist.pois.exp]{Class template \tcode{exponential_distribution}}%
...
\subclause4[rand.dist.pois.gamma]{Class template \tcode{gamma_distribution}}%
...
\subclause4[rand.dist.pois.weibull]{Class template \tcode{weibull_distribution}}%
...
\subclause4[rand.dist.pois.extreme]{Class template \tcode{extreme_value_distribution}}
...
\subclause3[rand.dist.norm]{Normal distributions}%
...
\subclause4[rand.dist.norm.normal]{Class template \tcode{normal_distribution}}%
...
\subclause4[rand.dist.norm.lognormal]{Class template \tcode{lognormal_distribution}}%
...
\subclause4[rand.dist.norm.chisq]{Class template \tcode{chi_squared_distribution}}%
...
\subclause4[rand.dist.norm.cauchy]{Class template \tcode{cauchy_distribution}}%
...
\subclause4[rand.dist.norm.f]{Class template \tcode{fisher_f_distribution}}%
...
\subclause4[rand.dist.norm.t]{Class template \tcode{student_t_distribution}}%
...
\subclause3[rand.dist.samp]{Sampling distributions}%
...
\subclause4[rand.dist.samp.discrete]{Class template \tcode{discrete_distribution}}%
...
\subclause4[rand.dist.samp.pconst]{Class template \tcode{piecewise_constant_distribution}}%
...
\subclause4[rand.dist.samp.plinear]{Class template \tcode{piecewise_linear_distribution}}%
...
\subclause2[c.math.rand]{Low-quality random number generation}
...
\subclause1[numarray]{Numeric arrays}

\subclause2[valarray.syn]{Header \tcode{<valarray>} synopsis}
...
\subclause2[template.valarray]{Class template \tcode{valarray}}

\subclause3[template.valarray.overview]{Overview}
...
\subclause3[valarray.cons]{Constructors}
...
\subclause3[valarray.assign]{Assignment}
...
\subclause3[valarray.access]{Element access}
...
\subclause3[valarray.sub]{Subset operations}
...
\subclause3[valarray.unary]{Unary operators}
...
\subclause3[valarray.cassign]{Compound assignment}
...
\subclause3[valarray.members]{Member functions}
...
\subclause2[valarray.nonmembers]{\tcode{valarray} non-member operations}

\subclause3[valarray.binary]{Binary operators}
...
\subclause3[valarray.comparison]{Logical operators}
...
\subclause3[valarray.transcend]{Transcendentals}
...
\subclause3[valarray.special]{Specialized algorithms}
...
\subclause2[class.slice]{Class \tcode{slice}}

\subclause3[class.slice.overview]{Overview}
...
\subclause3[cons.slice]{Constructors}
...
\subclause3[slice.access]{Access functions}
...
\subclause3[slice.ops]{Operators}
...
\subclause2[template.slice.array]{Class template \tcode{slice_array}}

\subclause3[template.slice.array.overview]{Overview}
...
\subclause3[slice.arr.assign]{Assignment}
...
\subclause3[slice.arr.comp.assign]{Compound assignment}
...
\subclause3[slice.arr.fill]{Fill function}
...
\subclause2[class.gslice]{The \tcode{gslice} class}

\subclause3[class.gslice.overview]{Overview}
...
\subclause3[gslice.cons]{Constructors}
...
\subclause3[gslice.access]{Access functions}
...
\subclause2[template.gslice.array]{Class template \tcode{gslice_array}}

\subclause3[template.gslice.array.overview]{Overview}
...
\subclause3[gslice.array.assign]{Assignment}
...
\subclause3[gslice.array.comp.assign]{Compound assignment}
...
\subclause3[gslice.array.fill]{Fill function}
...
\subclause2[template.mask.array]{Class template \tcode{mask_array}}

\subclause3[template.mask.array.overview]{Overview}
...
\subclause3[mask.array.assign]{Assignment}
...
\subclause3[mask.array.comp.assign]{Compound assignment}
...
\subclause3[mask.array.fill]{Fill function}
...
\subclause2[template.indirect.array]{Class template \tcode{indirect_array}}

\subclause3[template.indirect.array.overview]{Overview}
...
\subclause3[indirect.array.assign]{Assignment}
...
\subclause3[indirect.array.comp.assign]{Compound assignment}
...
\subclause3[indirect.array.fill]{Fill function}
...
\subclause2[valarray.range]{\tcode{valarray} range access}
...
\subclause1[c.math]{Mathematical functions for floating-point types}

\subclause2[cmath.syn]{Header \tcode{<cmath>} synopsis}
...
\subclause2[c.math.abs]{Absolute values}
...
\subclause2[c.math.hypot3]{Three-dimensional hypotenuse}
...
\subclause2[c.math.lerp]{Linear interpolation}
...
\subclause2[c.math.fpclass]{Classification / comparison functions}
...
\subclause2[sf.cmath]{Mathematical special functions}%

\subclause3[sf.cmath.general]{General}%
...
\subclause3[sf.cmath.assoc.laguerre]{Associated Laguerre polynomials}%
...
\subclause3[sf.cmath.assoc.legendre]{Associated Legendre functions}%
...
\subclause3[sf.cmath.beta]{Beta function}%
...
\subclause3[sf.cmath.comp.ellint.1]{Complete elliptic integral of the first kind}%
...
\subclause3[sf.cmath.comp.ellint.2]{Complete elliptic integral of the second kind}%
...
\subclause3[sf.cmath.comp.ellint.3]{Complete elliptic integral of the third kind}%
...
\subclause3[sf.cmath.cyl.bessel.i]{Regular modified cylindrical Bessel functions}%
...
\subclause3[sf.cmath.cyl.bessel.j]{Cylindrical Bessel functions of the first kind}%
...
\subclause3[sf.cmath.cyl.bessel.k]{Irregular modified cylindrical Bessel functions}%
...
\subclause3[sf.cmath.cyl.neumann]{Cylindrical Neumann functions}%
...
\subclause3[sf.cmath.ellint.1]{Incomplete elliptic integral of the first kind}%
...
\subclause3[sf.cmath.ellint.2]{Incomplete elliptic integral of the second kind}%
...
\subclause3[sf.cmath.ellint.3]{Incomplete elliptic integral of the third kind}%
...
\subclause3[sf.cmath.expint]{Exponential integral}%
...
\subclause3[sf.cmath.hermite]{Hermite polynomials}%
...
\subclause3[sf.cmath.laguerre]{Laguerre polynomials}%
...
\subclause3[sf.cmath.legendre]{Legendre polynomials}%
...
\subclause3[sf.cmath.riemann.zeta]{Riemann zeta function}%
...
\subclause3[sf.cmath.sph.bessel]{Spherical Bessel functions of the first kind}%
...
\subclause3[sf.cmath.sph.legendre]{Spherical associated Legendre functions}%
...
\subclause3[sf.cmath.sph.neumann]{Spherical Neumann functions}%
...
\subclause1[numbers]{Numbers}

\subclause2[numbers.syn]{Header \tcode{<numbers>} synopsis}
...
\subclause2[math.constants]{Mathematical constants}
