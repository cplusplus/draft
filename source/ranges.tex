...
\indexlibrary{\idxcode{take_view::sentinel}}%
\begin{codeblock}
namespace std::ranges {
  template<class V>
  template<bool Const>
...
\indexlibrary{\idxcode{take_while_view}}%
\begin{codeblock}
namespace std::ranges {
  template<view R, class Pred>
  requires input_range<R> && is_object_v<Pred> &&
...
\indexlibrary{\idxcode{take_while_view::sentinel}}%
\begin{codeblock}
namespace std::ranges {
  template<class V>
  template<bool Const>
...
\indexlibrary{\idxcode{join_view::sentinel}}%
\begin{codeblock}
namespace std::ranges {
  template<class V>
  template<bool Const>
...
\indexlibrary{\idxcode{split_view}}%
\begin{codeblock}
namespace std::ranges {
...
\indexlibrary{\idxcode{split_view::outer_iterator}}%
\begin{codeblock}
namespace std::ranges {
...
\indexlibrary{\idxcode{split_view::outer_iterator::value_type}}%
\begin{codeblock}
namespace std::ranges {
  template<class V, class Pattern>
  template<bool Const>
...
\indexlibrary{\idxcode{split_view::inner_iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<class V, class Pattern>
  template<bool Const>
...
\indexlibrary{\idxcode{common_view}}%
\begin{codeblock}
namespace std::ranges {
  template<view V>
    requires (!common_range<V>)
...
\indexlibrary{\idxcode{basic_istream_view::iterator}}%
\begin{codeblock}
namespace std::ranges {
  template<class Val, class CharT, class Traits>
...
\indexlibrary{\idxcode{elements_view::iterator}}%
\begin{codeblock}
namespace std::ranges {
