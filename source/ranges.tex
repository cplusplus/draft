...
\pnum
\remarks
Pursuant to \ref{namespace.std}, a program may specialize \tcode{enable_borrowed_range}
...
a program may specialize \tcode{disable_sized_range}
for cv-unqualified program-defined types.
...
\pnum
\remarks
Pursuant to \ref{namespace.std}, a program may specialize \tcode{enable_view}
to \tcode{true}
