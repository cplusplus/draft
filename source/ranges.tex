%!TEX root = std.tex
\subclause0[ranges]{Ranges library}

\subclause1[ranges.general]{General}
...
\subclause1[ranges.syn]{Header \tcode{<ranges>} synopsis}
...
\subclause1[range.access]{Range access}

\subclause2[range.access.general]{General}
...
\subclause2[range.access.begin]{\tcode{ranges::begin}}
...
\subclause2[range.access.end]{\tcode{ranges::end}}
...
\subclause2[range.access.cbegin]{\tcode{ranges::cbegin}}
...
\subclause2[range.access.cend]{\tcode{ranges::cend}}
...
\subclause2[range.access.rbegin]{\tcode{ranges::rbegin}}
...
\subclause2[range.access.rend]{\tcode{ranges::rend}}
...
\subclause2[range.access.crbegin]{\tcode{ranges::crbegin}}
...
\subclause2[range.access.crend]{\tcode{ranges::crend}}
...
\subclause2[range.prim.size]{\tcode{ranges::size}}
...
\subclause2[range.prim.ssize]{\tcode{ranges::ssize}}
...
\subclause2[range.prim.empty]{\tcode{ranges::empty}}
...
\subclause2[range.prim.data]{\tcode{ranges::data}}
...
\subclause2[range.prim.cdata]{\tcode{ranges::cdata}}
...
\subclause1[range.req]{Range requirements}

\subclause2[range.req.general]{General}
...
\subclause2[range.sized]{Sized ranges}
...
\subclause2[range.refinements]{Other range refinements}
...
\subclause1[range.utility]{Range utilities}

\subclause2[range.utility.general]{General}

\pnum
The components in \ref{range.utility} are general utilities for representing and
manipulating ranges.

\subclause2[range.utility.helpers]{Helper concepts}
...
\subclause2[view.interface]{View interface}

\subclause3[view.interface.general]{General}
...
\subclause3[view.interface.members]{Members}
...
\subclause2[range.subrange]{Sub-ranges}

\subclause3[range.subrange.general]{General}
...
\subclause3[range.subrange.ctor]{Constructors and conversions}
...
\subclause3[range.subrange.access]{Accessors}
...
\subclause2[range.dangling]{Dangling iterator handling}
...
\subclause1[range.factories]{Range factories}

\subclause2[range.factories.general]{General}
...
\subclause2[range.empty]{Empty view}

\subclause3[range.empty.overview]{Overview}
...
\subclause3[range.empty.view]{Class template \tcode{empty_view}}
...
\subclause2[range.single]{Single view}

\subclause3[range.single.overview]{Overview}
...
\subclause3[range.single.view]{Class template \tcode{single_view}}
...
\subclause2[range.iota]{Iota view}

\subclause3[range.iota.overview]{Overview}
...
\subclause3[range.iota.view]{Class template \tcode{iota_view}}
...
\subclause3[range.iota.iterator]{Class \tcode{iota_view::\exposid{iterator}}}
...
\subclause3[range.iota.sentinel]{Class \tcode{iota_view::\exposid{sentinel}}}
...
\subclause2[range.istream]{Istream view}

\subclause3[range.istream.overview]{Overview}
...
\subclause3[range.istream.view]{Class template \tcode{basic_istream_view}}
...
\subclause3[range.istream.iterator]{Class template \tcode{basic_istream_view::\exposid{iterator}}}
...
\subclause1[range.adaptors]{Range adaptors}

\subclause2[range.adaptors.general]{General}
...
\subclause2[range.adaptor.object]{Range adaptor objects}
...
\subclause2[range.copy.wrap]{Copyable wrapper}
...
\subclause2[range.nonprop.cache]{Non-propagating cache}
...
\subclause2[range.all]{All view}

\subclause3[range.all.general]{General}
...
\subclause3[range.ref.view]{Class template \tcode{ref_view}}
...
\subclause2[range.filter]{Filter view}

\subclause3[range.filter.overview]{Overview}
...
\subclause3[range.filter.view]{Class template \tcode{filter_view}}
...
\subclause3[range.filter.iterator]{Class \tcode{filter_view::\exposid{iterator}}}
...
\subclause3[range.filter.sentinel]{Class \tcode{filter_view::\exposid{sentinel}}}
...
\subclause2[range.transform]{Transform view}

\subclause3[range.transform.overview]{Overview}
...
\subclause3[range.transform.view]{Class template \tcode{transform_view}}
...
\subclause3[range.transform.iterator]{Class template \tcode{transform_view::\exposid{iterator}}}
...
\subclause3[range.transform.sentinel]{Class template \tcode{transform_view::\exposid{sentinel}}}
...
\subclause2[range.take]{Take view}

\subclause3[range.take.overview]{Overview}
...
\subclause3[range.take.view]{Class template \tcode{take_view}}
...
\subclause3[range.take.sentinel]{Class template \tcode{take_view::\exposid{sentinel}}}
...
\subclause2[range.take.while]{Take while view}

\subclause3[range.take.while.overview]{Overview}
...
\subclause3[range.take.while.view]{Class template \tcode{take_while_view}}
...
\subclause3[range.take.while.sentinel]{Class template \tcode{take_while_view::\exposid{sentinel}}}
...
\subclause2[range.drop]{Drop view}

\subclause3[range.drop.overview]{Overview}
...
\subclause3[range.drop.view]{Class template \tcode{drop_view}}
...
\subclause2[range.drop.while]{Drop while view}

\subclause3[range.drop.while.overview]{Overview}
...
\subclause3[range.drop.while.view]{Class template \tcode{drop_while_view}}
...
\subclause2[range.join]{Join view}

\subclause3[range.join.overview]{Overview}
...
\subclause3[range.join.view]{Class template \tcode{join_view}}
...
\subclause3[range.join.iterator]{Class template \tcode{join_view::\exposid{iterator}}}
...
\subclause3[range.join.sentinel]{Class template \tcode{join_view::\exposid{sentinel}}}
...
\subclause2[range.lazy.split]{Lazy split view}

\subclause3[range.lazy.split.overview]{Overview}
...
\subclause3[range.lazy.split.view]{Class template \tcode{lazy_split_view}}
...
\subclause3[range.lazy.split.outer]{Class template \tcode{lazy_split_view::\exposid{outer-iterator}}}
...
\subclause3[range.lazy.split.outer.value]{Class \tcode{lazy_split_view::\exposid{outer-iterator}::value_type}}
...
\subclause3[range.lazy.split.inner]{Class template \tcode{lazy_split_view::\exposid{inner-iterator}}}
...
\subclause2[range.split]{Split view}

\subclause3[range.split.overview]{Overview}
...
\subclause3[range.split.view]{Class template \tcode{split_view}}
...
\subclause3[range.split.iterator]{Class \tcode{split_view::\exposid{iterator}}}
...
\subclause3[range.split.sentinel]{Class \tcode{split_view::\exposid{sentinel}}}
...
\subclause2[range.counted]{Counted view}
...
\subclause2[range.common]{Common view}

\subclause3[range.common.overview]{Overview}
...
\subclause3[range.common.view]{Class template \tcode{common_view}}
...
\subclause2[range.reverse]{Reverse view}

\subclause3[range.reverse.overview]{Overview}
...
\subclause3[range.reverse.view]{Class template \tcode{reverse_view}}
...
\subclause2[range.elements]{Elements view}

\subclause3[range.elements.overview]{Overview}
...
\subclause3[range.elements.view]{Class template \tcode{elements_view}}
...
\subclause3[range.elements.iterator]{Class template \tcode{elements_view::\exposid{iterator}}}
...
\subclause3[range.elements.sentinel]{Class template \tcode{elements_view::\exposid{sentinel}}}
