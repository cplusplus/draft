...
\libconcept{input_range}, \libconcept{ForwardRange}, \libconcept{bidirectional_range},
...
namespace std::ranges {
  ...
  public:
    ...
    constexpr auto end() requires ForwardRange<V> && common_range<V> {
      return outer_iterator<@\placeholder{simple-view}@<V>>{*this, ranges::end(base_)};
    }

    constexpr auto end() const {
      if constexpr (ForwardRange<V> && ForwardRange<const V> && common_range<const V>)
