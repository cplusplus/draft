...
namespace std::ranges {
  inline namespace @\unspec@ {
    ...
    inline constexpr @\unspec@ reserve_hint = @\unspec@;                        // freestanding
  ...
  template<class T>
    concept approximately_sized_range = @\seebelow@;                                  // freestanding
...
%FIXME: Why do we have an itemdecl inside a bulleted list?
\begin{itemdecl}
template<class I>
...
\pnum
%FIXME: Do we want this index here in addition to the one for the definition in the synopsis?
