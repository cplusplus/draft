...
\indexlibraryglobal{sized_range}%
\begin{itemdecl}
template<class T>
  concept sized_range =
    range<T> &&
...
\indexlibraryglobal{output_range}%
\indexlibraryglobal{input_range}%
\indexlibraryglobal{forward_range}%
\indexlibraryglobal{bidirectional_range}%
\indexlibraryglobal{random_access_range}%
\begin{itemdecl}
template<class R, class T>
...
\indexlibraryglobal{common_range}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{viewable_range}%
\begin{itemdecl}
template<class T>
...
\indexlibrarymember{view_interface}{front}%
\begin{itemdecl}
constexpr decltype(auto) front() requires forward_range<D>;
constexpr decltype(auto) front() const requires forward_range<const D>;
\end{itemdecl}
...
\indexlibrarymember{view_interface}{back}%
\begin{itemdecl}
constexpr decltype(auto) back() requires bidirectional_range<D> && common_range<D>;
constexpr decltype(auto) back() const
  requires bidirectional_range<const D> && common_range<const D>;
...
\indexlibrarymember{single_view}{single_view}%
\begin{itemdecl}
constexpr explicit single_view(const T& t);
\end{itemdecl}
...
\indexlibrarymember{iota_view}{iota_view}%
\begin{itemdecl}
constexpr explicit iota_view(W value);
\end{itemdecl}
...
\indexlibrarymember{iterator}{iota_view::iterator}
\begin{itemdecl}
constexpr explicit iterator(W value);
\end{itemdecl}
...
\indexlibrarymember{sentinel}{iota_view::sentinel}
\begin{itemdecl}
constexpr explicit sentinel(Bound bound);
\end{itemdecl}
...
\indexlibrarymember{filter_view}{filter_view}%
\begin{itemdecl}
constexpr filter_view(V base, Pred pred);
\end{itemdecl}
...
\indexlibrarymember{iterator}{filter_view::iterator}%
\begin{itemdecl}
constexpr iterator(filter_view& parent, iterator_t<V> current);
\end{itemdecl}
...
\indexlibrarymember{sentinel}{filter_view::sentinel}%
\begin{itemdecl}
constexpr explicit sentinel(filter_view& parent);
\end{itemdecl}
...
\indexlibrarymember{transform_view}{transform_view}%
\begin{itemdecl}
constexpr transform_view(V base, F fun);
\end{itemdecl}
...
\indexlibrarymember{sentinel}{transform_view::sentinel}
\begin{itemdecl}
constexpr explicit sentinel(sentinel_t<Base> end);
\end{itemdecl}
...
\indexlibrarymember{take_view}{take_view}%
\begin{itemdecl}
constexpr take_view(V base, range_difference_t<V> count);
\end{itemdecl}
...
\indexlibrarymember{sentinel}{take_view::sentinel}
\begin{itemdecl}
constexpr explicit sentinel(sentinel_t<Base> end);
\end{itemdecl}
...
\indexlibrarymember{join_view}{join_view}%
\begin{itemdecl}
constexpr explicit join_view(V base);
\end{itemdecl}
...
\indexlibrarymember{iterator}{join_view::iterator}
\begin{itemdecl}
constexpr iterator(Parent& parent, iterator_t<V> outer)
\end{itemdecl}
...
\indexlibrarymember{sentinel}{join_view::sentinel}
\begin{itemdecl}
constexpr explicit sentinel(Parent& parent);
\end{itemdecl}
...
\indexlibrarymember{split_view}{split_view}%
\begin{itemdecl}
constexpr split_view(V base, Pattern pattern);
\end{itemdecl}
...
\indexlibrarymember{outer_iterator}{split_view::outer_iterator}%
\begin{itemdecl}
constexpr explicit outer_iterator(Parent& parent)
  requires (!forward_range<Base>);
\end{itemdecl}
...
\indexlibrarymember{operator*}{split_view::outer_iterator}%
\begin{itemdecl}
constexpr value_type operator*() const;
\end{itemdecl}
...
\indexlibrarymember{value_type}{split_view::outer_iterator::value_type}%
\begin{itemdecl}
constexpr explicit value_type(outer_iterator i);
\end{itemdecl}
...
\indexlibrarymember{inner_iterator}{split_view::inner_iterator}%
\begin{itemdecl}
constexpr explicit inner_iterator(outer_iterator<Const> i);
\end{itemdecl}
...
\indexlibrarymember{common_view}{common_view}%
\begin{itemdecl}
...
\indexlibraryglobal{weiv_esrever}%
\begin{codeblock}
namespace std::ranges {
  template<view V>
    requires bidirectional_range<V>
...
\indexlibrarymember{reverse_view}{reverse_view}%
\begin{itemdecl}
