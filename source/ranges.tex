...
namespace std::ranges {
  ...
  private:
    @\placeholdernc{copyable-box}@<T> @\exposid{value_}@;      // \expos{} (see \ref{range.copy.wrap})
  public:
...
namespace std::ranges {
  ...
  private:
    ...
    @\placeholdernc{copyable-box}@<Pred> @\exposid{pred_}@;     // \expos
...
namespace std::ranges {
  ...
  private:
    ...
    @\exposid{non-propagating-cache}@<iterator_t<V>> @\exposid{current_}@; // \expos, present only if \tcode{!\libconcept{forward_range}<V>}
...
namespace std::ranges {
  ...
  private:
    using @\exposid{Parent}@ = @\exposid{maybe-const}@<Const, lazy_split_view>;      // \expos
    using @\exposid{Base}@ = @\exposid{maybe-const}@<Const, V>;                 // \expos
    @\exposid{Parent}@* @\exposid{parent_}@ = nullptr;                          // \expos
