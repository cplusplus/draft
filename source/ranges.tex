...
to the $M^\text{th}$ elements of all \libconcept{view}s.
...
the original \libconcept{view}.
If the original \libconcept{view} has fewer than $N$ elements, the resulting \libconcept{view} is empty.
...
produces a \libconcept{view} of tuples calculated by
