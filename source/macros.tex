...
\newcommand{\indexlibraryexpos}[1]{\indexlibrary{\idxexposid{#1}}}
...
\newcommand{\libexposid}[1]{\indexlibraryexpos{#1}\exposid{#1}}
\newcommand{\libexposidnc}[1]{\indexlibraryexpos{#1}\exposidnc{#1}}
