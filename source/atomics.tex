...
\begin{codeblock}
if (memcmp(@\removed{object}\added{this}@, expected, sizeof(*object)) == 0)
  memcpy(@\removed{object}\added{this}@, &desired, sizeof(*object));
else
  memcpy(expected, @\removed{object}\added{this}@, sizeof(*object));
\end{codeblock}
\end{note}
