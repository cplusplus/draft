...
namespace std {
  ...
  // In the following declarations, \tcode{\placeholder{atomic-type}} is either
  ...
  void atomic_init(volatile @\placeholder{atomic-type}@*, T) noexcept;
  void atomic_init(@\placeholder{atomic-type}@*, T) noexcept;
  void atomic_store(volatile @\placeholder{atomic-type}@*, T) noexcept;
  void atomic_store(@\placeholder{atomic-type}@*, T) noexcept;
  void atomic_store_explicit(volatile @\placeholder{atomic-type}@*, T, memory_order) noexcept;
  void atomic_store_explicit(@\placeholder{atomic-type}@*, T, memory_order) noexcept;
  T atomic_load(const volatile @\placeholder{atomic-type}@*) noexcept;
  T atomic_load(const @\placeholder{atomic-type}@*) noexcept;
  T atomic_load_explicit(const volatile @\placeholder{atomic-type}@*, memory_order) noexcept;
  T atomic_load_explicit(const @\placeholder{atomic-type}@*, memory_order) noexcept;
  T atomic_exchange(volatile @\placeholder{atomic-type}@*, T) noexcept;
  T atomic_exchange(@\placeholder{atomic-type}@*, T) noexcept;
  T atomic_exchange_explicit(volatile @\placeholder{atomic-type}@*, T, memory_order) noexcept;
  T atomic_exchange_explicit(@\placeholder{atomic-type}@*, T, memory_order) noexcept;
  bool atomic_compare_exchange_weak(volatile @\placeholder{atomic-type}@*, T*, T) noexcept;
  bool atomic_compare_exchange_weak(@\placeholder{atomic-type}@*, T*, T) noexcept;
  bool atomic_compare_exchange_strong(volatile @\placeholder{atomic-type}@*, T*, T) noexcept;
  bool atomic_compare_exchange_strong(@\placeholder{atomic-type}@*, T*, T) noexcept;
  bool atomic_compare_exchange_weak_explicit(volatile @\placeholder{atomic-type}@*, T*, T, 
    memory_order, memory_order) noexcept;
  bool atomic_compare_exchange_weak_explicit(@\placeholder{atomic-type}@*, T*, T,
    memory_order, memory_order) noexcept;
  bool atomic_compare_exchange_strong_explicit(volatile @\placeholder{atomic-type}@*, T*, T,
    memory_order, memory_order) noexcept;
  bool atomic_compare_exchange_strong_explicit(@\placeholder{atomic-type}@*, T*, T,
    memory_order, memory_order) noexcept;
  ...
  // In the following declarations, \placeholder{atomic-integral} is either
  // \tcode{atomic<T>} or a named base class for \tcode{T} from
  ...
  @\placeholdernc{integral}@ atomic_fetch_add(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_add(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_add_explicit(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_add_explicit(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_sub(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_sub(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_sub_explicit(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_sub_explicit(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_and(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_and(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_and_explicit(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_and_explicit(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_or(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_or(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_or_explicit(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_or_explicit(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_xor(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_xor(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_xor_explicit(volatile @\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
  @\placeholdernc{integral}@ atomic_fetch_xor_explicit(@\placeholder{atomic-integral}@*, @\placeholdernc{integral}@, memory_order) noexcept;
...
namespace std {
  ...
  template <> struct atomic<@\placeholder{integral}@> {
    ...
    bool compare_exchange_weak(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order, memory_order) volatile noexcept;
    bool compare_exchange_weak(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order, memory_order) noexcept;
    bool compare_exchange_strong(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order, memory_order) volatile noexcept;
    bool compare_exchange_strong(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order, memory_order) noexcept;
    bool compare_exchange_weak(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order = memory_order_seq_cst) volatile noexcept;
    bool compare_exchange_weak(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order = memory_order_seq_cst) noexcept;
    bool compare_exchange_strong(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order = memory_order_seq_cst) volatile noexcept;
    bool compare_exchange_strong(@\placeholder{integral}@&, @\placeholdernc{integral}@, memory_order = memory_order_seq_cst) noexcept;
...
\pnum
In the declarations of these functions and function template specializations, the name \tcode\placeholder{integral} refers to an
