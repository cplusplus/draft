...
namespace std {
  ...
  // \ref{atomics.types.generic}, \removed{generic types} \added{atomic}
  template<class T> struct atomic;
  @\removed{template<> struct atomic<\placeholder{integral}>;}@
  // \added{\ref{atomics.types.pointer}, partial specialization for pointers}
  template<class T> struct atomic<T*>;

  // \removed{\ref{atomics.types.operations.general}, general operations on atomic types}
  // \removed{In the following declarations, \tcode{\placeholder{atomic-type}} is either \tcode{atomic<T>} or a named base class}
  // \removed{for \tcode{T} from Table~\ref{tab:atomics.integral} or inferred from Table~\ref{tab:atomics.typedefs} or from \tcode{bool}. If it is \tcode{atomic<T>},}
  // \removed{then the declaration is a template declaration prefixed with \tcode{template <class T>}.}
  // \added{\ref{atomics.nonmembers}, non-member functions}
  @\added{template<class T>}@
    bool atomic_is_lock_free(const volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*) noexcept;
  @\added{template<class T>}@
    bool atomic_is_lock_free(const @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*) noexcept;
  @\added{template<class T>}@
    void atomic_init(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    void atomic_init(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    void atomic_store(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    void atomic_store(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    void atomic_store_explicit(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  @\added{template<class T>}@
    void atomic_store_explicit(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  @\added{template<class T>}@
    T atomic_load(const volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*) noexcept;
  @\added{template<class T>}@
    T atomic_load(const @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*) noexcept;
  @\added{template<class T>}@
    T atomic_load_explicit(const volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, memory_order) noexcept;
  @\added{template<class T>}@
    T atomic_load_explicit(const @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, memory_order) noexcept;
  @\added{template<class T>}@
    T atomic_exchange(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, T) noexcept;
  @\added{template<class T>}@
    T atomic_exchange(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    T atomic_exchange_explicit(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  @\added{template<class T>}@
    T atomic_exchange_explicit(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_weak(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_weak(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_strong(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_strong(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_weak_explicit(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@, 
      memory_order, memory_order) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_weak_explicit(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order, memory_order) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_strong_explicit(volatile @\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order, memory_order) noexcept;
  @\added{template<class T>}@
    bool atomic_compare_exchange_strong_explicit(@\removed{\placeholder{atomic-type}}\added{atomic<T>}@*@\itcorr[-1]@,
      @\removed{T}\added{typename atomic<T>::value_type}@*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order, memory_order) noexcept;

  template <class T>
    T atomic_fetch_add(volatile @atomic<T>@*, @\removed{T}\added{typename atomic<T>::difference_type}@) noexcept;
  template <class T>
    T atomic_fetch_add(@atomic<T>@*, @\removed{T}\added{typename atomic<T>::difference_type}@) noexcept;
  template <class T>
    T atomic_fetch_add_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::difference_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_add_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::difference_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_sub(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::difference_type}@) noexcept;
  template <class T>
    T atomic_fetch_sub(atomic<T>*, @\removed{T}\added{typename atomic<T>::difference_type}@) noexcept;
  template <class T>
    T atomic_fetch_sub_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::difference_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_sub_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::difference_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_and(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_and(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_and_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_and_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_or(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_or(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_or_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_or_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_xor(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_xor(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_xor_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order) noexcept;
  template <class T>
    T atomic_fetch_xor_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@,
      memory_order) noexcept;

  // \removed{\ref{atomics.types.operations.arith}, arithmetic operations on atomic types}
  // \removed{In the following declarations, \tcode{\placeholder{atomic-integral}} is either \tcode{atomic<T>} or a named base class}
  // \removed{for \tcode{T} from Table~\ref{tab:atomics.integral} or inferred from Table~\ref{tab:atomics.typedefs}. If it is \tcode{atomic<T>}, then the declaration}
  // \removed{is a template specialization declaration prefixed with \tcode{template <>}.}
  @\removed{\placeholdernc{integral} atomic_fetch_add(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_add(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_add_explicit(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_add_explicit(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_sub(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_sub(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_sub_explicit(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_sub_explicit(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_and(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_and(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_and_explicit(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_and_explicit(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_or(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_or(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_or_explicit(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_or_explicit(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_xor(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_xor(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_xor_explicit(volatile \placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@
  @\removed{\placeholdernc{integral} atomic_fetch_xor_explicit(\placeholder{atomic-integral}*\itcorr[-1], \placeholdernc{integral}, memory_order) noexcept;}@

  // \removed{\ref{atomics.types.operations.pointer}, overloads for pointers}
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_add(volatile atomic<T*>*, ptrdiff_t) noexcept;}@
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_add(atomic<T*>*, ptrdiff_t) noexcept;}@
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_add_explicit(volatile atomic<T*>*, ptrdiff_t, memory_order) noexcept;}@
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_add_explicit(atomic<T*>*, ptrdiff_t, memory_order) noexcept;}@
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_sub(volatile atomic<T*>*, ptrdiff_t) noexcept;}@
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_sub(atomic<T*>*, ptrdiff_t) noexcept;}@
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_sub_explicit(volatile atomic<T*>*, ptrdiff_t, memory_order) noexcept;}@
  @\removed{template <class T>}@
  @\removed{  T* atomic_fetch_sub_explicit(atomic<T*>*, ptrdiff_t, memory_order) noexcept;}@

  // \ref{atomics.types.operations.req}, initialization
  #define ATOMIC_VAR_INIT(value) @\seebelow@

  // \ref{atomics.alias}, type aliases
  @\added{using atomic_bool           = atomic<bool>;}@
  @\added{using atomic_char           = atomic<char>;}@
  @\added{using atomic_schar          = atomic<signed char>;}@
  @\added{using atomic_uchar          = atomic<unsigned char>;}@
  @\added{using atomic_short          = atomic<short>;}@
  @\added{using atomic_ushort         = atomic<unsigned short>;}@
  @\added{using atomic_int            = atomic<int>;}@
  @\added{using atomic_uint           = atomic<unsigned int>;}@
  @\added{using atomic_long           = atomic<long>;}@
  @\added{using atomic_ulong          = atomic<unsigned long>;}@
  @\added{using atomic_llong          = atomic<long long>;}@
  @\added{using atomic_ullong         = atomic<unsigned long long>;}@
  @\added{using atomic_char16_t       = atomic<char16_t>;}@
  @\added{using atomic_char32_t       = atomic<char32_t>;}@
  @\added{using atomic_wchar_t        = atomic<wchar_t>;}@

  @\added{using atomic_int8_t         = atomic<int8_t>;}@
  @\added{using atomic_uint8_t        = atomic<uint8_t>;}@
  @\added{using atomic_int16_t        = atomic<int16_t>;}@
  @\added{using atomic_uint16_t       = atomic<uint16_t>;}@
  @\added{using atomic_int32_t        = atomic<int32_t>;}@
  @\added{using atomic_uint32_t       = atomic<uint32_t>;}@
  @\added{using atomic_int64_t        = atomic<int64_t>;}@
  @\added{using atomic_uint64_t       = atomic<uint64_t>;}@

  @\added{using atomic_int_least8_t   = atomic<int_least8_t>;}@
  @\added{using atomic_uint_least8_t  = atomic<uint_least8_t>;}@
  @\added{using atomic_int_least16_t  = atomic<int_least16_t>;}@
  @\added{using atomic_uint_least16_t = atomic<uint_least16_t>;}@
  @\added{using atomic_int_least32_t  = atomic<int_least32_t>;}@
  @\added{using atomic_uint_least32_t = atomic<uint_least32_t>;}@
  @\added{using atomic_int_least64_t  = atomic<int_least64_t>;}@
  @\added{using atomic_uint_least64_t = atomic<uint_least64_t>;}@

  @\added{using atomic_int_fast8_t    = atomic<int_fast8_t>;}@
  @\added{using atomic_uint_fast8_t   = atomic<uint_fast8_t>;}@
  @\added{using atomic_int_fast16_t   = atomic<int_fast16_t>;}@
  @\added{using atomic_uint_fast16_t  = atomic<uint_fast16_t>;}@
  @\added{using atomic_int_fast32_t   = atomic<int_fast32_t>;}@
  @\added{using atomic_uint_fast32_t  = atomic<uint_fast32_t>;}@
  @\added{using atomic_int_fast64_t   = atomic<int_fast64_t>;}@
  @\added{using atomic_uint_fast64_t  = atomic<uint_fast64_t>;}@

  @\added{using atomic_intptr_t       = atomic<intptr_t>;}@
  @\added{using atomic_uintptr_t      = atomic<uintptr_t>;}@
  @\added{using atomic_size_t         = atomic<size_t>;}@
  @\added{using atomic_ptrdiff_t      = atomic<ptrdiff_t>;}@
  @\added{using atomic_intmax_t       = atomic<intmax_t>;}@
  @\added{using atomic_uintmax_t      = atomic<uintmax_t>;}@
...
\pnum
\removed{There shall be named types corresponding to the integral specializations of
...
\pnum
\removed{There shall be atomic typedefs corresponding to non-atomic typedefs as
specified in Table~\ref{tab:atomics.typedefs}.}
\added{The type aliases} \tcode{atomic_int$N$_t}, \tcode{atomic_uint$N$_t},
\tcode{atomic_intptr_t}, and \tcode{atomic_uintptr_t}
\removed{shall be} \added{are} defined if and only if
...
\indexlibrary{\idxcode{atomic}}%
\pnum
\removed{There is a generic class template \tcode{atomic<T>}.} The \removed{type of the} template argument \added{for}
...
\pnum
\added{The specialization \tcode{atomic<bool>} is a standard-layout struct.}
\removed{The semantics of the operations on specializations of \tcode{atomic} are defined
in~\ref{atomics.types.operations}.}

\pnum
\removed{Specializations and instantiations of the \tcode{atomic} template shall have a deleted copy constructor, a deleted
...
\ednote{Remove all of the following subsections and the heading preceding this note.}

\rSec2[atomics.types.operations.general]{General operations on atomic types}

\pnum
\removed{The implementation shall provide the functions and function templates identified as ``general operations
on atomic types'' in~\ref{atomics.syn}.}

\pnum
\removed{In the declarations of these functions and function templates, the name
...
\pnum
\removed{The implementation shall declare but not define the
...
\pnum
\removed{The implementation shall provide the functions and function template specializations identified as ``arithmetic operations
on atomic types'' in~\ref{atomics.syn}.}

\indexlibrary{\idxcode{atomic<\placeholder{integral}>}}%
\pnum
\removed{In the declarations of these functions and function template specializations,
...
\pnum
\removed{The implementation shall provide the function templates identified as
...
\pnum
\removed{There are only a few kinds of operations on atomic types, though there are many
...
\pnum
\removed{In the following operation definitions:}

\begin{itemize}
\item \removed{an \placeholder{A} refers to one of the atomic types.}
\item \removed{a \placeholder{C} refers to its corresponding non-atomic type.}
\item \removed{an \placeholder{M} refers to type of the other argument for arithmetic operations. For
integral atomic types, \placeholder{M} is \placeholder{C}. For atomic address types, \placeholder{M} is
\tcode{ptrdiff_t}.}
\item \removed{the non-member functions not ending in \tcode{_explicit} have the semantics of their
...
operations on non-volatile objects become volatile. \removed{Thus, volatile qualified operations
...
\begin{itemdecl}
@\removed{\placeholdernc{A}::\placeholdernc{A}}\added{atomic}@() noexcept = default;
\end{itemdecl}
...
\indexlibrary{\idxcode{atomic<\placeholder{integral}>}!constructor}%
\begin{itemdecl}
constexpr @\removed{\placeholdernc{A}::\placeholdernc{A}}\added{atomic}@(@\removed{\placeholdernc{C}}\added{T}@ desired) noexcept;
\end{itemdecl}
...
\begin{itemdecl}
@\removed{bool atomic_is_lock_free(const volatile \placeholder{A}*\itcorr[-1] object) noexcept;}@
@\removed{bool atomic_is_lock_free(const \placeholder{A}*\itcorr[-1] object) noexcept;}@
bool @\removed{\placeholdernc{A}::}@is_lock_free() const volatile noexcept;
bool @\removed{\placeholdernc{A}::}@is_lock_free() const noexcept;
\end{itemdecl}
...
\begin{itemdecl}
@\removed{void atomic_store(volatile \placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired) noexcept;}@
@\removed{void atomic_store(\placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired) noexcept;}@
@\removed{void atomic_store_explicit(volatile \placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired, memory_order order) noexcept;}@
@\removed{void atomic_store_explicit(\placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired, memory_order order) noexcept;}@
void @\removed{\placeholdernc{A}::}@store(@\removed{\placeholdernc{C}}\added{T}@ desired, memory_order order = memory_order_seq_cst) volatile noexcept;
void @\removed{\placeholdernc{A}::}@store(@\removed{\placeholdernc{C}}\added{T}@ desired, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}
...
\pnum
\effects Atomically replaces the value pointed to \removed{by \tcode{object} or} by \tcode{this}
...
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator=(@\removed{\placeholdernc{C}}\added{T}@ desired) volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator=(@\removed{\placeholdernc{C}}\added{T}@ desired) noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\effects \removed{As if by} \added{Equivalent to:} \tcode{store(desired)}.
...
\begin{itemdecl}
@\removed{\placeholdernc{C} atomic_load(const volatile \placeholder{A}*\itcorr[-1] object) noexcept;}@
@\removed{\placeholdernc{C} atomic_load(const \placeholder{A}*\itcorr[-1] object) noexcept;}@
@\removed{\placeholdernc{C} atomic_load_explicit(const volatile \placeholder{A}*\itcorr[-1] object, memory_order) noexcept;}@
@\removed{\placeholdernc{C} atomic_load_explicit(const \placeholder{A}*\itcorr[-1] object, memory_order) noexcept;}@
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@load(memory_order order = memory_order_seq_cst) const volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@load(memory_order order = memory_order_seq_cst) const noexcept;
\end{itemdecl}
...
\pnum
\returns Atomically returns the value pointed to \removed{by \tcode{object} or} by \tcode{this}.
\end{itemdescr}
...
\begin{itemdecl}
@\removed{\placeholdernc{A}::}@operator @\removed{\placeholder{C}}\added{T}@() const volatile noexcept;
@\removed{\placeholdernc{A}::}@operator @\removed{\placeholder{C}}\added{T}@() const noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\effects \removed{As if by \tcode{load()}} \added{Equivalent to: \tcode{return load();}}

\removed{\returns The result of \tcode{load()}.}
\end{itemdescr}
...
\begin{itemdecl}
@\removed{\placeholdernc{C} atomic_exchange(volatile \placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired) noexcept;}@
@\removed{\placeholdernc{C} atomic_exchange(\placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired) noexcept;}@
@\removed{\placeholdernc{C} atomic_exchange_explicit(volatile \placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired, memory_order) noexcept;}@
@\removed{\placeholdernc{C} atomic_exchange_explicit(\placeholder{A}*\itcorr[-1] object, \placeholdernc{C} desired, memory_order) noexcept;}@
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@exchange(@\removed{\placeholdernc{C}}\added{T}@ desired, memory_order order = memory_order_seq_cst) volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@exchange(@\removed{\placeholdernc{C}}\added{T}@ desired, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}
...
\pnum
\returns Atomically returns the value pointed to \removed{by \tcode{object} or} by \tcode{this} immediately before the effects.
\end{itemdescr}
...
\begin{itemdecl}
@\removed{bool atomic_compare_exchange_weak(volatile \placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired) noexcept;}@
@\removed{bool atomic_compare_exchange_weak(\placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired) noexcept;}@
@\removed{bool atomic_compare_exchange_strong(volatile \placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired) noexcept;}@
@\removed{bool atomic_compare_exchange_strong(\placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired) noexcept;}@
@\removed{bool atomic_compare_exchange_weak_explicit(volatile \placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired,}@
    @\removed{memory_order success, memory_order failure) noexcept;}@
@\removed{bool atomic_compare_exchange_weak_explicit(\placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired,}@
    @\removed{memory_order success, memory_order failure) noexcept;}@
@\removed{bool atomic_compare_exchange_strong_explicit(volatile \placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired,}@
    @\removed{memory_order success, memory_order failure) noexcept;}@
@\removed{bool atomic_compare_exchange_strong_explicit(\placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired,}@
    @\removed{memory_order success, memory_order failure) noexcept;}@
bool @\removed{\placeholdernc{A}::}@compare_exchange_weak(@\removed{\placeholder{C}}\added{T}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{T}@ desired,
    memory_order success, memory_order failure) volatile noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_weak(@\removed{\placeholder{C}}\added{T}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{T}@ desired,
    memory_order success, memory_order failure) noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_strong(@\removed{\placeholder{C}}\added{T}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{T}@ desired,
    memory_order success, memory_order failure) volatile noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_strong(@\removed{\placeholder{C}}\added{T}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{T}@ desired,
    memory_order success, memory_order failure) noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_weak(@\removed{\placeholder{C}}\added{T}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{T}@ desired,
...
compares the contents of the memory pointed to \removed{by \tcode{object} or} by \tcode{this}
for equality with that previously retrieved from \tcode{expected},
and if true, replaces the contents of the memory pointed to
\removed{by \tcode{object} or} by \tcode{this} with that in \tcode{desired}.
...
read from \removed{\tcode{object} or} \added{the memory pointed to} by \tcode{this} during the atomic comparison.
If the operation returns \tcode{true}, these
operations are atomic read-modify-write
operations~(\ref{intro.multithread}) on the memory
pointed to by \tcode{this} \removed{or \tcode{object}}.
...
\tcode{\removed{atomic_}compare_exchange_strong} is
\begin{codeblock}
if (memcmp(@\removed{object}\added{this}@, @\added{\&}@expected, sizeof(*@\removed{object}\added{this}@)) == 0)
  memcpy(@\removed{object}\added{this}@, &desired, sizeof(*@\removed{object}\added{this}@));
else
  memcpy(expected, @\removed{object}\added{this}@, sizeof(*@\removed{object}\added{this}@));
\end{codeblock}
\end{note}
...
the contents of memory referred to by \tcode{expected} and \tcode{\removed{object}\added{this}} are
...
\indexlibrary{\idxcode{atomic<\placeholder{integral}>}}%
\pnum
There \removed{shall be explicit} \added{are} specializations of the \tcode{atomic}
...
For each \added{such} integral type \tcode{\placeholder{integral}}, the specialization
\tcode{atomic<\placeholder{integral}>} provides additional atomic operations appropriate to integral types.
\removed{There shall be a specialization \tcode{atomic<bool>} which provides the general
atomic operations as specified in \ref{atomics.types.operations.general}.}
\begin{note}\added{For the specialization \tcode{atomic<bool>}, see \ref{atomics.types.generic}.}\end{note}

\begin{codeblock}
  template <> struct atomic<@\placeholder{integral}@> {
    @\added{using value_type = \placeholder{integral};}@
    @\added{using difference_type = value_type;}@
    static constexpr bool is_always_lock_free = @\impdefx{whether a given \tcode{atomic} type's operations are always lock free}@;
    bool is_lock_free() const volatile noexcept;
    bool is_lock_free() const noexcept;
...
\pnum
The atomic integral specializations \removed{and the specialization \tcode{atomic<bool>}}
\removed{shall be} \added{are} standard-layout structs. They \removed{shall} each have a trivial default constructor
and a trivial destructor. \removed{They shall each support aggregate initialization
syntax.}

\pnum
\added{Descriptions are provided below only for members that differ from the primary template.}
...
\begin{itemdecl}
@\removed{\placeholdernc{C} atomic_fetch_\placeholdernc{key}(volatile \placeholder{A}*\itcorr[-1] object, \placeholdernc{M} operand) noexcept;}@
@\removed{\placeholdernc{C} atomic_fetch_\placeholdernc{key}(\placeholder{A}*\itcorr[-1] object, \placeholdernc{M} operand) noexcept;}@
@\removed{\placeholdernc{C} atomic_fetch_\placeholdernc{key}_explicit(volatile \placeholder{A}*\itcorr[-1] object, \placeholdernc{M} operand, memory_order order) noexcept;}@
@\removed{\placeholdernc{C} atomic_fetch_\placeholdernc{key}_explicit(\placeholder{A}*\itcorr[-1] object, \placeholdernc{M} operand, memory_order order) noexcept;}@
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@fetch_@\placeholdernc{key}@(@\removed{\placeholdernc{M}}\added{T}@ operand, memory_order order = memory_order_seq_cst) volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@fetch_@\placeholdernc{key}@(@\removed{\placeholdernc{M}}\added{T}@ operand, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\effects Atomically replaces the value pointed to \removed{by \tcode{object} or} by
\tcode{this} with the result of the computation applied to the
value pointed to \removed{by \tcode{object} or} by \tcode{this} and the given \tcode{operand}.
Memory is affected according to the value of \tcode{order}.
These operations are atomic read-modify-write operations~(\ref{intro.multithread}).

\pnum
\returns Atomically, the value pointed to \removed{by \tcode{object} or} by \tcode{this} immediately before the effects.
...
representation. There are no undefined results.  \removed{For address types, the result may be an
...
\indexlibrarymember{operator\^{}=}{atomic<\placeholder{integral}>}%
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator @\placeholder{op}@=(@\removed{\placeholdernc{M}}\added{T}@ operand) volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator @\placeholder{op}@=(@\removed{\placeholdernc{M}}\added{T}@ operand) noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\effects \removed{As if by \tcode{fetch_\placeholder{key}(operand)}.} \added{Equivalent to: \tcode{return fetch_\placeholder{key}(operand) \placeholder{op} operand;}}

\removed{\returns \tcode{fetch_\placeholder{key}(operand) op operand}.}
\end{itemdescr}
...
\indexlibrary{\idxcode{atomic<T*>}}%
\pnum
There \removed{shall be pointer} \added{is a} partial specialization\removed{s} of the \tcode{atomic} class template \added{for pointers}.
\removed{These s}\added{S}pecializations \removed{shall be} \added{of this partial specialization are} standard-layout structs.
They \removed{shall} each have a trivial default constructor and a trivial destructor.
\removed{They shall each support aggregate initialization syntax.}

\pnum
\added{Descriptions are provided below only for members that differ from the primary template.}

\ednote{The following provisions are cloned from the integer arithmetic section to avoid the
...
\begin{itemdecl}
T* fetch_@\placeholdernc{key}@(ptrdiff_t operand, memory_order order = memory_order_seq_cst) volatile noexcept;
T* fetch_@\placeholdernc{key}@(ptrdiff_t operand, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\added{\requires T shall be an object type, otherwise the program is ill-formed.}
\begin{note} \added{Pointer arithmetic on \tcode{void*} or function pointers is ill-formed.} \end{note}
...
\pnum
\remarks \added{The result may be an undefined address,
...
\indexlibrarymember{operator++}{atomic<\placeholder{integral}>}%
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator++(int) volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator++(int) noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\removed{\returns \tcode{fetch_add(1)}.}

\added{\effects Equivalent to: \tcode{return fetch\_add(1);}}
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\removed{\returns \tcode{fetch_sub(1)}.}

\added{\effects Equivalent to: \tcode{return fetch\_sub(1);}}
\end{itemdescr}

\indexlibrarymember{operator++}{atomic<T*>}%
\indexlibrarymember{operator++}{atomic<\placeholder{integral}>}%
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator++() volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator++() noexcept;
\end{itemdecl}

\begin{itemdescr}
\pnum
\effects \removed{As if by \tcode{fetch_add(1)}.} \added{Equivalent to: \tcode{return fetch_add(1) + 1;}}

\removed{\returns \tcode{fetch_add(1) + 1}.}
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects \removed{As if by \tcode{fetch_sub(1)}.} \added{Equivalent to: \tcode{return fetch_sub(1) - 1;}}

\removed{\returns \tcode{fetch_sub(1) - 1}.}
\end{itemdescr}
...
\pnum
\added{A non-member function template whose name matches the pattern
...
\added{If no such member function exists, the program is ill-formed.}

\indexlibrary{\idxcode{atomic_init}}%
\begin{itemdecl}
@\added{template<class T>}@
  void atomic_init(volatile @\removed{\placeholder{A}}\added{atomic<T>}@*@\itcorr[-1]@ object, @\removed{\placeholdernc{C}}\added{typename atomic<T>::value_type}@ desired) noexcept;
@\added{template<class T>}@
  void atomic_init(@\removed{\placeholder{A}}\added{atomic<T>}@*@\itcorr[-1]@ object, @\removed{\placeholdernc{C}}\added{typename atomic<T>::value_type}@ desired) noexcept;
\end{itemdecl}
...
\pnum
\begin{note}
\added{The non-member functions enable programmers to write code that can be
...
the operations should also be address-free. \removed{No other type requires lock-free operations,
...
It shall have a trivial default constructor\removed{, a deleted copy constructor, a deleted copy assignment operator,} and a trivial destructor.
