...
void @\removed{\placeholdernc{A}::}@store(@\placeholdernc{C}@ desired, memory_order order = memory_order_seq_cst) volatile noexcept;
void @\removed{\placeholdernc{A}::}@store(@\placeholdernc{C}@ desired, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}
