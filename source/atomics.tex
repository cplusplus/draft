...
\indexlibrary{\idxcode{atomic<\placeholder{integral}>}!constructor}%
\begin{itemdecl}
constexpr @\removed{\placeholdernc{A}::\placeholdernc{A}}\added{atomic}@(@\removed{\placeholdernc{C}}\added{value_type}@ desired) noexcept;
\end{itemdecl}
...
void @\removed{\placeholdernc{A}::}@store(@\removed{\placeholdernc{C}}\added{value_type}@ desired, memory_order order = memory_order_seq_cst) volatile noexcept;
void @\removed{\placeholdernc{A}::}@store(@\removed{\placeholdernc{C}}\added{value_type}@ desired, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}
...
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator=(@\removed{\placeholdernc{C}}\added{value_type}@ desired) volatile noexcept;
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator=(@\removed{\placeholdernc{C}}\added{value_type}@ desired) noexcept;
\end{itemdecl}
...
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@load(memory_order order = memory_order_seq_cst) const volatile noexcept;
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@load(memory_order order = memory_order_seq_cst) const noexcept;
\end{itemdecl}
...
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@exchange(@\removed{\placeholdernc{C}}\added{value_type}@ desired, memory_order order = memory_order_seq_cst) volatile noexcept;
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@exchange(@\removed{\placeholdernc{C}}\added{value_type}@ desired, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}
...
@\removed{bool atomic_compare_exchange_strong_explicit(\placeholder{A}*\itcorr[-1] object, \placeholder{C}*\itcorr[-1] expected, \placeholdernc{C} desired,}@
    @\removed{memory_order success, memory_order failure) noexcept;}@
bool @\removed{\placeholdernc{A}::}@compare_exchange_weak(@\removed{\placeholder{C}}\added{value_type}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{value_type}@ desired,
    memory_order success, memory_order failure) volatile noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_weak(@\removed{\placeholder{C}}\added{value_type}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{value_type}@ desired,
    memory_order success, memory_order failure) noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_strong(@\removed{\placeholder{C}}\added{value_type}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{value_type}@ desired,
    memory_order success, memory_order failure) volatile noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_strong(@\removed{\placeholder{C}}\added{value_type}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{value_type}@ desired,
    memory_order success, memory_order failure) noexcept;
bool @\removed{\placeholdernc{A}::}@compare_exchange_weak(@\removed{\placeholder{C}}\added{value_type}@&@\itcorr[-1]@ expected, @\removed{\placeholdernc{C}}\added{value_type}@ desired,
...
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@fetch_@\placeholdernc{key}@(@\placeholdernc{M}@ operand, memory_order order = memory_order_seq_cst) volatile noexcept;
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@fetch_@\placeholdernc{key}@(@\placeholdernc{M}@ operand, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}
...
\indexlibrarymember{operator\^{}=}{atomic<\placeholder{integral}>}%
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator @\placeholder{op}@=(@\placeholdernc{M}@ operand) volatile noexcept;
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator @\placeholder{op}@=(@\placeholdernc{M}@ operand) noexcept;
\end{itemdecl}
...
\indexlibrarymember{operator++}{atomic<\placeholder{integral}>}%
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator++(int) volatile noexcept;
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator++(int) noexcept;
\end{itemdecl}
...
\indexlibrarymember{operator++}{atomic<\placeholder{integral}>}%
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator++() volatile noexcept;
@\removed{\placeholdernc{C}}\added{value_type}@ @\removed{\placeholdernc{A}::}@operator++() noexcept;
\end{itemdecl}
