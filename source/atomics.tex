...
\begin{libsumtab}{Atomics library summary}{atomics.lib.summary}
...
\begin{floattable}
{Atomic arithmetic computations}{atomic.arithmetic.computations}{lll|lll}
\hline
...
\begin{floattable}
{Atomic pointer computations}{atomic.pointer.computations}{lll|lll}
\hline
\tcode{Key}       &
  Op          &
  Computation     &
