...
namespace std {
  ...
  @\added{typedef atomic<bool> atomic_bool;}@
  @\added{typedef atomic<char> atomic_char;}@
  @\added{typedef atomic<signed char> atomic_schar;}@
  @\added{typedef atomic<unsigned char> atomic_uchar;}@
  @\added{typedef atomic<short> atomic_short;}@
  @\added{typedef atomic<unsigned short> atomic_ushort;}@
  @\added{typedef atomic<int> atomic_int;}@
  @\added{typedef atomic<unsigned int> atomic_uint;}@
  @\added{typedef atomic<long> atomic_long;}@
  @\added{typedef atomic<unsigned long> atomic_ulong;}@
  @\added{typedef atomic<long long> atomic_llong;}@
  @\added{typedef atomic<unsigned long long> atomic_ullong;}@
  @\added{typedef atomic<char16_t> atomic_char16_t;}@
  @\added{typedef atomic<char32_t> atomic_char32_t;}@
  @\added{typedef atomic<wchar_t> atomic_wchar_t;}@

  @\added{typedef atomic<int8_t> atomic_int8_t;}@
  @\added{typedef atomic<uint8_t> atomic_uint8_t;}@
  @\added{typedef atomic<int16_t> atomic_int16_t;}@
  @\added{typedef atomic<uint16_t> atomic_uint16_t;}@
  @\added{typedef atomic<int32_t> atomic_int32_t;}@
  @\added{typedef atomic<uint32_t> atomic_uint32_t;}@
  @\added{typedef atomic<int64_t> atomic_int64_t;}@
  @\added{typedef atomic<uint64_t> atomic_uint64_t;}@

  @\added{typedef atomic<int_least8_t> atomic_int_least8_t;}@
  @\added{typedef atomic<uint_least8_t> atomic_uint_least8_t;}@
  @\added{typedef atomic<int_least16_t> atomic_int_least16_t;}@
  @\added{typedef atomic<uint_least16_t> atomic_uint_least16_t;}@
  @\added{typedef atomic<int_least32_t> atomic_int_least32_t;}@
  @\added{typedef atomic<uint_least32_t> atomic_uint_least32_t;}@
  @\added{typedef atomic<int_least64_t> atomic_int_least64_t;}@
  @\added{typedef atomic<uint_least64_t> atomic_uint_least64_t;}@

  @\added{typedef atomic<int_fast8_t> atomic_int_fast8_t;}@
  @\added{typedef atomic<uint_fast8_t> atomic_uint_fast8_t;}@
  @\added{typedef atomic<int_fast16_t> atomic_int_fast16_t;}@
  @\added{typedef atomic<uint_fast16_t> atomic_uint_fast16_t;}@
  @\added{typedef atomic<int_fast32_t> atomic_int_fast32_t;}@
  @\added{typedef atomic<uint_fast32_t> atomic_uint_fast32_t;}@
  @\added{typedef atomic<int_fast64_t> atomic_int_fast64_t;}@
  @\added{typedef atomic<uint_fast64_t> atomic_uint_fast64_t;}@

  @\added{typedef atomic<intptr_t> atomic_intptr_t;}@
  @\added{typedef atomic<uintptr_t> atomic_uintptr_t;}@
  @\added{typedef atomic<size_t> atomic_size_t;}@
  @\added{typedef atomic<ptrdiff_t> atomic_ptrdiff_t;}@
  @\added{typedef atomic<intmax_t> atomic_intmax_t;}@
  @\added{typedef atomic<uintmax_t> atomic_uintmax_t;}@
...
\begin{codeblock}
  template <> struct atomic<@\placeholder{integral}@> {
    @\added{typedef \placeholder{integral} value_type;}@
    @\added{typedef value_type difference_type;}@
    static constexpr bool is_always_lock_free = @\impdefx{whether a given \tcode{atomic} type's operations are always lock free}@;
    bool is_lock_free() const volatile noexcept;
    bool is_lock_free() const noexcept;
...
\begin{itemdescr}
\pnum
\effects \removed{As if by \tcode{fetch_\placeholder{key}(operand)}.} \added{Equivalent to: \tcode{return fetch_\placeholder{key}(operand);}}
...
\removed{These s}\added{S}pecializations \removed{shall be} \added{of this partical specialization are} standard-layout structs.
...
\rSec1[atomics.typedefs]{Typedefs}
...
\added{The typedefs} \tcode{atomic_int$N$_t}, \tcode{atomic_uint$N$_t},
