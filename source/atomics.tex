...
namespace std {
  ...
  template <class T>
    T atomic_fetch_add(volatile @atomic<T>@*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_add(@atomic<T>@*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_add_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
    T atomic_fetch_add_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
    T atomic_fetch_sub(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_sub(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@) noexcept;
  template <class T>
    T atomic_fetch_sub_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
    T atomic_fetch_sub_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
  ...
  template <class T>
    T atomic_fetch_and_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
    T atomic_fetch_and_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
  ...
  template <class T>
    T atomic_fetch_or_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
    T atomic_fetch_or_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
  ...
  template <class T>
    T atomic_fetch_xor_explicit(volatile atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  template <class T>
    T atomic_fetch_xor_explicit(atomic<T>*, @\removed{T}\added{typename atomic<T>::value_type}@, memory_order) noexcept;
  ...
  // \ref{atomics.types.operations.pointer}, overloads for pointers
  template <class T>
