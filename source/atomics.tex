...
read \removed{from \tcode{object} or} by \tcode{this} during the atomic comparison.
...
\tcode{char32_t},
\tcode{wchar_t},
and any other types needed by the typedefs in \added{section}~\ref{atomics.typedefs} \removed{the header \tcode{<cstdint>}}.
...
\begin{itemdescr}
\pnum
\added{\requires T shall be an object type.}
...
\rSec2[atomics.types.memop]{Member operators common to integers and pointers}
...
bool remove_use {       // \added{returns \tcode{true} if last use was removed}
