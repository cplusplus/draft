...
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@fetch_@\placeholdernc{key}@(@\placeholdernc{M}@ operand, memory_order order = memory_order_seq_cst) volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@fetch_@\placeholdernc{key}@(@\placeholdernc{M}@ operand, memory_order order = memory_order_seq_cst) noexcept;
\end{itemdecl}
...
\indexlibrarymember{operator\^{}=}{atomic<\placeholder{integral}>}%
\begin{itemdecl}
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator @\placeholder{op}@=(@\placeholdernc{M}@ operand) volatile noexcept;
@\removed{\placeholdernc{C}}\added{T}@ @\removed{\placeholdernc{A}::}@operator @\placeholder{op}@=(@\placeholdernc{M}@ operand) noexcept;
\end{itemdecl}
