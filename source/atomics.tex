%!TEX root = std.tex
\subclause0[atomics]{Atomic operations library}

\subclause1[atomics.general]{General}
...
\subclause1[atomics.syn]{Header \tcode{<atomic>} synopsis}
...
\subclause1[atomics.alias]{Type aliases}
...
\subclause1[atomics.order]{Order and consistency}
...
\subclause1[atomics.lockfree]{Lock-free property}
...
\subclause1[atomics.wait]{Waiting and notifying}
...
\subclause1[atomics.ref.generic]{Class template \tcode{atomic_ref}}

\subclause2[atomics.ref.generic.general]{General}
...
\subclause2[atomics.ref.ops]{Operations}
...
\subclause2[atomics.ref.int]{Specializations for integral types}
...
\subclause2[atomics.ref.float]{Specializations for floating-point types}
...
\subclause2[atomics.ref.pointer]{Partial specialization for pointers}
...
\subclause2[atomics.ref.memop]{Member operators
...
\subclause1[atomics.types.generic]{Class template \tcode{atomic}}

\subclause2[atomics.types.generic.general]{General}
...
\subclause2[atomics.types.operations]{Operations on atomic types}
...
\subclause2[atomics.types.int]{Specializations for integers}
...
\subclause2[atomics.types.float]{Specializations for floating-point types}
...
\subclause2[atomics.types.pointer]{Partial specialization for pointers}
...
\subclause2[atomics.types.memop]{Member operators common to integers and pointers to objects}
...
\subclause2[util.smartptr.atomic]{Partial specializations for smart pointers}%
\indextext{atomic!smart pointers|(}%

\subclause3[util.smartptr.atomic.general]{General}
...
\subclause3[util.smartptr.atomic.shared]{Partial specialization for \tcode{shared_ptr}}
...
\subclause3[util.smartptr.atomic.weak]{Partial specialization for \tcode{weak_ptr}}
...
\subclause1[atomics.nonmembers]{Non-member functions}
...
\subclause1[atomics.flag]{Flag type and operations}
...
\subclause1[atomics.fences]{Fences}
...
\subclause1[stdatomic.h.syn]{C compatibility}
