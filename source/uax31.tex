...
\tcode{<Medial>} is a list of characters permitted between continue characters. \UAX{31}
also specifies some standard profiles, including the Mathematical Compatability Notation
profile.
