...
which is an \link{unevaluated operand}{term.unevaluated.operand}, or a parenthesized
...
the behavior is undefined\ubdef{expr.mptr.oper.member.func.null}.
...
are not \deflinkx{similar}{similar types}{conv.qual}, the behavior is undefined\ubdef{expr.add.not.similar}.
\begin{example}
\begin{codeblock}
int arr[5] = {1, 2, 3, 4, 5};
...
\deflinkx{named by}{function!named by expression or conversion}{basic.def.odr}
an expression
