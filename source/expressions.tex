...
\pnum
A \defnadj{component}{name} of an \grammarterm{unqualified-id} $U$ is $U$
if it is a name or the component name of the \grammarterm{template-id} or \grammarterm{type-name} of $U$, if any.
\begin{note}
