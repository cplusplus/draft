...
\subclause1[expr.prop]{Properties of expressions}

\subclause2[basic.lval]{Value category}
\pnum
...
\subclause2[expr.context]{Context dependence}
...
\subclause1[conv]{Standard conversions}

\subclause2[conv.general]{General}
...
\subclause2[conv.lval]{Lvalue-to-rvalue conversion}
...
\subclause2[conv.array]{Array-to-pointer conversion}
...
\subclause2[conv.func]{Function-to-pointer conversion}
...
\subclause2[conv.rval]{Temporary materialization conversion}
...
\subclause2[conv.qual]{Qualification conversions}
...
\subclause2[conv.prom]{Integral promotions}
...
\subclause2[conv.fpprom]{Floating-point promotion}
...
\subclause2[conv.integral]{Integral conversions}
...
\subclause2[conv.double]{Floating-point conversions}
...
\subclause2[conv.fpint]{Floating-integral conversions}
...
\subclause2[conv.ptr]{Pointer conversions}
...
\subclause2[conv.mem]{Pointer-to-member conversions}
...
\subclause2[conv.fctptr]{Function pointer conversions}
...
\subclause2[conv.bool]{Boolean conversions}
...
\subclause1[expr.arith.conv]{Usual arithmetic conversions}
...
\subclause1[expr.prim]{Primary expressions}%
...
\subclause2[expr.prim.literal]{Literals}
...
\subclause2[expr.prim.this]{This}
...
\subclause2[expr.prim.paren]{Parentheses}
...
\subclause2[expr.prim.id]{Names}

\subclause3[expr.prim.id.general]{General}
...
\subclause3[expr.prim.id.unqual]{Unqualified names}
...
\subclause3[expr.prim.id.qual]{Qualified names}
...
\subclause3[expr.prim.id.dtor]{Destruction}
...
\subclause2[expr.prim.lambda]{Lambda expressions}%

\subclause3[expr.prim.lambda.general]{General}%
...
\subclause3[expr.prim.lambda.closure]{Closure types}%
...
\subclause3[expr.prim.lambda.capture]{Captures}%
...
\subclause2[expr.prim.fold]{Fold expressions}%
...
\subclause2[expr.prim.req]{Requires expressions}

\subclause3[expr.prim.req.general]{General}
...
\subclause3[expr.prim.req.simple]{Simple requirements}
...
\subclause3[expr.prim.req.type]{Type requirements}
...
\subclause3[expr.prim.req.compound]{Compound requirements}
...
\subclause3[expr.prim.req.nested]{Nested requirements}
...
\subclause1[expr.compound]{Compound expressions}

\subclause2[expr.post]{Postfix expressions}%

\subclause3[expr.post.general]{General}%
...
\subclause3[expr.sub]{Subscripting}
...
\subclause3[expr.call]{Function call}
...
\subclause3[expr.type.conv]{Explicit type conversion (functional notation)}
...
\subclause3[expr.ref]{Class member access}
...
\subclause3[expr.post.incr]{Increment and decrement}
...
\subclause3[expr.dynamic.cast]{Dynamic cast}
...
\subclause3[expr.typeid]{Type identification}
...
\subclause3[expr.static.cast]{Static cast}
...
\subclause3[expr.reinterpret.cast]{Reinterpret cast}
...
\subclause3[expr.const.cast]{Const cast}
...
\subclause2[expr.unary]{Unary expressions}

\subclause3[expr.unary.general]{General}
...
\subclause3[expr.unary.op]{Unary operators}
...
\subclause3[expr.pre.incr]{Increment and decrement}
...
\subclause3[expr.alignof]{Alignof}
...
\subclause3[expr.unary.noexcept]{\tcode{noexcept} operator}
...
\subclause2[expr.cast]{Explicit type conversion (cast notation)}%
\indextext{expression!cast|(}
...
\subclause2[expr.mptr.oper]{Pointer-to-member operators}
...
\subclause2[expr.mul]{Multiplicative operators}%
...
\subclause2[expr.add]{Additive operators}%
...
\subclause2[expr.shift]{Shift operators}
...
\subclause2[expr.spaceship]{Three-way comparison operator}
...
\subclause2[expr.rel]{Relational operators}%
...
\subclause2[expr.eq]{Equality operators}%
...
\subclause2[expr.bit.and]{Bitwise AND operator}%
...
\subclause2[expr.xor]{Bitwise exclusive OR operator}%
...
\subclause2[expr.or]{Bitwise inclusive OR operator}%
...
\subclause2[expr.log.and]{Logical AND operator}%
...
\subclause2[expr.log.or]{Logical OR operator}%
...
\subclause2[expr.cond]{Conditional operator}%
...
\subclause2[expr.yield]{Yielding a value}%
...
\subclause2[expr.throw]{Throwing an exception}%
...
\subclause2[expr.ass]{Assignment and compound assignment operators}%
...
\subclause2[expr.comma]{Comma operator}%
...
\subclause1[expr.const]{Constant expressions}%
