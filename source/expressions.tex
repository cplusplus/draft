...
the operator yields a prvalue of type \tcode{std::strong_ordering}.
The result is
...
the operator yields a prvalue of type \tcode{std::partial_ordering}.
...
\tcode{std::nullptr_t},
the operator yields a prvalue of type \tcode{std::strong_equality};
the operator yields
...
\tcode{p <=> q} returns a \tcode{strong_ordering}.
