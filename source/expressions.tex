...
variable with automatic storage duration (this excludes any \grammarterm{id-expression}
that has been found to refer to an \grammarterm{init-capture}{'s} associated
non-static data member), and the odr-used entity is not explicitly
...
storage duration, to the address one past the last element of an array with
static storage duration, to the address of a function, or to a null pointer
