...
\nontermdef{lambda-expression}\br
    ...
    lambda-introducer lambda-declarator requires-clause\opt{} compound-statement\br
    lambda-introducer \terminal{<} template-parameter-list \terminal{>} requires-clause\opt{} compound-statement\br
    lambda-introducer \terminal{<} template-parameter-list \terminal{>} requires-clause\opt{}\br
    \hspace*{\bnfindentinc}lambda-declarator requires-clause\opt{} compound-statement
\end{bnf}
