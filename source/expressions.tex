...
the behavior is undefined:\footnote{The intent of this list is
to specify those circumstances in which an object may or may not be aliased.}
\begin{itemize}
\item \cv{} \tcode{T}

\item a type similar (as defined in~\ref{conv.qual}) to \tcode{T},
...
that refers to the object to be deleted is different from its dynamic type
...
that refers to the first element of the object to be deleted
