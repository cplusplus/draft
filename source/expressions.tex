...
argument by invoking \tcode{\libmacro{va_arg}}\iref{support.runtime}.
\begin{note}
...
\item
an invocation of the \tcode{\libmacro{va_arg}} macro\iref{cstdarg.syn};
...
\item
an invocation of the \tcode{\libmacro{va_start}} macro\iref{cstdarg.syn}.
\end{itemize}
