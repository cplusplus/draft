%!TEX root = std.tex
\subclause0[concepts]{Concepts library}

\subclause1[concepts.general]{General}
...
\subclause1[concepts.equality]{Equality preservation}
...
\subclause1[concepts.syn]{Header \tcode{<concepts>} synopsis}
...
\subclause1[concepts.lang]{Language-related concepts}

\subclause2[concepts.lang.general]{General}
...
\subclause2[concept.same]{Concept \cname{same_as}}
...
\subclause2[concept.derived]{Concept \cname{derived_from}}
...
\subclause2[concept.convertible]{Concept \cname{convertible_to}}
...
\subclause2[concept.commonref]{Concept \cname{common_reference_with}}
...
\subclause2[concept.common]{Concept \cname{common_with}}
...
\subclause2[concepts.arithmetic]{Arithmetic concepts}
...
\subclause2[concept.assignable]{Concept \cname{assignable_from}}
...
\subclause2[concept.swappable]{Concept \cname{swappable}}
...
\subclause2[concept.destructible]{Concept \cname{destructible}}
...
\subclause2[concept.constructible]{Concept \cname{constructible_from}}
...
\subclause2[concept.default.init]{Concept \cname{default_initializable}}
...
\subclause2[concept.moveconstructible]{Concept \cname{move_constructible}}
...
\subclause2[concept.copyconstructible]{Concept \cname{copy_constructible}}
...
\subclause1[concepts.compare]{Comparison concepts}

\subclause2[concepts.compare.general]{General}
...
\subclause2[concept.booleantestable]{Boolean testability}
...
\subclause2[concept.equalitycomparable]{Concept \cname{equality_comparable}}
...
\subclause2[concept.totallyordered]{Concept \cname{totally_ordered}}
...
\subclause1[concepts.object]{Object concepts}
...
\subclause1[concepts.callable]{Callable concepts}

\subclause2[concepts.callable.general]{General}
...
\subclause2[concept.invocable]{Concept \cname{invocable}}
...
\subclause2[concept.regularinvocable]{Concept \cname{regular_invocable}}
...
\subclause2[concept.predicate]{Concept \cname{predicate}}
...
\subclause2[concept.relation]{Concept \cname{relation}}
...
\subclause2[concept.equiv]{Concept \cname{equivalence_relation}}
...
\subclause2[concept.strictweakorder]{Concept \cname{strict_weak_order}}
