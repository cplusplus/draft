...
preserving expressions. It effectively forbids spontaneous changes to an object,
changes to an object from another thread of execution, changes to an object as
side effects of non-modifying expressions, and changes to an object as side
effects of modifying a distinct object if those changes could be observable to a
library function via an equality preserving expression that is required to be
...
\rSec2[concepts.lib.corelang.same]{Concept \libconcept{Same}}
...
\rSec2[concepts.lib.corelang.derived]{Concept \libconcept{DerivedFrom}}
...
\rSec2[concepts.lib.corelang.commonref]{Concept \libconcept{CommonReference}}
...
\rSec2[concepts.lib.corelang.common]{Concept \libconcept{Common}}
...
\item \tcode{C(t())} equals \tcode{C(t())} if and only if
  ...
  expression\iref{concepts.lib.general.equality}.
...
\rSec2[concepts.lib.corelang.integral]{Concept \libconcept{Integral}}
...
\rSec2[concepts.lib.corelang.unsignedintegral]{Concept \libconcept{UnsignedIntegral}}
...
\rSec2[concepts.lib.corelang.assignable]{Concept \libconcept{Assignable}}
...
\rSec2[concepts.lib.corelang.swappable]{Concept \libconcept{Swappable}}
...
\pnum
The context in which \tcode{swap(a1, b1)} or \tcode{swap(b1, a1)} are evaluated
...
\rSec2[concepts.lib.corelang.destructible]{Concept \libconcept{Destructible}}
...
\rSec2[concepts.lib.corelang.constructible]{Concept \libconcept{Constructible}}
...
\rSec2[concepts.lib.corelang.defaultconstructible]{Concept \libconcept{DefaultConstructible}}
...
\rSec2[concepts.lib.corelang.moveconstructible]{Concept \libconcept{MoveConstructible}}
...
\rSec2[concepts.lib.corelang.copyconstructible]{Concept \libconcept{CopyConstructible}}
...
\rSec2[concepts.lib.compare.boolean]{Concept \libconcept{Boolean}}
...
\rSec2[concepts.lib.compare.equalitycomparable]{Concept \libconcept{EqualityComparable}}
...
\tcode{b}\iref{concepts.lib.general.equality}, and \tcode{false} otherwise.
...
\rSec2[concepts.lib.compare.stricttotallyordered]{Concept \libconcept{StrictTotallyOrdered}}
...
\rSec2[concepts.lib.object.general]{General}
\pnum
...
\rSec2[concepts.lib.object.movable]{Concept \libconcept{Movable}}
...
\rSec2[concepts.lib.object.copyable]{Concept \libconcept{Copyable}}
...
\rSec2[concepts.lib.object.semiregular]{Concept \libconcept{Semiregular}}
...
\rSec2[concepts.lib.object.regular]{Concept \libconcept{Regular}}
...
\rSec2[concepts.lib.callable.invocable]{Concept \libconcept{Invocable}}
...
equality-preserving\iref{concepts.lib.general.equality}.
\end{example}
\end{itemdescr}

\rSec2[concepts.lib.callable.regularinvocable]{Concept \libconcept{RegularInvocable}}
...
arguments\iref{concepts.lib.general.equality}.
\begin{note}
...
\rSec2[concepts.lib.callable.predicate]{Concept \libconcept{Predicate}}
...
\rSec2[concepts.lib.callable.relation]{Concept \libconcept{Relation}}
...
\rSec2[concepts.lib.callable.strictweakorder]{Concept \libconcept{StrictWeakOrder}}
