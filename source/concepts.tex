...
\indexlibraryglobal{derived_from}%
\begin{itemdecl}
template<class Derived, class Base>
...
\indexlibraryglobal{convertible_to}%
\begin{itemdecl}
template<class From, class To>
...
\indexlibraryglobal{common_reference_with}%
\begin{itemdecl}
template<class T, class U>
...
\indexlibraryglobal{common_with}%
\begin{itemdecl}
template<class T, class U>
  concept common_with =
...
\indexlibraryglobal{integral}%
\indexlibraryglobal{signed_integral}%
\indexlibraryglobal{unsigned_integral}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{assignable_from}%
\begin{itemdecl}
template<class LHS, class RHS>
...
\indexlibraryglobal{swappable}%
\begin{itemdecl}
template<class T>
  concept swappable = requires(T& a, T& b) { ranges::swap(a, b); };
\end{itemdecl}

\indexlibraryglobal{swappable_with}%
\begin{itemdecl}
template<class T, class U>
...
\indexlibraryglobal{destructible}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{constructible_from}%
\begin{itemdecl}
template<class T, class... Args>
...
\indexlibraryglobal{default_constructible}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{move_constructible}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{copy_constructible}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{equality_comparable}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{equality_comparable_with}%
\begin{itemdecl}
template<class T, class U>
...
\indexlibraryglobal{totally_ordered}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{movable}%
\indexlibraryglobal{copyable}%
\indexlibraryglobal{semiregular}%
\indexlibraryglobal{regular}%
\begin{itemdecl}
template<class T>
...
\indexlibraryglobal{regular_invocable}%
\begin{itemdecl}
template<class F, class... Args>
...
\indexlibraryglobal{strict_weak_order}%
\begin{itemdecl}
template<class R, class T, class U>
