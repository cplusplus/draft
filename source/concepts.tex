...
\begin{codeblock}
namespace std {
  // \ref{concepts.lang}, core language concepts:
...
\rSec1[concepts.lang]{Core language concepts}
...
\tcode{b}\iref{concepts.general.equality}, and \tcode{false} otherwise.
...
equality-preserving\iref{concepts.general.equality}.
\end{example}
\end{itemdescr}
...
arguments\iref{concepts.general.equality}.
\begin{note}
