...
and let \tcode{g} be a function with no arguments and return type \tcode{From}
such that \tcode{g()} is equality-preserving.
...
\tcode{static_cast<To>(g())} is equal to \tcode{test(g)}; and
