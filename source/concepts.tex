...
\begin{itemdecl}
template<class T>
  concept DefaultConstructible = constructible_from<T>;
\end{itemdecl}
...
\begin{itemdecl}
template<class T>
  concept MoveConstructible = constructible_from<T, T> && convertible_to<T, T>;
\end{itemdecl}
...
\begin{itemdecl}
template<class T>
  concept Movable = is_object_v<T> && MoveConstructible<T> && assignable_from<T&, T> && swappable<T>;
template<class T>
  concept Copyable = CopyConstructible<T> && Movable<T> && assignable_from<T&, const T&>;
template<class T>
