%!TEX root = std.tex
\subclause0[diagnostics]{Diagnostics library}

\subclause1[diagnostics.general]{General}
...
\subclause1[std.exceptions]{Exception classes}

\subclause2[std.exceptions.general]{General}
...
\subclause2[stdexcept.syn]{Header \tcode{<stdexcept>} synopsis}
...
\subclause2[logic.error]{Class \tcode{logic_error}}
...
\subclause2[domain.error]{Class \tcode{domain_error}}
...
\subclause2[invalid.argument]{Class \tcode{invalid_argument}}
...
\subclause2[length.error]{Class \tcode{length_error}}
...
\subclause2[out.of.range]{Class \tcode{out_of_range}}
...
\subclause2[runtime.error]{Class \tcode{runtime_error}}
...
\subclause2[range.error]{Class \tcode{range_error}}
...
\subclause2[overflow.error]{Class \tcode{overflow_error}}
...
\subclause2[underflow.error]{Class \tcode{underflow_error}}
...
\subclause1[assertions]{Assertions}

\subclause2[assertions.general]{General}
...
\subclause2[cassert.syn]{Header \tcode{<cassert>} synopsis}
...
\subclause2[assertions.assert]{The \tcode{assert} macro}
...
\subclause1[errno]{Error numbers}

\subclause2[errno.general]{General}
...
\subclause2[cerrno.syn]{Header \tcode{<cerrno>} synopsis}
...
\subclause1[syserr]{System error support}

\subclause2[syserr.general]{General}
...
\subclause2[system.error.syn]{Header \tcode{<system_error>} synopsis}
...
\subclause2[syserr.errcat]{Class \tcode{error_category}}

\subclause3[syserr.errcat.overview]{Overview}
...
\subclause3[syserr.errcat.virtuals]{Virtual members}
...
\subclause3[syserr.errcat.nonvirtuals]{Non-virtual members}
...
\subclause3[syserr.errcat.derived]{Program-defined classes derived from \tcode{error_category}}
...
\subclause3[syserr.errcat.objects]{Error category objects}
...
\subclause2[syserr.errcode]{Class \tcode{error_code}}

\subclause3[syserr.errcode.overview]{Overview}
...
\subclause3[syserr.errcode.constructors]{Constructors}
...
\subclause3[syserr.errcode.modifiers]{Modifiers}
...
\subclause3[syserr.errcode.observers]{Observers}
...
\subclause3[syserr.errcode.nonmembers]{Non-member functions}
...
\subclause2[syserr.errcondition]{Class \tcode{error_condition}}

\subclause3[syserr.errcondition.overview]{Overview}
...
\subclause3[syserr.errcondition.constructors]{Constructors}
...
\subclause3[syserr.errcondition.modifiers]{Modifiers}
...
\subclause3[syserr.errcondition.observers]{Observers}
...
\subclause3[syserr.errcondition.nonmembers]{Non-member functions}
...
\subclause2[syserr.compare]{Comparison operator functions}
...
\subclause2[syserr.hash]{System error hash support}
...
\subclause2[syserr.syserr]{Class \tcode{system_error}}

\subclause3[syserr.syserr.overview]{Overview}
...
\subclause3[syserr.syserr.members]{Members}
