...
\pnum
Otherwise, the \tcode{\libmacro{assert}} macro puts a diagnostic test into programs;
...
\libheader{errno.h}, except that \tcode{\libmacro{errno}} shall be defined as a macro.
\begin{note}
