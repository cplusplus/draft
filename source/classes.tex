...
classes are called its \defnadjx{potentially constructed}{subobjects}{subobject}.
...
void foo() {
  ...
  c.C::f();         // calls \tcode{A::f} because of the \grammarterm{using-declaration}
}
\end{codeblock}
\end{example}
...
C::C(): global_A() { }          // \grammarterm{mem-initializer} for base \tcode{A}
\end{codeblock}
\end{example}
