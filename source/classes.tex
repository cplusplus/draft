...
\subclause1[class.prop]{Properties of classes}
...
\subclause1[class.name]{Class names}
...
\subclause1[class.mem]{Class members}%

\subclause2[class.mem.general]{General}%
...
\subclause2[class.mfct]{Member functions}%
...
\subclause2[class.mfct.non-static]{Non-static member functions}%
...
\subclause2[special]{Special member functions}
...
\subclause2[class.ctor]{Constructors}%

\subclause3[class.ctor.general]{General}%
...
\subclause3[class.default.ctor]{Default constructors}
...
\subclause3[class.copy.ctor]{Copy/move constructors}%
...
\subclause2[class.copy.assign]{Copy/move assignment operator}%
...
\subclause2[class.dtor]{Destructors}%
...
\subclause2[class.conv]{Conversions}

\subclause3[class.conv.general]{General}
...
\subclause3[class.conv.ctor]{Conversion by constructor}%
...
\subclause3[class.conv.fct]{Conversion functions}%
...
\subclause2[class.static]{Static members}%

\subclause3[class.static.general]{General}%
...
\subclause3[class.static.mfct]{Static member functions}
...
\subclause3[class.static.data]{Static data members}
...
\subclause2[class.bit]{Bit-fields}%
\indextext{bit-field}
...
\subclause2[class.nest]{Nested class declarations}%
...
\subclause1[class.union]{Unions}%

\subclause2[class.union.general]{General}%
...
\subclause2[class.union.anon]{Anonymous unions}
...
\subclause1[class.local]{Local class declarations}
...
\subclause1[class.derived]{Derived classes}%

\subclause2[class.derived.general]{General}%
...
\subclause2[class.mi]{Multiple base classes}
\indextext{multiple inheritance}%
\indextext{base class}%
...
\subclause2[class.virtual]{Virtual functions}%
...
\subclause2[class.abstract]{Abstract classes}%
...
\subclause1[class.access]{Member access control}%

\subclause2[class.access.general]{General}%
...
\subclause2[class.access.spec]{Access specifiers}%
...
\subclause2[class.access.base]{Accessibility of base classes and base class members}%
...
\subclause2[class.friend]{Friends}%
...
\subclause2[class.protected]{Protected member access}
\indextext{access control!\idxcode{protected}}%
...
\subclause2[class.access.virt]{Access to virtual functions}%
...
\subclause2[class.paths]{Multiple access}%
...
\subclause2[class.access.nest]{Nested classes}%
...
\subclause1[class.init]{Initialization}%

\subclause2[class.init.general]{General}%
...
\subclause2[class.expl.init]{Explicit initialization}%
...
\subclause2[class.base.init]{Initializing bases and members}%
...
\subclause2[class.inhctor.init]{Initialization by inherited constructor}%
...
\subclause2[class.cdtor]{Construction and destruction}%
...
\subclause2[class.copy.elision]{Copy/move elision}%
...
\subclause1[class.compare]{Comparisons}%

\subclause2[class.compare.default]{Defaulted comparison operator functions}%
...
\subclause2[class.eq]{Equality operator}
...
\subclause2[class.spaceship]{Three-way comparison}
...
\subclause2[class.compare.secondary]{Secondary comparison operators}
...
\subclause1[class.free]{Free store}%
