%!TEX root = std.tex
\subclause0[containers]{Containers library}

\subclause1[containers.general]{General}
...
\subclause1[container.requirements]{Container requirements}%
\indextext{requirements!container}

\subclause2[container.requirements.general]{General container requirements}
...
\subclause2[container.requirements.dataraces]{Container data races}
...
\subclause2[sequence.reqmts]{Sequence containers}
...
\subclause2[container.node]{Node handles}

\subclause3[container.node.overview]{Overview}
...
\subclause3[container.node.cons]{Constructors, copy, and assignment}
...
\subclause3[container.node.dtor]{Destructor}
...
\subclause3[container.node.observers]{Observers}
...
\subclause3[container.node.modifiers]{Modifiers}
...
\subclause2[container.insert.return]{Insert return type}
...
\subclause2[associative.reqmts]{Associative containers}

\subclause3[associative.reqmts.general]{General}
...
\subclause3[associative.reqmts.except]{Exception safety guarantees}%
...
\subclause2[unord.req]{Unordered associative containers}%
...
\subclause3[unord.req.general]{General}
...
\subclause3[unord.req.except]{Exception safety guarantees}
...
\subclause1[sequences]{Sequence containers}

\subclause2[sequences.general]{In general}
...
\subclause2[array.syn]{Header \tcode{<array>} synopsis}
...
\subclause2[deque.syn]{Header \tcode{<deque>} synopsis}
...
\subclause2[forward.list.syn]{Header \tcode{<forward_list>} synopsis}
...
\subclause2[list.syn]{Header \tcode{<list>} synopsis}
...
\subclause2[vector.syn]{Header \tcode{<vector>} synopsis}
...
\subclause2[array]{Class template \tcode{array}}
\indexlibraryglobal{array}%

\subclause3[array.overview]{Overview}
...
\subclause3[array.cons]{Constructors, copy, and assignment}
...
\subclause3[array.members]{Member functions}
...
\subclause3[array.special]{Specialized algorithms}
...
\subclause3[array.zero]{Zero-sized arrays}
...
\subclause3[array.creation]{Array creation functions}
...
\subclause3[array.tuple]{Tuple interface}
\indexlibraryglobal{array}%
...
\subclause2[deque]{Class template \tcode{deque}}

\subclause3[deque.overview]{Overview}
...
\subclause3[deque.cons]{Constructors, copy, and assignment}
...
\subclause3[deque.capacity]{Capacity}
...
\subclause3[deque.modifiers]{Modifiers}
...
\subclause3[deque.erasure]{Erasure}
...
\subclause2[forward.list]{Class template \tcode{forward_list}}

\subclause3[forward.list.overview]{Overview}
...
\subclause3[forward.list.cons]{Constructors, copy, and assignment}
...
\subclause3[forward.list.iter]{Iterators}
...
\subclause3[forward.list.access]{Element access}
...
\subclause3[forward.list.modifiers]{Modifiers}
...
\subclause3[forward.list.ops]{Operations}
...
\subclause3[forward.list.erasure]{Erasure}
...
\subclause2[list]{Class template \tcode{list}}

\subclause3[list.overview]{Overview}
...
\subclause3[list.cons]{Constructors, copy, and assignment}
...
\subclause3[list.capacity]{Capacity}
...
\subclause3[list.modifiers]{Modifiers}
...
\subclause3[list.ops]{Operations}
...
\subclause3[list.erasure]{Erasure}
...
\subclause2[vector]{Class template \tcode{vector}}

\subclause3[vector.overview]{Overview}
...
\subclause3[vector.cons]{Constructors}
...
\subclause3[vector.capacity]{Capacity}
...
\subclause3[vector.modifiers]{Modifiers}
...
\subclause3[vector.erasure]{Erasure}
...
\subclause2[vector.bool]{Class \tcode{vector<bool>}}
...
\subclause1[associative]{Associative containers}

\subclause2[associative.general]{In general}
...
\subclause2[associative.map.syn]{Header \tcode{<map>} synopsis}
...
\subclause2[associative.set.syn]{Header \tcode{<set>} synopsis}%
...
\subclause2[map]{Class template \tcode{map}}

\subclause3[map.overview]{Overview}
...
\subclause3[map.cons]{Constructors, copy, and assignment}%
...
\subclause3[map.access]{Element access}
...
\subclause3[map.modifiers]{Modifiers}
...
\subclause3[map.erasure]{Erasure}
...
\subclause2[multimap]{Class template \tcode{multimap}}

\subclause3[multimap.overview]{Overview}
...
\subclause3[multimap.cons]{Constructors}
...
\subclause3[multimap.modifiers]{Modifiers}
...
\subclause3[multimap.erasure]{Erasure}
...
\subclause2[set]{Class template \tcode{set}}

\subclause3[set.overview]{Overview}
...
\subclause3[set.cons]{Constructors, copy, and assignment}
...
\subclause3[set.erasure]{Erasure}
...
\subclause2[multiset]{Class template \tcode{multiset}}

\subclause3[multiset.overview]{Overview}
...
\subclause3[multiset.cons]{Constructors}
...
\subclause3[multiset.erasure]{Erasure}
...
\subclause1[unord]{Unordered associative containers}

\subclause2[unord.general]{In general}
...
\subclause2[unord.map.syn]{Header \tcode{<unordered_map>} synopsis}
...
\subclause2[unord.set.syn]{Header \tcode{<unordered_set>} synopsis}
...
\subclause2[unord.map]{Class template \tcode{unordered_map}}%
\indexlibraryglobal{unordered_map}

\subclause3[unord.map.overview]{Overview}
...
\subclause3[unord.map.cnstr]{Constructors}
...
\subclause3[unord.map.elem]{Element access}
...
\subclause3[unord.map.modifiers]{Modifiers}
...
\subclause3[unord.map.erasure]{Erasure}
...
\subclause2[unord.multimap]{Class template \tcode{unordered_multimap}}%
\indexlibraryglobal{unordered_multimap}

\subclause3[unord.multimap.overview]{Overview}
...
\subclause3[unord.multimap.cnstr]{Constructors}
...
\subclause3[unord.multimap.modifiers]{Modifiers}
...
\subclause3[unord.multimap.erasure]{Erasure}
...
\subclause2[unord.set]{Class template \tcode{unordered_set}}%
\indexlibraryglobal{unordered_set}

\subclause3[unord.set.overview]{Overview}
...
\subclause3[unord.set.cnstr]{Constructors}
...
\subclause3[unord.set.erasure]{Erasure}
...
\subclause2[unord.multiset]{Class template \tcode{unordered_multiset}}%
\indexlibraryglobal{unordered_multiset}

\subclause3[unord.multiset.overview]{Overview}
...
\subclause3[unord.multiset.cnstr]{Constructors}
...
\subclause3[unord.multiset.erasure]{Erasure}
...
\subclause1[container.adaptors]{Container adaptors}

\subclause2[container.adaptors.general]{In general}
...
\subclause2[queue.syn]{Header \tcode{<queue>} synopsis}
...
\subclause2[stack.syn]{Header \tcode{<stack>} synopsis}
...
\subclause2[queue]{Class template \tcode{queue}}

\subclause3[queue.defn]{Definition}
...
\subclause3[queue.cons]{Constructors}
...
\subclause3[queue.cons.alloc]{Constructors with allocators}
...
\subclause3[queue.ops]{Operators}
...
\subclause3[queue.special]{Specialized algorithms}
...
\subclause2[priority.queue]{Class template \tcode{priority_queue}}

\subclause3[priqueue.overview]{Overview}
...
\subclause3[priqueue.cons]{Constructors}
...
\subclause3[priqueue.cons.alloc]{Constructors with allocators}
...
\subclause3[priqueue.members]{Members}
...
\subclause3[priqueue.special]{Specialized algorithms}
...
\subclause2[stack]{Class template \tcode{stack}}

\subclause3[stack.general]{General}
...
\subclause3[stack.defn]{Definition}
...
\subclause3[stack.cons]{Constructors}
...
\subclause3[stack.cons.alloc]{Constructors with allocators}
...
\subclause3[stack.ops]{Operators}
...
\subclause3[stack.special]{Specialized algorithms}
...
\subclause1[views]{Views}

\subclause2[views.general]{General}

\pnum
The header \libheader{span} defines the view \tcode{span}.

\subclause2[span.syn]{Header \tcode{<span>} synopsis}%
...
\subclause2[views.span]{Class template \tcode{span}}

\subclause3[span.overview]{Overview}
...
\subclause3[span.cons]{Constructors, copy, and assignment}
...
\subclause3[span.deduct]{Deduction guides}
...
\subclause3[span.elem]{Element access}
...
\subclause3[span.iterators]{Iterator support}
...
\subclause3[span.objectrep]{Views of object representation}
