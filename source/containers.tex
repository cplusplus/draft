...
\begin{libsumtab}{Containers library summary}{containers.lib.summary}
...
{containers.reversible.requirements}
\\ \topline
...
{containers.optional.operations}
\\ \topline
\lhdr{Expression}       &   \chdr{Return type}  &   \chdr{Operational}  &
\chdr{Assertion/note}   &   \rhdr{Complexity}   \\
    &   &   \chdr{semantics}    &   \chdr{pre-/post-condition}   &      \\ \capsep
...
{containers.sequence.requirements}
\\ \topline
...
\begin{floattable}{Container types with compatible nodes}{containers.node.compat}
{ll}
\topline
...
{containers.associative.requirements}
\\ \topline
