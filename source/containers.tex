...
\pnum
\tcode{strided_slice} and \tcode{range_slice} represent a set of
...
\pnum
\tcode{strided_slice} and \tcode{range_slice}
...
\begin{note}
Both \tcode{strided_slice\{.offset = 1, .extent = 4, .stride = 3\}} and
...
\pnum
\returns
\tcode{strided_slice\{ .offset = offset, .extent = extent, .stride = stride \};}
\end{itemdescr}
