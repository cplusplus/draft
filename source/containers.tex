...
\ref{views}                  & Views                            & \tcode{<span>}, \tcode{<mdspan>} \\
\end{libsumtab}
...
\rSec2[mdspan.syn]{Header \tcode{<mdspan>} synopsis}
...
namespace std {
  ...
  public:
    ...
    template<class OtherSizeType, size_t... OtherExtents>
      constexpr explicit(@\seebelow@)
        extents(const extents<OtherSizeType, OtherExtents...>&) noexcept;
    template<class... OtherSizeTypes>
      constexpr explicit extents(OtherSizeTypes...) noexcept;
    template<class OtherSizeType, size_t N>
      constexpr explicit(N != rank_dynamic())
        extents(span<OtherSizeType, N>) noexcept;
    template<class OtherSizeType, size_t N>
      constexpr explicit(N != rank_dynamic())
        extents(const array<OtherSizeType, N>&) noexcept;

    // \ref{mdspan.extents.cmp}, comparison operators
    template<class OtherSizeType, size_t... OtherExtents>
      friend constexpr bool operator==(const extents&,
                                       const extents<OtherSizeType, OtherExtents...>&) noexcept;
    ...
    template<class OtherSizeType>
      static constexpr auto @\exposid{index-cast}@(OtherSizeType&&) noexcept;   // \expos
  ...
  private:
    ...
    array<size_type, rank_dynamic()> @\exposid{dynamic-extents}@{};                 // \expos
  };
...
\begin{itemize}
\item
\tcode{SizeType} is a signed or unsigned integer type, and
\item
each element of \tcode{Extents} is either equal to \tcode{dynamic_extent}, or
is representable as a value of type \tcode{SizeType}.
\end{itemize}
...
\begin{itemdecl}
template<class OtherSizeType>
  static constexpr auto @\exposid{index-cast}@(OtherSizeType&& i) noexcept;
\end{itemdecl}
...
\begin{itemize}
\item
If \tcode{OtherSizeType} is an integral type other than \tcode{bool},
then equivalent to \tcode{return i;},
\item
otherwise, equivalent to \tcode{return static_cast<size_type>(i);}.
\end{itemize}
\begin{note}
...
convertibility of \tcode{OtherSizeType} to \tcode{size_type},
...
template<class OtherSizeType, size_t... OtherExtents>
  constexpr explicit(@\seebelow@)
    extents(const extents<OtherSizeType, OtherExtents...>& other) noexcept;
\end{itemdecl}
...
a value of type \tcode{size_type} for every rank index \tcode{r} of \tcode{other}.
\end{itemize}
\end{itemize}
...
\pnum
\constraints
Let \tcode{N} be \tcode{sizeof...(OtherSizeTypes)}.
\begin{itemize}
\item
\tcode{(is_convertible_v<OtherSizeTypes, size_type> \&\& ...)} is \tcode{true},
\item
\tcode{(is_nothrow_constructible_v<size_type, OtherSizeTypes> \&\& ...)} is \tcode{true}, and
\item
...
\begin{codeblock}
array<size_type, sizeof...(OtherSizeTypes)>{static_cast<size_type>(std::move(exts))...}
\end{codeblock}
...
\begin{itemize}
\item
If \tcode{sizeof...(OtherSizeTypes) != rank_dynamic()} is \tcode{true},
...
is representable as a value of type \tcode{size_type}.
\end{itemize}
\end{itemize}
...
template<class OtherSizeType, size_t N>
  constexpr explicit(N != rank_dynamic())
    extents(span<OtherSizeType, N> exts) noexcept;
template<class OtherSizeType, size_t N>
  constexpr explicit(N != rank_dynamic())
    extents(const array<OtherSizeType, N>& exts) noexcept;
\end{itemdecl}
...
\begin{itemize}
\item
\tcode{is_convertible_v<const OtherSizeType\&, size_type>} is \tcode{true},
\item
\tcode{is_nothrow_constructible_v<size_type, const OtherSizeType\&>} is \tcode{true}, and
\item
\tcode{N == rank_dynamic() || N == rank()} is \tcode{true}.
\end{itemize}
...
is representable as a value of type \tcode{size_type} for every rank index \tcode{r}.
\end{itemize}
\end{itemize}
...
\rSec3[mdspan.extents.obs]{Observers of the multidimensional index space}
...
\rSec3[mdspan.extents.cmp]{Comparison operators}
...
\rSec3[mdspan.extents.dextents]{Alias template \tcode{dextents}}
...
\tcode{E::size_type} denotes \tcode{SizeType}.
\end{itemdescr}

\rSec2[mdspan.layout]{Layout mapping}

\rSec3[mdspan.layout.general]{General}
...
\rSec3[mdspan.layout.reqmts]{Requirements}
...
\pnum
\result
\tcode{typename M::extents_type::size_type}.
\end{itemdescr}
...
\pnum
\result
\tcode{typename M::size_type}

\pnum
\returns
A nonnegative integer
less than \tcode{numeric_limits<typename M::size_type>::max()} and
...
there exists an \tcode{i} such that \tcode{m(i...)} equals \tcode{k}.
\begin{note}
A mapping can return \tcode{false} even if the condition is met.
For certain layouts, it is possibly not feasible to determine efficiently
...
\rSec3[mdspan.layout.policy.overview]{Layout mapping policies}
...
\rSec3[mdspan.layout.left]{Class template \tcode{layout_left::mapping}}

\rSec4[mdspan.layout.left.overview]{Overview}
...
a value of type \tcode{size_type}\iref{basic.fundamental}.
...
\rSec4[mdspan.layout.left.obs]{Observers}
...
\item
\tcode{(is_convertible_v<Indices, size_type> \&\& ...)} is \tcode{true}, and
\item
\tcode{(is_nothrow_constructible_v<size_type, Indices> \&\& ...)} is \tcode{true}.
\end{itemize}
...
\rSec3[mdspan.layout.right]{Class template \tcode{layout_right::mapping}}

\rSec4[mdspan.layout.right.overview]{Overview}
...
\rSec4[mdspan.layout.right.obs]{Observers}
...
\tcode{(is_convertible_v<Indices, size_type> \&\& ...)} is \tcode{true}, and
\item
\tcode{(is_nothrow_constructible_v<size_type, Indices> \&\& ...)} is
\tcode{true}.
\end{itemize}
...
\rSec3[mdspan.layout.stride]{Class template \tcode{layout_stride::mapping}}

\rSec4[mdspan.layout.stride.overview]{Overview}
...
namespace std {
  ...
  public:
    ...
    constexpr mapping(const mapping&) noexcept = default;
    template<class OtherSizeType>
      constexpr mapping(const extents_type&, span<OtherSizeType, rank_>) noexcept;
    template<class OtherSizeType>
      constexpr mapping(const extents_type&, const array<OtherSizeType, rank_>&) noexcept;
    ...
    constexpr size_type stride(rank_type i) const noexcept { return @\exposid{strides_}@[i]; }
  ...
  private:
    extents_type @\exposid{extents_}@{};                    // \expos
    array<size_type, @\exposid{rank_}@> @\exposid{strides_}@{};         // \expos
  };
}
\end{codeblock}
...
\rSec4[mdspan.layout.stride.expo]{Exposition-only helpers}

\pnum
Let \tcode{\exposid{REQUIRED-SPAN-SIZE}(e, strides)} be:
\begin{itemize}
\item
\tcode{1}, if \tcode{e.rank() == 0} is \tcode{true}, otherwise
\item
\tcode{0}, if the size of the multidimensional index space \tcode{e} is 0, otherwise
\item
\tcode{1} plus the sum of products of \tcode{(e.extent($r$) - 1)} and \tcode{strides[$r$]}
...
\begin{itemize}
\item
\tcode{m()}, if \tcode{e.rank() == 0} is \tcode{true}, otherwise
\item
\tcode{0}, if the size of the multidimensional index space \tcode{e} is 0, otherwise
\item
\tcode{m(z...)} for a pack of integers \tcode{z}
...
template<class SizeType, size_t... Args>
  constexpr bool @\exposid{is-extents}@<extents<SizeType, Args...>> = true;   // \expos
\end{codeblock}
...
\begin{itemdecl}
template<class OtherSizeType>
  constexpr mapping(const extents_type& e, span<OtherSizeType, @\exposid{rank_}@> s) noexcept;
template<class OtherSizeType>
  constexpr mapping(const extents_type& e, const array<OtherSizeType, @\exposid{rank_}@>& s) noexcept;
\end{itemdecl}
...
\begin{itemize}
\item
\tcode{is_convertible_v<const OtherSizeType\&, size_type>} is \tcode{true}, and
\item
\tcode{is_nothrow_constructible_v<size_type, const OtherSizeType\&>} is \tcode{true}.
\end{itemize}
...
as a value of type \tcode{size_type}\iref{basic.fundamental}.
\item
...
\item
\tcode{other.required_span_size()} is representable as
a value of type \tcode{size_type}\iref{basic.fundamental}, and
\item
...
\rSec4[mdspan.layout.stride.obs]{Observers}
...
\rSec2[mdspan.accessor]{Accessor policy}

\rSec3[mdspan.accessor.general]{General}
...
\rSec3[mdspan.accessor.reqmts]{Requirements}
...
\rSec3[mdspan.accessor.default]{Class template \tcode{default_accessor}}

\rSec4[mdspan.accessor.default.overview]{Overview}
...
\rSec4[mdspan.accessor.default.members]{Members}
...
\pnum
\effects
Euivalent to: \tcode{return p + i;}
\end{itemdescr}

\rSec2[mdspan.mdspan]{Class template \tcode{mdspan}}

\rSec3[mdspan.mdspan.overview]{Overview}
...
namespace std {
  ...
  public:
    ...
    template<class... OtherSizeTypes>
      constexpr explicit mdspan(pointer ptr, OtherSizeTypes... exts);
    template<class OtherSizeType, size_t N>
      constexpr explicit(N != rank_dynamic()) mdspan(pointer p, span<OtherSizeType, N> exts);
    template<class OtherSizeType, size_t N>
      constexpr explicit(N != rank_dynamic())
        mdspan(pointer p, const array<OtherSizeType, N>& exts);
...
\begin{itemdecl}
template<class... OtherSizeTypes>
  constexpr explicit mdspan(pointer p, OtherSizeTypes... exts);
\end{itemdecl}
...
\tcode{(is_convertible_v<OtherSizeTypes, size_type> \&\& ...)} is \tcode{true},
\item
\tcode{(is_nothrow_constructible<size_type, OtherSizeTypes> \&\& ...)} is \tcode{true},
\item
...
\tcode{Extents(static_cast<size_type>(std::move(exts))...)}, and
\item
...
template<class OtherSizeType, size_t N>
  constexpr explicit(N != rank_dynamic())
    mdspan(pointer p, span<OtherSizeType, N> exts);
template<class OtherSizeType, size_t N>
  constexpr explicit(N != rank_dynamic())
    mdspan(pointer p, const array<OtherSizeType, N>& exts);
\end{itemdecl}
...
\tcode{is_convertible_v<const OtherSizeType\&, size_type>} is \tcode{true},
\item
\tcode{(is_nothrow_constructible<size_type, const OtherSizeType\&> \&\& ...)} is \tcode{true},
\item
\tcode{N == rank() || N == rank_dynamic()} is \tcode{true},
\item
\tcode{is_constructible_v<mapping_type, extents_type>} is \tcode{true}, and
...
\rSec3[mdspan.mdspan.members]{Members}
...
\tcode{(is_nothrow_constructible_v<size_type, OtherSizeTypes> \&\& ...)} is \tcode{true}, and
\item
\tcode{sizeof...(OtherSizeTypes) == rank()} is \tcode{true}.
\end{itemize}
...
Equivalent to:
\begin{codeblock}
return @\exposid{acc_}@.access(@\exposid{ptr_}@, @\exposid{map_}@(static_cast<size_type>(std::move(indices))...));
\end{codeblock}
\end{itemdescr}
...
is representable as a value of type \tcode{size_t}\iref{basic.fundamental}.
