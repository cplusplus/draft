...
template<class InputIterator>
  using @\placeholder{iter-to-alloc-type}@
...
namespace std {
  ...
  // \ref{span.comparison}, span comparison operators
...
nnamespace std {
  ...
  public:
    ...
    // \ref{span.cons}, constructors, copy, assignment, and destructor
    ...
    // \ref{span.obs}, span observers
    constexpr index_type size() const noexcept;
    constexpr index_type size_bytes() const noexcept;
    constexpr bool empty() const noexcept;

    // \ref{span.elem}, span element access
    constexpr reference operator[](index_type idx) const;
    constexpr reference operator()(index_type idx) const;
    constexpr pointer data() const noexcept;

    // \ref{span.iterators}, span iterator support
...
\rSec3[span.cons]{\tcode{span} constructors, copy, assignment, and destructor}
...
\rSec3[span.sub]{\tcode{span} subviews}
...
\rSec3[span.obs]{\tcode{span} observers}
...
\rSec3[span.elem]{\tcode{span} element access}
...
\rSec3[span.iterators]{\tcode{span} iterator support}
...
\rSec3[span.comparison]{\tcode{span} comparison operators}
