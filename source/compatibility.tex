...
ISO C will accept this usage of pointer to \tcode{void} being assigned
...
\tcode{void} functions and \tcode{int} functions.
\effect
Deletion of semantically well-defined feature.
\difficulty
Semantic transformation.
...
\rationale
In \Cpp{}, implicit \tcode{int} creates several opportunities for
