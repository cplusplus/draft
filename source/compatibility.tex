...
ISO C accepts this usage of pointer to \tcode{void} being assigned
...
In C, a \tcode{sizeof} expression or cast expression may define a new type.
For example,
\begin{codeblock}
...
functions with \tcode{void} and \tcode{int} return types.
\effect
Deletion of semantically well-defined feature.
\difficulty
Semantic transformation.
...
\rationale
In \Cpp{}, implicit \tcode{int} would create several opportunities for
