...
\subclause1[diff.cpp20]{\Cpp{} and ISO \CppXX{}}

\subclause2[diff.cpp20.general]{General}
...
\subclause2[diff.cpp20.lex]{\ref{lex}: lexical conventions}
...
\subclause2[diff.cpp20.utilities]{\ref{utilities}: general utilities library}
...
\subclause1[diff.cpp17]{\Cpp{} and ISO \CppXVII{}}

\subclause2[diff.cpp17.general]{General}
...
\subclause2[diff.cpp17.lex]{\ref{lex}: lexical conventions}
...
\subclause2[diff.cpp17.basic]{\ref{basic}: basics}
...
\subclause2[diff.cpp17.expr]{\ref{expr}: expressions}
...
\subclause2[diff.cpp17.dcl.dcl]{\ref{dcl.dcl}: declarations}
...
\subclause2[diff.cpp17.class]{\ref{class}: classes}
...
\subclause2[diff.cpp17.over]{\ref{over}: overloading}
...
\subclause2[diff.cpp17.temp]{\ref{temp}: templates}
...
\subclause2[diff.cpp17.except]{\ref{except}: exception handling}
...
\subclause2[diff.cpp17.library]{\ref{library}: library introduction}
...
\subclause2[diff.cpp17.containers]{\ref{containers}: containers library}
...
\subclause2[diff.cpp17.iterators]{\ref{iterators}: iterators library}
...
\subclause2[diff.cpp17.alg.reqs]{\ref{algorithms}: algorithms library}
...
\subclause2[diff.cpp17.input.output]{\ref{input.output}: input/output library}
...
\subclause2[diff.cpp17.depr]{\ref{depr}: compatibility features}
...
\subclause1[diff.cpp14]{\Cpp{} and ISO \CppXIV{}}

\subclause2[diff.cpp14.general]{General}
...
\subclause2[diff.cpp14.lex]{\ref{lex}: lexical conventions}
...
\subclause2[diff.cpp14.expr]{\ref{expr}: expressions}
...
\subclause2[diff.cpp14.dcl.dcl]{\ref{dcl.dcl}: declarations}
...
\subclause2[diff.cpp14.class]{\ref{class}: classes}
...
\subclause2[diff.cpp14.temp]{\ref{temp}: templates}
...
\subclause2[diff.cpp14.except]{\ref{except}: exception handling}
...
\subclause2[diff.cpp14.library]{\ref{library}: library introduction}
...
\subclause2[diff.cpp14.utilities]{\ref{utilities}: general utilities library}
...
\subclause2[diff.cpp14.string]{\ref{strings}: strings library}
...
\subclause2[diff.cpp14.containers]{\ref{containers}: containers library}
...
\subclause2[diff.cpp14.depr]{\ref{depr}: compatibility features}
...
\subclause1[diff.cpp11]{\Cpp{} and ISO \CppXI{}}

\subclause2[diff.cpp11.general]{General}
...
\subclause2[diff.cpp11.lex]{\ref{lex}: lexical conventions}
...
\subclause2[diff.cpp11.basic]{\ref{basic}: basics}
...
\subclause2[diff.cpp11.expr]{\ref{expr}: expressions}
...
\subclause2[diff.cpp11.dcl.dcl]{\ref{dcl.dcl}: declarations}
...
\subclause2[diff.cpp11.library]{\ref{library}: library introduction}
...
\subclause2[diff.cpp11.input.output]{\ref{input.output}: input/output library}
...
\subclause1[diff.cpp03]{\Cpp{} and ISO \CppIII{}}

\subclause2[diff.cpp03.general]{General}
...
\subclause2[diff.cpp03.lex]{\ref{lex}: lexical conventions}
...
\subclause2[diff.cpp03.expr]{\ref{expr}: expressions}
...
\subclause2[diff.cpp03.dcl.dcl]{\ref{dcl.dcl}: declarations}
...
\subclause2[diff.cpp03.class]{\ref{class}: classes}
...
\subclause2[diff.cpp03.temp]{\ref{temp}: templates}
...
\subclause2[diff.cpp03.library]{\ref{library}: library introduction}
...
\subclause2[diff.cpp03.language.support]{\ref{support}:
...
\subclause2[diff.cpp03.diagnostics]{\ref{diagnostics}: diagnostics library}
...
\subclause2[diff.cpp03.utilities]{\ref{utilities}: general utilities library}
...
\subclause2[diff.cpp03.strings]{\ref{strings}: strings library}
...
\subclause2[diff.cpp03.containers]{\ref{containers}: containers library}
...
\subclause2[diff.cpp03.algorithms]{\ref{algorithms}: algorithms library}
...
\subclause2[diff.cpp03.numerics]{\ref{numerics}: numerics library}
...
\subclause2[diff.cpp03.input.output]{\ref{input.output}: input/output library}
...
\subclause1[diff.iso]{\Cpp{} and ISO C}

\subclause2[diff.iso.general]{General}
...
\subclause2[diff.lex]{\ref{lex}: lexical conventions}
...
\subclause2[diff.basic]{\ref{basic}: basics}
...
\subclause2[diff.expr]{\ref{expr}: expressions}
...
\subclause2[diff.stat]{\ref{stmt.stmt}: statements}
...
\subclause2[diff.dcl]{\ref{dcl.dcl}: declarations}
...
\subclause2[diff.class]{\ref{class}: classes}
...
\subclause2[diff.cpp]{\ref{cpp}: preprocessing directives}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subclause1[diff.library]{C standard library}

\subclause2[diff.library.general]{General}
...
\subclause2[diff.mods.to.headers]{Modifications to headers}
...
\subclause2[diff.mods.to.definitions]{Modifications to definitions}

\subclause3[diff.char16]{Types \tcode{char16_t} and \tcode{char32_t}}
...
\subclause3[diff.wchar.t]{Type \tcode{wchar_t}}
...
\subclause3[diff.header.assert.h]{Header \tcode{<assert.h>}}
\indexhdr{assert.h}%
...
\subclause3[diff.header.iso646.h]{Header \tcode{<iso646.h>}}
...
\subclause3[diff.header.stdalign.h]{Header \tcode{<stdalign.h>}}
\indexhdr{stdalign.h}%
...
\subclause3[diff.header.stdbool.h]{Header \tcode{<stdbool.h>}}
\indexhdr{stdbool.h}%
...
\subclause3[diff.null]{Macro \tcode{NULL}}
...
\subclause2[diff.mods.to.declarations]{Modifications to declarations}
...
\subclause2[diff.mods.to.behavior]{Modifications to behavior}

\subclause3[diff.mods.to.behavior.general]{General}
...
\subclause3[diff.offsetof]{Macro \tcode{offsetof(\placeholder{type}, \placeholder{member-designator})}}
...
\subclause3[diff.malloc]{Memory allocation functions}
