...
\rSec1[diff.cpp03]{\Cpp and ISO \CppFIXME}

\pnum
\indextext{summary!compatibility~with ISO \CppFIXME}%
This subclause lists the differences between \Cpp and
ISO \CppFIXME (ISO/IEC 14882:2011, \doccite{Programming Languages --- \Cpp}),
by the chapters of this document.

\rSec2[diff.cpp11.dcl.dcl]{Clause \ref{dcl.dcl}: declarations}

\ref{dcl.spec.constexpr}
...
the object.
\effect
Valid \CppFIXME code may fail to compile or produce different results in
this International Standard. For example, the following code is valid in \CppFIXME
