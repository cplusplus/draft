...
\begin{note}
Except for \tcode{CHAR_BIT} and \tcode{MB_LEN_MAX}, the types of the constants
defined by these macros are obtained from the types to which they refer by
applying the integral promotions\iref{conv.prom}.
\end{note}
