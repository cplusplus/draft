%!TEX root = std.tex
\subclause0[support]{Language support library}

\subclause1[support.general]{General}
...
\subclause1[support.types]{Common definitions}

\subclause2[cstddef.syn]{Header \tcode{<cstddef>} synopsis}
...
\subclause2[cstdlib.syn]{Header \tcode{<cstdlib>} synopsis}
...
\subclause2[support.types.nullptr]{Null pointers}
...
\subclause2[support.types.layout]{Sizes, alignments, and offsets}
...
\subclause2[support.types.byteops]{\tcode{byte} type operations}
...
\subclause1[support.limits]{Implementation properties}

\subclause2[support.limits.general]{General}
...
\subclause2[version.syn]{Header \tcode{<version>} synopsis}
...
\subclause2[limits.syn]{Header \tcode{<limits>} synopsis}
...
\subclause2[fp.style]{Floating-point type properties}

\subclause3[round.style]{Type \tcode{float_round_style}}
...
\subclause3[denorm.style]{Type \tcode{float_denorm_style}}
...
\subclause2[numeric.limits]{Class template \tcode{numeric_limits}}

\subclause3[numeric.limits.general]{General}
...
\subclause3[numeric.limits.members]{\tcode{numeric_limits} members}
...
\subclause3[numeric.special]{\tcode{numeric_limits} specializations}
...
\subclause2[climits.syn]{Header \tcode{<climits>} synopsis}
...
\subclause2[cfloat.syn]{Header \tcode{<cfloat>} synopsis}
...
\subclause1[cstdint]{Integer types}

\subclause2[cstdint.general]{General}
...
\subclause2[cstdint.syn]{Header \tcode{<cstdint>} synopsis}
...
\subclause1[support.start.term]{Startup and termination}
...
\subclause1[support.dynamic]{Dynamic memory management}

\subclause2[support.dynamic.general]{General}
...
\subclause2[new.syn]{Header \tcode{<new>} synopsis}
\begin{codeblock}
namespace std {
...
\subclause2[new.delete]{Storage allocation and deallocation}

\subclause3[new.delete.general]{General}
...
\subclause3[new.delete.single]{Single-object forms}
...
\subclause3[new.delete.array]{Array forms}
...
\subclause3[new.delete.placement]{Non-allocating forms}
...
\subclause3[new.delete.dataraces]{Data races}
...
\subclause2[alloc.errors]{Storage allocation errors}

\subclause3[bad.alloc]{Class \tcode{bad_alloc}}%
\indexlibraryglobal{bad_alloc}%
...
\subclause3[new.badlength]{Class \tcode{bad_array_new_length}}%
...
\subclause3[new.handler]{Type \tcode{new_handler}}
...
\subclause3[set.new.handler]{\tcode{set_new_handler}}
...
\subclause3[get.new.handler]{\tcode{get_new_handler}}
...
\subclause2[ptr.launder]{Pointer optimization barrier}
...
\subclause2[hardware.interference]{Hardware interference size}
...
\subclause1[support.rtti]{Type identification}

\subclause2[support.rtti.general]{General}
...
\subclause2[typeinfo.syn]{Header \tcode{<typeinfo>} synopsis}
...
\subclause2[type.info]{Class \tcode{type_info}}
...
\subclause2[bad.cast]{Class \tcode{bad_cast}}
...
\subclause2[bad.typeid]{Class \tcode{bad_typeid}}
...
\subclause1[support.srcloc]{Source location}

\subclause2[source.location.syn]{Header \tcode{<source_location>} synopsis}
...
\subclause2[support.srcloc.class]{Class \tcode{source_location}}

\subclause3[support.srcloc.class.general]{General}
...
\subclause3[support.srcloc.cons]{Creation}
...
\subclause3[support.srcloc.obs]{Observers}
...
\subclause1[support.exception]{Exception handling}

\subclause2[support.exception.general]{General}
...
\subclause2[exception.syn]{Header \tcode{<exception>} synopsis}
...
\subclause2[exception]{Class \tcode{exception}}
...
\subclause2[bad.exception]{Class \tcode{bad_exception}}
...
\subclause2[exception.terminate]{Abnormal termination}

\subclause3[terminate.handler]{Type \tcode{terminate_handler}}
...
\subclause3[set.terminate]{\tcode{set_terminate}}
...
\subclause3[get.terminate]{\tcode{get_terminate}}
...
\subclause3[terminate]{\tcode{terminate}}
...
\subclause2[uncaught.exceptions]{\tcode{uncaught_exceptions}}
...
\subclause2[propagation]{Exception propagation}
...
\subclause2[except.nested]{\tcode{nested_exception}}
...
\subclause1[support.initlist]{Initializer lists}

\subclause2[support.initlist.general]{General}
...
\subclause2[initializer.list.syn]{Header \tcode{<initializer_list>} synopsis}
...
\subclause2[support.initlist.cons]{Initializer list constructors}
...
\subclause2[support.initlist.access]{Initializer list access}
...
\subclause2[support.initlist.range]{Initializer list range access}
...
\subclause1[cmp]{Comparisons}

\subclause2[compare.syn]{Header \tcode{<compare>} synopsis}
...
\subclause2[cmp.categories]{Comparison category types}

\subclause3[cmp.categories.pre]{Preamble}
...
\subclause3[cmp.partialord]{Class \tcode{partial_ordering}}
...
\subclause3[cmp.weakord]{Class \tcode{weak_ordering}}
...
\subclause3[cmp.strongord]{Class \tcode{strong_ordering}}
...
\subclause2[cmp.common]{Class template \tcode{common_comparison_category}}
...
\subclause2[cmp.concept]{Concept \cname{three_way_comparable}}
...
\subclause2[cmp.result]{Result of three-way comparison}
...
\subclause2[cmp.alg]{Comparison algorithms}
...
\subclause1[support.coroutine]{Coroutines}

\subclause2[support.coroutine.general]{General}
...
\subclause2[coroutine.syn]{Header \tcode{<coroutine>} synopsis}
...
\subclause2[coroutine.traits]{Coroutine traits}

\subclause3[coroutine.traits.general]{General}
...
\subclause3[coroutine.traits.primary]{Class template \tcode{coroutine_traits}}
...
\subclause2[coroutine.handle]{Class template \tcode{coroutine_handle}}

\subclause3[coroutine.handle.general]{General}
...
\subclause3[coroutine.handle.con]{Construct/reset}
...
\subclause3[coroutine.handle.conv]{Conversion}
...
\subclause3[coroutine.handle.export.import]{Export/import}
...
\subclause3[coroutine.handle.observers]{Observers}
...
\subclause3[coroutine.handle.resumption]{Resumption}
...
\subclause3[coroutine.handle.promise]{Promise access}
...
\subclause3[coroutine.handle.compare]{Comparison operators}
...
\subclause3[coroutine.handle.hash]{Hash support}
...
\subclause2[coroutine.noop]{No-op coroutines}

\subclause3[coroutine.promise.noop]{Class \tcode{noop_coroutine_promise}}
...
\subclause3[coroutine.handle.noop]{Class \tcode{coroutine_handle<noop_coroutine_promise>}}
...
\subclause4[coroutine.handle.noop.conv]{Conversion}
...
\subclause4[coroutine.handle.noop.observers]{Observers}
...
\subclause4[coroutine.handle.noop.resumption]{Resumption}
...
\subclause4[coroutine.handle.noop.promise]{Promise access}
...
\subclause4[coroutine.handle.noop.address]{Address}
...
\subclause3[coroutine.noop.coroutine]{Function \tcode{noop_coroutine}}
...
\subclause2[coroutine.trivial.awaitables]{Trivial awaitables}
...
\subclause1[support.runtime]{Other runtime support}

\subclause2[support.runtime.general]{General}
...
\subclause2[cstdarg.syn]{Header \tcode{<cstdarg>} synopsis}
...
\subclause2[csetjmp.syn]{Header \tcode{<csetjmp>} synopsis}
...
\subclause2[csignal.syn]{Header \tcode{<csignal>} synopsis}
...
\subclause2[support.signal]{Signal handlers}
