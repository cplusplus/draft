...
#define @\libmacro{NULL}@ @\seebelow@
#define @\libmacro{offsetof}@(P, D) @\seebelow@
\end{codeblock}
...
\pnum
The macro
\tcode{\libmacro{offsetof}(\placeholder{type}, \placeholder{member-designator})}
...
#define @\libmacro{INTPTR_MIN}@       @\seebelow@              // optional
#define @\libmacro{INTPTR_MAX}@       @\seebelow@              // optional
#define @\libmacro{UINTPTR_MAX}@      @\seebelow@              // optional
...
\tcode{\libmacro{va_start}} macro in header \libheader{stdarg.h}
...
#define @\libmacro{setjmp}@(env) @\seebelow@
\end{codeblock}
...
A \tcode{\libmacro{setjmp}}/\tcode{longjmp} call pair has undefined
...
#define @\libmacro{SIG_DFL}@ @\seebelow@
#define @\libmacro{SIG_ERR}@ @\seebelow@
#define @\libmacro{SIG_IGN}@ @\seebelow@
#define @\libmacro{SIGABRT}@ @\seebelow@
#define @\libmacro{SIGFPE}@ @\seebelow@
#define @\libmacro{SIGILL}@ @\seebelow@
#define @\libmacro{SIGINT}@ @\seebelow@
#define @\libmacro{SIGSEGV}@ @\seebelow@
#define @\libmacro{SIGTERM}@ @\seebelow@
\end{codeblock}
