...
\pnum
The header \tcode{<climits>} defines all macros the same as 5.2.4.2.1 in the C standard.
\begin{note}
...
\pnum
The header \tcode{<cfloat>} defines all macros the same as 5.2.4.2.2 in the C standard.
...
\pnum
A call to the \tcode{setlocale} function~(\ref{clocale.syn}) may introduce a data race with other
