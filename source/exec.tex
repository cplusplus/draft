...
namespace std::execution {
  ...
  struct @\exposid{associate-data}@ {                                               // \expos
    ...
    using @\exposid{assoc-t}@ = decltype(declval<Token&>().try_associate());        // \expos
    using @\exposid{sender-ref}@ =                                                  // \expos
      unique_ptr<@\exposid{wrap-sender}@, decltype([](auto* p) noexcept { destroy_at(p); })>;
  ...
  private:
    @\exposid{associate-data}@(pair<@\exposid{assoc-t}@, @\exposid{sender-ref}@> parts);  // \expos
    union {
      @\exposid{wrap-sender}@ @\exposid{sndr}@;                                         // \expos
    };
