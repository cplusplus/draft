%!TEX root = std.tex
\subclause0[over]{Overloading}%
\indextext{overloading|(}

\gramSec[gram.over]{Overloading}

\subclause1[over.pre]{Preamble}
...
\subclause1[over.match]{Overload resolution}%

\subclause2[over.match.general]{General}%
...
\subclause2[over.match.funcs]{Candidate functions and argument lists}%

\subclause3[over.match.funcs.general]{General}%
...
\subclause3[over.match.call]{Function call syntax}%

\subclause4[over.match.call.general]{General}%
...
\subclause4[over.call.func]{Call to named function}
...
\subclause4[over.call.object]{Call to object of class type}
...
\subclause3[over.match.oper]{Operators in expressions}%
...
\subclause3[over.match.ctor]{Initialization by constructor}%
...
\subclause3[over.match.copy]{Copy-initialization of class by user-defined conversion}%
\indextext{overloading!resolution!initialization}
...
\subclause3[over.match.conv]{Initialization by conversion function}%
\indextext{overloading!resolution!initialization}
...
\subclause3[over.match.ref]{Initialization by conversion function for direct reference binding}%
\indextext{overloading!resolution!initialization}
...
\subclause3[over.match.list]{Initialization by list-initialization}%
\indextext{overloading!resolution!initialization}
...
\subclause3[over.match.class.deduct]{Class template argument deduction}%
...
\subclause2[over.match.viable]{Viable functions}%
...
\subclause2[over.match.best]{Best viable function}%

\subclause3[over.match.best.general]{General}%
...
\subclause3[over.best.ics]{Implicit conversion sequences}%

\subclause4[over.best.ics.general]{General}%
...
\subclause4[over.ics.scs]{Standard conversion sequences}
...
\subclause4[over.ics.user]{User-defined conversion sequences}
...
\subclause4[over.ics.ellipsis]{Ellipsis conversion sequences}
...
\subclause4[over.ics.ref]{Reference binding}
...
\subclause4[over.ics.list]{List-initialization sequence}
...
\subclause3[over.ics.rank]{Ranking implicit conversion sequences}
...
\subclause1[over.over]{Address of an overload set}%
...
\subclause1[over.oper]{Overloaded operators}%

\subclause2[over.oper.general]{General}%
...
\subclause2[over.unary]{Unary operators}%
...
\subclause2[over.binary]{Binary operators}%

\subclause3[over.binary.general]{General}%
...
\subclause3[over.ass]{Simple assignment}
...
\subclause2[over.call]{Function call}%
...
\subclause2[over.sub]{Subscripting}%
...
\subclause2[over.ref]{Class member access}
...
\subclause2[over.inc]{Increment and decrement}
...
\subclause1[over.built]{Built-in operators}%
...
\subclause1[over.literal]{User-defined literals}%
