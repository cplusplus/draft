%!TEX root = std.tex
\subclause0[basic]{Basics}

\gramSec[gram.basic]{Basics}

\subclause1[basic.pre]{Preamble}
...
\subclause1[basic.def]{Declarations and definitions}
...
\subclause1[basic.def.odr]{One-definition rule}%
...
\subclause1[basic.scope]{Scope}%
\indextext{scope|(}

\subclause2[basic.scope.scope]{General}
...
\subclause2[basic.scope.pdecl]{Point of declaration}
...
\subclause2[basic.scope.block]{Block scope}
...
\subclause2[basic.scope.param]{Function parameter scope}
...
\subclause2[basic.scope.namespace]{Namespace scope}
...
\subclause2[basic.scope.class]{Class scope}
...
\subclause2[basic.scope.enum]{Enumeration scope}%
...
\subclause2[basic.scope.temp]{Template parameter scope}%
...
\subclause1[basic.lookup]{Name lookup}%

\indextext{lookup!name|(}

\subclause2[basic.lookup.general]{General}%
...
\subclause2[class.member.lookup]{Member name lookup}%
...
\subclause2[basic.lookup.unqual]{Unqualified name lookup}
...
\subclause2[basic.lookup.argdep]{Argument-dependent name lookup}%
...
\subclause2[basic.lookup.qual]{Qualified name lookup}

\subclause3[basic.lookup.qual.general]{General}
...
\subclause3[class.qual]{Class members}
...
\subclause3[namespace.qual]{Namespace members}
...
\subclause2[basic.lookup.elab]{Elaborated type specifiers}%
...
\subclause2[basic.lookup.udir]{Using-directives and namespace aliases}
...
\subclause1[basic.link]{Program and linkage}%
\indextext{linkage|(}
...
\subclause1[basic.memobj]{Memory and objects}

\subclause2[intro.memory]{Memory model}
...
\subclause2[intro.object]{Object model}
...
\subclause2[basic.life]{Lifetime}
...
\subclause2[basic.indet]{Indeterminate values}
...
\subclause2[basic.stc]{Storage duration}

\subclause3[basic.stc.general]{General}
...
\subclause3[basic.stc.static]{Static storage duration}
...
\subclause3[basic.stc.thread]{Thread storage duration}
...
\subclause3[basic.stc.auto]{Automatic storage duration}
...
\subclause3[basic.stc.dynamic]{Dynamic storage duration}%

\subclause4[basic.stc.dynamic.general]{General}%
\indextext{storage duration!dynamic|(}
...
\subclause4[basic.stc.dynamic.allocation]{Allocation functions}
...
\subclause4[basic.stc.dynamic.deallocation]{Deallocation functions}
...
\subclause3[basic.stc.inherit]{Duration of subobjects}
...
\subclause2[basic.align]{Alignment}
...
\subclause2[class.temporary]{Temporary objects}
...
\subclause1[basic.types]{Types}%

\subclause2[basic.types.general]{General}%
\indextext{type|(}
...
\subclause2[basic.fundamental]{Fundamental types}
...
\subclause2[basic.compound]{Compound types}
...
\subclause2[basic.type.qualifier]{CV-qualifiers}
...
\subclause2[conv.rank]{Integer conversion rank}%
...
\subclause1[basic.exec]{Program execution}

\subclause2[intro.execution]{Sequential execution}
...
\subclause2[intro.multithread]{Multi-threaded executions and data races}

\subclause3[intro.multithread.general]{General}
...
\subclause3[intro.races]{Data races}
...
\subclause3[intro.progress]{Forward progress}
...
\subclause2[basic.start]{Start and termination}

\subclause3[basic.start.main]{\tcode{main} function}
...
\subclause3[basic.start.static]{Static initialization}
...
\subclause3[basic.start.dynamic]{Dynamic initialization of non-block variables}
...
\subclause3[basic.start.term]{Termination}
