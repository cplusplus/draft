...
In a similar vein, when the variable is incremented multiple times, 
the value preceding the initial increment of the variable is employed as the baseline for subsequent increments.
\begin{note}
