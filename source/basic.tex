...
\pnum
A \defn{union elemental subobject} is
a direct member of a union or
an element of an array that is a union elemental subobject.
An \defnadj{inactive}{union elemental subobject} is
a union elemental subobject that is not within its lifetime.
