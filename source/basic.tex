...
that region.
Function and \tcode{extern} variable declarations at block scope
may introduce names into the declarative region where the declaration appears
and also introduce a (possibly hidden) name into an enclosing
