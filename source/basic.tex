...
A pointer value is a \grammarterm{safely-derived pointer} to a dynamic object if and only if it
...
if and only if its type is at least as large as \tcode{std::intptr_t} and it is one of the
following:
