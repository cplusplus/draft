...
\begin{libsumtab}{Time library summary}{time.lib.summary}
...
\tcode{day} is \oldconcept{EqualityComparable} (\tref{equalitycomparable})
and \oldconcept{LessThanComparable} (\tref{lessthancomparable}),
...
\tcode{month} is \oldconcept{EqualityComparable} (\tref{equalitycomparable})
and \oldconcept{LessThanComparable} (\tref{lessthancomparable}),
...
\tcode{year} is \oldconcept{EqualityComparable} (\tref{equalitycomparable})
and \oldconcept{LessThanComparable} (\tref{lessthancomparable}),
...
\tcode{weekday} is \oldconcept{EqualityComparable} (\tref{equalitycomparable}).
\begin{note}
\tcode{weekday} is not
...
\tcode{month_day} is \oldconcept{EqualityComparable} (\tref{equalitycomparable})
and \oldconcept{LessThanComparable} (\tref{lessthancomparable}).
...
\tcode{year_month} is \oldconcept{EqualityComparable} (\tref{equalitycomparable})
and \oldconcept{LessThanComparable} (\tref{lessthancomparable}).
...
\end{note}
\tcode{year_month_day} is \oldconcept{EqualityComparable} (\tref{equalitycomparable})
and \oldconcept{LessThanComparable} (\tref{lessthancomparable}),
...
which efficiently supports \tcode{days}-oriented arithmetic.
\end{note}
\tcode{year_month_day_last} is \oldconcept{EqualityComparable} (\tref{equalitycomparable})
and \oldconcept{LessThanComparable} (\tref{lessthancomparable}),
...
which efficiently supports \tcode{days}-oriented arithmetic.
\end{note}
\tcode{year_month_weekday} is \oldconcept{EqualityComparable} (\tref{equalitycomparable}).
...
which efficiently supports \tcode{days}-oriented arithmetic.
\end{note}
\tcode{year_month_weekday_last} is \oldconcept{EqualityComparable} (\tref{equalitycomparable}).
