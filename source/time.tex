%!TEX root = std.tex
\subclause0[time]{Time library}

\subclause1[time.general]{General}
...
\subclause1[time.syn]{Header \tcode{<chrono>} synopsis}
...
\subclause1[time.clock.req]{\oldconcept{Clock} requirements}
...
\subclause1[time.traits]{Time-related traits}

\subclause2[time.traits.is.fp]{\tcode{treat_as_floating_point}}
...
\subclause2[time.traits.duration.values]{\tcode{duration_values}}
...
\subclause2[time.traits.specializations]{Specializations of \tcode{common_type}}
...
\subclause2[time.traits.is.clock]{Class template \tcode{is_clock}}
...
\subclause1[time.duration]{Class template \tcode{duration}}

\subclause2[time.duration.general]{General}
...
\subclause2[time.duration.cons]{Constructors}
...
\subclause2[time.duration.observer]{Observer}
...
\subclause2[time.duration.arithmetic]{Arithmetic}
...
\subclause2[time.duration.special]{Special values}
...
\subclause2[time.duration.nonmember]{Non-member arithmetic}
...
\subclause2[time.duration.comparisons]{Comparisons}
...
\subclause2[time.duration.cast]{Conversions}
...
\subclause2[time.duration.literals]{Suffixes for duration literals}
...
\subclause2[time.duration.alg]{Algorithms}
...
\subclause2[time.duration.io]{I/O}
...
\subclause1[time.point]{Class template \tcode{time_point}}

\subclause2[time.point.general]{General}
...
\subclause2[time.point.cons]{Constructors}
...
\subclause2[time.point.observer]{Observer}
...
\subclause2[time.point.arithmetic]{Arithmetic}
...
\subclause2[time.point.special]{Special values}
...
\subclause2[time.point.nonmember]{Non-member arithmetic}
...
\subclause2[time.point.comparisons]{Comparisons}
...
\subclause2[time.point.cast]{Conversions}
...
\subclause1[time.clock]{Clocks}

\subclause2[time.clock.general]{General}
...
\subclause2[time.clock.system]{Class \tcode{system_clock}}

\subclause3[time.clock.system.overview]{Overview}
...
\subclause3[time.clock.system.members]{Members}
...
\subclause3[time.clock.system.nonmembers]{Non-member functions}
...
\subclause2[time.clock.utc]{Class \tcode{utc_clock}}

\subclause3[time.clock.utc.overview]{Overview}
...
\subclause3[time.clock.utc.members]{Member functions}
...
\subclause3[time.clock.utc.nonmembers]{Non-member functions}
...
\subclause2[time.clock.tai]{Class \tcode{tai_clock}}

\subclause3[time.clock.tai.overview]{Overview}
...
\subclause3[time.clock.tai.members]{Member functions}
...
\subclause3[time.clock.tai.nonmembers]{Non-member functions}
...
\subclause2[time.clock.gps]{Class \tcode{gps_clock}}

\subclause3[time.clock.gps.overview]{Overview}
...
\subclause3[time.clock.gps.members]{Member functions}
...
\subclause3[time.clock.gps.nonmembers]{Non-member functions}
...
\subclause2[time.clock.file]{Type \tcode{file_clock}}

\subclause3[time.clock.file.overview]{Overview}
...
\subclause3[time.clock.file.members]{Member functions}
...
\subclause3[time.clock.file.nonmembers]{Non-member functions}
...
\subclause2[time.clock.steady]{Class \tcode{steady_clock}}
...
\subclause2[time.clock.hires]{Class \tcode{high_resolution_clock}}
...
\subclause2[time.clock.local]{Local time}
\indexlibraryglobal{local_time}%
...
\subclause2[time.clock.cast]{\tcode{time_point} conversions}

\subclause3[time.clock.conv]{Class template \tcode{clock_time_conversion}}
...
\subclause3[time.clock.cast.id]{Identity conversions}
...
\subclause3[time.clock.cast.sys.utc]{Conversions between \tcode{system_clock} and \tcode{utc_clock}}
...
\subclause3[time.clock.cast.sys]{Conversions between \tcode{system_clock} and other clocks}
...
\subclause3[time.clock.cast.utc]{Conversions between \tcode{utc_clock} and other clocks}
...
\subclause3[time.clock.cast.fn]{Function template \tcode{clock_cast}}
...
\subclause1[time.cal]{The civil calendar}

\subclause2[time.cal.general]{In general}

\pnum
The types in \ref{time.cal} describe the civil (Gregorian) calendar
and its relationship to \tcode{sys_days} and \tcode{local_days}.

\subclause2[time.cal.last]{Class \tcode{last_spec}}
...
\subclause2[time.cal.day]{Class \tcode{day}}

\subclause3[time.cal.day.overview]{Overview}
...
\subclause3[time.cal.day.members]{Member functions}
...
\subclause3[time.cal.day.nonmembers]{Non-member functions}
...
\subclause2[time.cal.month]{Class \tcode{month}}

\subclause3[time.cal.month.overview]{Overview}
...
\subclause3[time.cal.month.members]{Member functions}
...
\subclause3[time.cal.month.nonmembers]{Non-member functions}
...
\subclause2[time.cal.year]{Class \tcode{year}}

\subclause3[time.cal.year.overview]{Overview}
...
\subclause3[time.cal.year.members]{Member functions}
...
\subclause3[time.cal.year.nonmembers]{Non-member functions}
...
\subclause2[time.cal.wd]{Class \tcode{weekday}}

\subclause3[time.cal.wd.overview]{Overview}
...
\subclause3[time.cal.wd.members]{Member functions}
...
\subclause3[time.cal.wd.nonmembers]{Non-member functions}
...
\subclause2[time.cal.wdidx]{Class \tcode{weekday_indexed}}

\subclause3[time.cal.wdidx.overview]{Overview}
...
\subclause3[time.cal.wdidx.members]{Member functions}
...
\subclause3[time.cal.wdidx.nonmembers]{Non-member functions}
...
\subclause2[time.cal.wdlast]{Class \tcode{weekday_last}}

\subclause3[time.cal.wdlast.overview]{Overview}
...
\subclause3[time.cal.wdlast.members]{Member functions}
...
\subclause3[time.cal.wdlast.nonmembers]{Non-member functions}
...
\subclause2[time.cal.md]{Class \tcode{month_day}}

\subclause3[time.cal.md.overview]{Overview}
...
\subclause3[time.cal.md.members]{Member functions}
...
\subclause3[time.cal.md.nonmembers]{Non-member functions}
...
\subclause2[time.cal.mdlast]{Class \tcode{month_day_last}}
...
\subclause2[time.cal.mwd]{Class \tcode{month_weekday}}

\subclause3[time.cal.mwd.overview]{Overview}
...
\subclause3[time.cal.mwd.members]{Member functions}
...
\subclause3[time.cal.mwd.nonmembers]{Non-member functions}
...
\subclause2[time.cal.mwdlast]{Class \tcode{month_weekday_last}}

\subclause3[time.cal.mwdlast.overview]{Overview}
...
\subclause3[time.cal.mwdlast.members]{Member functions}
...
\subclause3[time.cal.mwdlast.nonmembers]{Non-member functions}
...
\subclause2[time.cal.ym]{Class \tcode{year_month}}

\subclause3[time.cal.ym.overview]{Overview}
...
\subclause3[time.cal.ym.members]{Member functions}
...
\subclause3[time.cal.ym.nonmembers]{Non-member functions}
...
\subclause2[time.cal.ymd]{Class \tcode{year_month_day}}

\subclause3[time.cal.ymd.overview]{Overview}
...
\subclause3[time.cal.ymd.members]{Member functions}
...
\subclause3[time.cal.ymd.nonmembers]{Non-member functions}
...
\subclause2[time.cal.ymdlast]{Class \tcode{year_month_day_last}}

\subclause3[time.cal.ymdlast.overview]{Overview}
...
\subclause3[time.cal.ymdlast.members]{Member functions}
...
\subclause3[time.cal.ymdlast.nonmembers]{Non-member functions}
...
\subclause2[time.cal.ymwd]{Class \tcode{year_month_weekday}}

\subclause3[time.cal.ymwd.overview]{Overview}
...
\subclause3[time.cal.ymwd.members]{Member functions}
...
\subclause3[time.cal.ymwd.nonmembers]{Non-member functions}
...
\subclause2[time.cal.ymwdlast]{Class \tcode{year_month_weekday_last}}

\subclause3[time.cal.ymwdlast.overview]{Overview}
...
\subclause3[time.cal.ymwdlast.members]{Member functions}
...
\subclause3[time.cal.ymwdlast.nonmembers]{Non-member functions}
...
\subclause2[time.cal.operators]{Conventional syntax operators}
...
\subclause1[time.hms]{Class template \tcode{hh_mm_ss}}

\subclause2[time.hms.overview]{Overview}
...
\subclause2[time.hms.members]{Members}
...
\subclause2[time.hms.nonmembers]{Non-members}
...
\subclause1[time.12]{12/24 hours functions}
...
\subclause1[time.zone]{Time zones}

\subclause2[time.zone.general]{In general}
...
\subclause2[time.zone.db]{Time zone database}

\subclause3[time.zone.db.tzdb]{Class \tcode{tzdb}}
...
\subclause3[time.zone.db.list]{Class \tcode{tzdb_list}}
...
\subclause3[time.zone.db.access]{Time zone database access}
...
\subclause3[time.zone.db.remote]{Remote time zone database support}
...
\subclause2[time.zone.exception]{Exception classes}

\subclause3[time.zone.exception.nonexist]{Class \tcode{nonexistent_local_time}}
...
\subclause3[time.zone.exception.ambig]{Class \tcode{ambiguous_local_time}}
...
\subclause2[time.zone.info]{Information classes}

\subclause3[time.zone.info.sys]{Class \tcode{sys_info}}
...
\subclause3[time.zone.info.local]{Class \tcode{local_info}}
...
\subclause2[time.zone.timezone]{Class \tcode{time_zone}}

\subclause3[time.zone.overview]{Overview}
...
\subclause3[time.zone.members]{Member functions}
...
\subclause3[time.zone.nonmembers]{Non-member functions}
...
\subclause2[time.zone.zonedtraits]{Class template \tcode{zoned_traits}}
...
\subclause2[time.zone.zonedtime]{Class template \tcode{zoned_time}}

\subclause3[time.zone.zonedtime.overview]{Overview}
...
\subclause3[time.zone.zonedtime.ctor]{Constructors}
...
\subclause3[time.zone.zonedtime.members]{Member functions}
...
\subclause3[time.zone.zonedtime.nonmembers]{Non-member functions}
...
\subclause2[time.zone.leap]{Class \tcode{leap_second}}

\subclause3[time.zone.leap.overview]{Overview}
...
\subclause3[time.zone.leap.members]{Member functions}
...
\subclause3[time.zone.leap.nonmembers]{Non-member functions}
...
\subclause2[time.zone.link]{Class \tcode{time_zone_link}}

\subclause3[time.zone.link.overview]{Overview}
...
\subclause3[time.zone.link.members]{Member functions}
...
\subclause3[time.zone.link.nonmembers]{Non-member functions}
...
\subclause1[time.format]{Formatting}
...
\subclause1[ctime.syn]{Header \tcode{<ctime>} synopsis}
