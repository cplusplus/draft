...
\pnum
Let \tcode{\libexposid{STATICALLY-WIDEN}<charT>("...")} be
...
\begin{codeblock}
template<class Duration> struct @\libexposid{local-time-format-t}@ {           // \expos
...
\indexlibrary{\idxcode{formatter}!specializations!chrono::local-time-format-t@\tcode{chrono::\ExposStylex{local-time-format-t}}}%
\begin{itemdecl}
template<class Duration, class charT>
  struct formatter<chrono::@\exposid{local-time-format-t}@<Duration>, charT>;
\end{itemdecl}
...
template<class Duration, class TimeZonePtr, class charT>
struct formatter<chrono::zoned_time<Duration, TimeZonePtr>, charT>
    : formatter<chrono::@\exposid{local-time-format-t}@<Duration>, charT> {
...
return formatter<chrono::@\exposid{local-time-format-t}@<Duration>, charT>::
