...
\pnum
\begin{note}
This means, for example, that implementations cannot use an object with static storage duration for
internal purposes without synchronization because it possibly causes a data race even in
