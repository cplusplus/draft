...
\item
\tcode{operator new(std::size_t, std::align_val_t, const std::nothrow_t\&)}
\item
\tcode{operator new[](std::size_t)}
\item
\tcode{operator new[](std::size_t, const std::nothrow_t\&)}
...
\item
\tcode{operator delete(void*, std::align_val_t)}
\item
\tcode{operator delete(void*, std::align_val_t, const std::nothrow_t\&)}
\item
\tcode{operator delete(void*, std::size_t, std::align_val_t)}
\item
\tcode{operator delete[](void*)}
\item
\tcode{operator delete[](void*, const std::nothrow_t\&)}
