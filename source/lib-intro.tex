...
\begin{multicoltable}{\Cpp{} library headers}{tab:cpp.library.headers}
{4}{0.99\textwidth}
\tcode{<algorithm>} \\
\tcode{<any>} \\
\tcode{<array>} \\
...
\begin{multicoltable}{\Cpp{} headers for C library facilities}{tab:cpp.c.headers}
{5}{0.8\textwidth}
\tcode{<cassert>}           \\
\tcode{<ccomplex>}          \\
\tcode{<cctype>}            \\
...
\tcode{CopyAssign\-able} requirements (\tref{copyassignable})
