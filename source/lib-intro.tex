...
\pnum
\result
Object \tcode{t} is default-initialized.
\end{itemdescr}
...
\pnum
\result
Object \tcode{u} is value-initialized or aggregate-initialized.
\end{itemdescr}
...
\pnum
\remarks
The state of \tcode{rv} is unspecified.
...
\pnum
\result
A value equivalent to the value of \tcode{rv} before the construction.
