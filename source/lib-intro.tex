...
to namespace
\tcode{std} if and only if the declaration
...
if and only if the declaration depends on the name of a user-defined type
...
\rSec1[cstdlib.syn]{Header \tcode{<cstdlib>} synopsis}
