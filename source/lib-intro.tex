...
\multicolumn{2}{|p{5.3in}|}{
  ...
  if \tcode{rv} does not meet the requirements of the library component
  that is using it,
  regardless of whether \tcode{rv} has been moved from or not.
\end{tailnote}
}\\
\end{oldconcepttable}
...
\multicolumn{4}{|p{5.3in}|}{
  ...
  if \tcode{rv} does not meet the requirements of the library component
  that is using it,
  regardless of whether or not \tcode{t} and \tcode{rv} refer to the same object
  or whether \tcode{rv} has been moved from or not.
\end{tailnote}
}\\
\end{oldconcepttable}
...
is expected to be prepared to work adequately with any user-supplied specialization
