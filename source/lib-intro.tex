...
\tcode{constexpr}~(\ref{dcl.constexpr}). Additionally, an implementation may declare any
function to be \tcode{constexpr} if that function's definition satisfies the necessary
constraints.
