%!TEX root = std.tex
\subclause0[library]{Library introduction}

\subclause1[library.general]{General}
...
\subclause1[library.c]{The C standard library}
...
\subclause1[description]{Method of description}

\subclause2[description.general]{General}
...
\subclause2[structure]{Structure of each clause}

\subclause3[structure.elements]{Elements}
...
\subclause3[structure.summary]{Summary}
...
\subclause3[structure.requirements]{Requirements}
...
\subclause3[structure.specifications]{Detailed specifications}
...
\subclause3[structure.see.also]{C library}

\pnum
Paragraphs labeled ``\textsc{See also}'' contain cross-references to the relevant portions
of other standards\iref{intro.refs}.

\subclause2[conventions]{Other conventions}

\subclause3[conventions.general]{General}
...
\subclause3[expos.only.func]{Exposition-only functions}
...
\subclause3[type.descriptions]{Type descriptions}

\subclause4[type.descriptions.general]{General}
...
\subclause4[expos.only.types]{Exposition-only types}
...
\subclause4[enumerated.types]{Enumerated types}
...
\subclause4[bitmask.types]{Bitmask types}
...
\subclause4[character.seq]{Character sequences}

\subclause5[character.seq.general]{General}
...
\subclause5[byte.strings]{Byte strings}
...
\subclause5[multibyte.strings]{Multibyte strings}
...
\subclause4[customization.point.object]{Customization Point Object types}
...
\subclause3[functions.within.classes]{Functions within classes}
...
\subclause3[objects.within.classes]{Private members}
...
\subclause1[requirements]{Library-wide requirements}

\subclause2[requirements.general]{General}
...
\subclause2[organization]{Library contents and organization}

\subclause3[organization.general]{General}
...
\subclause3[contents]{Library contents}
...
\subclause3[compliance]{Freestanding implementations}
...
\subclause2[using]{Using the library}

\subclause3[using.overview]{Overview}
...
\subclause3[using.headers]{Headers}
...
\subclause3[using.linkage]{Linkage}
...
\subclause2[utility.requirements]{Requirements on types and expressions}

\subclause3[utility.requirements.general]{General}
...
\subclause3[utility.arg.requirements]{Template argument requirements}
...
\subclause3[swappable.requirements]{Swappable requirements}
...
\subclause3[nullablepointer.requirements]{\oldconcept{NullablePointer} requirements}
...
\subclause3[hash.requirements]{\oldconcept{Hash} requirements}
...
\subclause3[allocator.requirements]{\oldconcept{Allocator} requirements}

\subclause4[allocator.requirements.general]{General}
...
\subclause4[allocator.requirements.completeness]{Allocator completeness requirements}
...
\subclause2[constraints]{Constraints on programs}

\subclause3[constraints.overview]{Overview}
...
\subclause3[namespace.constraints]{Namespace use}

\subclause4[namespace.std]{Namespace \tcode{std}}
...
\subclause4[namespace.posix]{Namespace \tcode{posix}}
...
\subclause4[namespace.future]{Namespaces for future standardization}
...
\subclause3[reserved.names]{Reserved names}%

\subclause4[reserved.names.general]{General}%
...
\subclause4[zombie.names]{Zombie names}%
...
\subclause4[macro.names]{Macro names}
...
\subclause4[extern.names]{External linkage}
...
\subclause4[usrlit.suffix]{User-defined literal suffixes}
...
\subclause3[alt.headers]{Headers}
...
\subclause3[derived.classes]{Derived classes}
...
\subclause3[replacement.functions]{Replacement functions}
...
\subclause3[handler.functions]{Handler functions}
...
\subclause3[res.on.functions]{Other functions}
...
\subclause3[res.on.arguments]{Function arguments}
...
\subclause3[res.on.objects]{Library object access}
...
\subclause3[res.on.requirements]{Semantic requirements}
...
\subclause2[conforming]{Conforming implementations}

\subclause3[conforming.overview]{Overview}
...
\subclause3[res.on.headers]{Headers}
...
\subclause3[res.on.macro.definitions]{Restrictions on macro definitions}
\indextext{restriction}%
...
\subclause3[global.functions]{Non-member functions}
...
\subclause3[member.functions]{Member functions}
...
\subclause3[hidden.friends]{Friend functions}
...
\subclause3[constexpr.functions]{Constexpr functions and constructors}
...
\subclause3[algorithm.stable]{Requirements for stable algorithms}
...
\subclause3[reentrancy]{Reentrancy}
...
\subclause3[res.on.data.races]{Data race avoidance}
...
\subclause3[protection.within.classes]{Protection within classes}
...
\subclause3[derivation]{Derived classes}
...
\subclause3[res.on.exception.handling]{Restrictions on exception handling}%
\indextext{restriction}%
...
\subclause3[value.error.codes]{Value of error codes}
...
\subclause3[lib.types.movedfrom]{Moved-from state of library types}
