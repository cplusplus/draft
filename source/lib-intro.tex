...
expressions which have the same effects,
all either are potentially-throwing\iref{except.spec} or not,
and
all either are constant subexpressions or not
...
\libconcept{Semiregular}\iref{concept.semiregular}.
