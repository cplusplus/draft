...
\tcode{\libmacro{assert}}, \tcode{\libmacro{offsetof}}, \tcode{\libmacro{setjmp}}, \tcode{\libmacro{va_arg}},
\tcode{\libmacro{va_end}}, and \tcode{\libmacro{va_start}}.
\end{note}
...
\tcode{\libmacro{assert}}\iref{cassert.syn},
\tcode{\libmacro{errno}}\iref{cerrno.syn},
\tcode{\libmacro{offsetof}}\iref{cstddef.syn}, and
\tcode{\libmacro{va_arg}}\iref{cstdarg.syn}.
\end{note}
...
\tcode{\libmacro{errno}}, declared or defined in \libheaderref{cerrno}.
\end{footnote}
