...
to emulate the injected-class-name\iref{class.pre}.
\end{note}
The class
\tcode{failure}
...
is needed is permitted to distinguish between the formats.
\end{note}
...
\begin{note}
The generic format needs to ensure lexicographical
