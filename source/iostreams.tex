...
\defnnote{1}{A hard link can be thought of as a shared-ownership smart
pointer to a file.}
...
\defnnote{1}{does not apply to dot and dot-dot.}
...
\defnnote{1}{Pathnames ``.'' and ``..'' are relative paths.}
...
\defnnote{1}{Symbolic links are often called symlinks. A symbolic link can be thought
of as a raw pointer to a file.
