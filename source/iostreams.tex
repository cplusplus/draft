%!TEX root = std.tex
\subclause0[input.output]{Input/output library}

\subclause1[input.output.general]{General}
...
\subclause1[iostreams.requirements]{Iostreams requirements}

\subclause2[iostream.limits.imbue]{Imbue limitations}
...
\subclause2[iostreams.limits.pos]{Positioning type limitations}
...
\subclause2[iostreams.threadsafety]{Thread safety}
...
\subclause1[iostream.forward]{Forward declarations}

\subclause2[iosfwd.syn]{Header \tcode{<iosfwd>} synopsis}
...
\subclause2[iostream.forward.overview]{Overview}
...
\subclause1[iostream.objects]{Standard iostream objects}

\subclause2[iostream.syn]{Header \tcode{<iostream>} synopsis}
...
\subclause2[iostream.objects.overview]{Overview}
...
\subclause2[narrow.stream.objects]{Narrow stream objects}
...
\subclause2[wide.stream.objects]{Wide stream objects}
...
\subclause1[iostreams.base]{Iostreams base classes}

\subclause2[ios.syn]{Header \tcode{<ios>} synopsis}
...
\subclause2[ios.base]{Class \tcode{ios_base}}

\subclause3[ios.base.general]{General}
...
\subclause3[ios.types]{Types}

\subclause4[ios.failure]{Class \tcode{ios_base::failure}}
...
\subclause4[ios.fmtflags]{Type \tcode{ios_base::fmtflags}}
...
\subclause4[ios.iostate]{Type \tcode{ios_base::iostate}}
...
\subclause4[ios.openmode]{Type \tcode{ios_base::openmode}}
...
\subclause4[ios.seekdir]{Type \tcode{ios_base::seekdir}}
...
\subclause4[ios.init]{Class \tcode{ios_base::Init}}
...
\subclause3[fmtflags.state]{State functions}
...
\subclause3[ios.base.locales]{Functions}
...
\subclause3[ios.members.static]{Static members}
...
\subclause3[ios.base.storage]{Storage functions}
...
\subclause3[ios.base.callback]{Callbacks}
...
\subclause3[ios.base.cons]{Constructors and destructor}
...
\subclause2[fpos]{Class template \tcode{fpos}}
...
\subclause3[fpos.members]{Members}
...
\subclause3[fpos.operations]{Requirements}
...
\subclause2[ios]{Class template \tcode{basic_ios}}

\subclause3[ios.overview]{Overview}
...
\subclause3[basic.ios.cons]{Constructors}
...
\subclause3[basic.ios.members]{Member functions}
...
\subclause3[iostate.flags]{Flags functions}
...
\subclause2[std.ios.manip]{\tcode{ios_base} manipulators}

\subclause3[fmtflags.manip]{\tcode{fmtflags} manipulators}
...
\subclause3[adjustfield.manip]{\tcode{adjustfield} manipulators}
...
\subclause3[basefield.manip]{\tcode{basefield} manipulators}
...
\subclause3[floatfield.manip]{\tcode{floatfield} manipulators}
...
\subclause2[error.reporting]{Error reporting}
...
\subclause1[stream.buffers]{Stream buffers}

\subclause2[streambuf.syn]{Header \tcode{<streambuf>} synopsis}
...
\subclause2[streambuf.reqts]{Stream buffer requirements}
...
\subclause2[streambuf]{Class template \tcode{basic_streambuf}}

\subclause3[streambuf.general]{General}
...
\subclause3[streambuf.cons]{Constructors}
...
\subclause3[streambuf.members]{Public member functions}

\subclause4[streambuf.locales]{Locales}
...
\subclause4[streambuf.buffer]{Buffer management and positioning}
...
\subclause4[streambuf.pub.get]{Get area}
...
\subclause4[streambuf.pub.pback]{Putback}
...
\subclause4[streambuf.pub.put]{Put area}
...
\subclause3[streambuf.protected]{Protected member functions}

\subclause4[streambuf.assign]{Assignment}
...
\subclause4[streambuf.get.area]{Get area access}
...
\subclause4[streambuf.put.area]{Put area access}
...
\subclause3[streambuf.virtuals]{Virtual functions}

\subclause4[streambuf.virt.locales]{Locales}
...
\subclause4[streambuf.virt.buffer]{Buffer management and positioning}
...
\subclause4[streambuf.virt.get]{Get area}
...
\subclause4[streambuf.virt.pback]{Putback}
...
\subclause4[streambuf.virt.put]{Put area}
...
\subclause1[iostream.format]{Formatting and manipulators}

\subclause2[istream.syn]{Header \tcode{<istream>} synopsis}
...
\subclause2[ostream.syn]{Header \tcode{<ostream>} synopsis}
...
\subclause2[iomanip.syn]{Header \tcode{<iomanip>} synopsis}
...
\subclause2[input.streams]{Input streams}

\subclause3[input.streams.general]{General}
...
\subclause3[istream]{Class template \tcode{basic_istream}}

\subclause4[istream.general]{General}
...
\subclause4[istream.cons]{Constructors}
...
\subclause4[istream.assign]{Assignment and swap}
...
\subclause4[istream.sentry]{Class \tcode{basic_istream::sentry}}
...
\subclause3[istream.formatted]{Formatted input functions}

\subclause4[istream.formatted.reqmts]{Common requirements}
...
\subclause4[istream.formatted.arithmetic]{Arithmetic extractors}
...
\subclause4[istream.extractors]{\tcode{basic_istream::operator>>}}
...
\subclause3[istream.unformatted]{Unformatted input functions}
...
\subclause3[istream.manip]{Standard \tcode{basic_istream} manipulators}
...
\subclause3[istream.rvalue]{Rvalue stream extraction}
...
\subclause3[iostreamclass]{Class template \tcode{basic_iostream}}

\subclause4[iostreamclass.general]{General}
...
\subclause4[iostream.cons]{Constructors}
...
\subclause4[iostream.dest]{Destructor}
...
\subclause4[iostream.assign]{Assignment and swap}
...
\subclause2[output.streams]{Output streams}

\subclause3[output.streams.general]{General}
...
\subclause3[ostream]{Class template \tcode{basic_ostream}}

\subclause4[ostream.general]{General}
...
\subclause4[ostream.cons]{Constructors}
...
\subclause4[ostream.assign]{Assignment and swap}
...
\subclause4[ostream.sentry]{Class \tcode{basic_ostream::sentry}}
...
\subclause4[ostream.seeks]{Seek members}
...
\subclause3[ostream.formatted]{Formatted output functions}

\subclause4[ostream.formatted.reqmts]{Common requirements}
...
\subclause4[ostream.inserters.arithmetic]{Arithmetic inserters}
...
\subclause4[ostream.inserters]{\tcode{basic_ostream::operator<<}}
...
\subclause4[ostream.inserters.character]{Character inserter function templates}
...
\subclause3[ostream.unformatted]{Unformatted output functions}
...
\subclause3[ostream.manip]{Standard manipulators}
...
\subclause3[ostream.rvalue]{Rvalue stream insertion}
...
\subclause2[std.manip]{Standard manipulators}
...
\subclause2[ext.manip]{Extended manipulators}
...
\subclause2[quoted.manip]{Quoted manipulators}
...
\subclause1[string.streams]{String-based streams}

\subclause2[sstream.syn]{Header \tcode{<sstream>} synopsis}
...
\subclause2[stringbuf]{Class template \tcode{basic_stringbuf}}

\subclause3[stringbuf.general]{General}
\indexlibraryglobal{basic_stringbuf}%
\begin{codeblock}
namespace std {
  template<class charT, class traits = char_traits<charT>,
...
\subclause3[stringbuf.cons]{Constructors}
...
\subclause3[stringbuf.assign]{Assignment and swap}
...
\subclause3[stringbuf.members]{Member functions}
...
\subclause3[stringbuf.virtuals]{Overridden virtual functions}
...
\subclause2[istringstream]{Class template \tcode{basic_istringstream}}

\subclause3[istringstream.general]{General}
...
\subclause3[istringstream.cons]{Constructors}
...
\subclause3[istringstream.assign]{Assignment and swap}
...
\subclause3[istringstream.members]{Member functions}
...
\subclause2[ostringstream]{Class template \tcode{basic_ostringstream}}

\subclause3[ostringstream.general]{General}
...
\subclause3[ostringstream.cons]{Constructors}
...
\subclause3[ostringstream.assign]{Assignment and swap}
...
\subclause3[ostringstream.members]{Member functions}
...
\subclause2[stringstream]{Class template \tcode{basic_stringstream}}

\subclause3[stringstream.general]{General}
...
\subclause3[stringstream.cons]{Constructors}
...
\subclause3[stringstream.assign]{Assignment and swap}
...
\subclause3[stringstream.members]{Member functions}
...
\subclause1[span.streams]{Span-based streams}

\subclause2[span.streams.overview]{Overview}
...
\subclause2[spanstream.syn]{Header \tcode{<spanstream>} synopsis}
...
\subclause2[spanbuf]{Class template \tcode{spanbuf}}

\subclause3[spanbuf.general]{General}
...
\subclause3[spanbuf.ctor]{Constructors}
...
\subclause3[spanbuf.assign]{Assignment and swap}
...
\subclause3[spanbuf.members]{Member functions}
...
\subclause3[spanbuf.virtuals]{Overridden virtual functions}
...
\subclause2[ispanstream]{Class template \tcode{basic_ispanstream}}

\subclause3[ispanstream.general]{General}
...
\subclause3[ispanstream.ctor]{Constructors}
...
\subclause3[ispanstream.assign]{Assignment and swap}
...
\subclause3[ispanstream.members]{Member functions}
...
\subclause2[ospanstream]{Class template \tcode{basic_ospanstream}}

\subclause3[ospanstream.general]{General}
...
\subclause3[ospanstream.ctor]{Constructors}
...
\subclause3[ospanstream.assign]{Assignment and swap}
...
\subclause3[ospanstream.members]{Member functions}
...
\subclause2[spanstream]{Class template \tcode{basic_spanstream}}

\subclause3[spanstream.general]{General}
...
\subclause3[spanstream.ctor]{Constructors}
...
\subclause3[spanstream.assign]{Assignment and swap}
...
\subclause3[spanstream.members]{Member functions}
...
\subclause1[file.streams]{File-based streams}

\subclause2[fstream.syn]{Header \tcode{<fstream>} synopsis}
...
\subclause2[filebuf]{Class template \tcode{basic_filebuf}}

\subclause3[filebuf.general]{General}
...
\subclause3[filebuf.cons]{Constructors}
...
\subclause3[filebuf.assign]{Assignment and swap}
...
\subclause3[filebuf.members]{Member functions}
...
\subclause3[filebuf.virtuals]{Overridden virtual functions}
...
\subclause2[ifstream]{Class template \tcode{basic_ifstream}}

\subclause3[ifstream.general]{General}
...
\subclause3[ifstream.cons]{Constructors}
...
\subclause3[ifstream.assign]{Assignment and swap}
...
\subclause3[ifstream.members]{Member functions}
...
\subclause2[ofstream]{Class template \tcode{basic_ofstream}}

\subclause3[ofstream.general]{General}
...
\subclause3[ofstream.cons]{Constructors}
...
\subclause3[ofstream.assign]{Assignment and swap}
...
\subclause3[ofstream.members]{Member functions}
...
\subclause2[fstream]{Class template \tcode{basic_fstream}}

\subclause3[fstream.general]{General}
...
\subclause3[fstream.cons]{Constructors}
...
\subclause3[fstream.assign]{Assignment and swap}
...
\subclause3[fstream.members]{Member functions}
...
\subclause1[syncstream]{Synchronized output streams}

\subclause2[syncstream.syn]{Header \tcode{<syncstream>} synopsis}
...
\subclause2[syncstream.syncbuf]{Class template \tcode{basic_syncbuf}}

\subclause3[syncstream.syncbuf.overview]{Overview}
...
\subclause3[syncstream.syncbuf.cons]{Construction and destruction}
...
\subclause3[syncstream.syncbuf.assign]{Assignment and swap}
...
\subclause3[syncstream.syncbuf.members]{Member functions}
...
\subclause3[syncstream.syncbuf.virtuals]{Overridden virtual functions}
...
\subclause3[syncstream.syncbuf.special]{Specialized algorithms}
...
\subclause2[syncstream.osyncstream]{Class template \tcode{basic_osyncstream}}

\subclause3[syncstream.osyncstream.overview]{Overview}
...
\subclause3[syncstream.osyncstream.cons]{Construction and destruction}
...
\subclause3[syncstream.osyncstream.members]{Member functions}
...
\subclause1[filesystems]{File systems}

\subclause2[fs.general]{General}
...
\subclause2[fs.conformance]{Conformance}

\subclause3[fs.conformance.general]{General}
...
\subclause3[fs.conform.9945]{POSIX conformance}
\pnum
...
\subclause3[fs.conform.os]{Operating system dependent behavior conformance}
\pnum
...
\subclause3[fs.race.behavior]{File system race behavior}
...
\subclause2[fs.req]{Requirements}
...
\subclause2[fs.filesystem.syn]{Header \tcode{<filesystem>} synopsis}
...
\subclause2[fs.err.report]{Error reporting}
...
\subclause2[fs.class.path]{Class \tcode{path}}

\subclause3[fs.class.path.general]{General}
...
\subclause3[fs.path.generic]{Generic pathname format}
...
\subclause3[fs.path.cvt]{Conversions}

\subclause4[fs.path.fmt.cvt]{Argument format conversions}
...
\subclause4[fs.path.type.cvt]{Type and encoding conversions}
...
\subclause3[fs.path.req]{Requirements}
...
\subclause3[fs.path.member]{Members}

\subclause4[fs.path.construct]{Constructors}
...
\subclause4[fs.path.assign]{Assignments}
...
\subclause4[fs.path.append]{Appends}
...
\subclause4[fs.path.concat]{Concatenation}
...
\subclause4[fs.path.modifiers]{Modifiers}
...
\subclause4[fs.path.native.obs]{Native format observers}
...
\subclause4[fs.path.generic.obs]{Generic format observers}
...
\subclause4[fs.path.compare]{Compare}
...
\subclause4[fs.path.decompose]{Decomposition}
...
\subclause4[fs.path.query]{Query}
...
\subclause4[fs.path.gen]{Generation}
...
\subclause3[fs.path.itr]{Iterators}
...
\subclause3[fs.path.io]{Inserter and extractor}
...
\subclause3[fs.path.nonmember]{Non-member functions}
...
\subclause2[fs.class.filesystem.error]{Class \tcode{filesystem_error}}

\subclause3[fs.class.filesystem.error.general]{General}
...
\subclause3[fs.filesystem.error.members]{Members}
...
\subclause2[fs.enum]{Enumerations}

\subclause3[fs.enum.path.format]{Enum \tcode{path::format}}
...
\subclause3[fs.enum.file.type]{Enum class \tcode{file_type}}
...
\subclause3[fs.enum.copy.opts]{Enum class \tcode{copy_options}}
...
\subclause3[fs.enum.perms]{Enum class \tcode{perms}}
...
\subclause3[fs.enum.perm.opts]{Enum class \tcode{perm_options}}
...
\subclause3[fs.enum.dir.opts]{Enum class \tcode{directory_options}}
...
\subclause2[fs.class.file.status]{Class \tcode{file_status}}

\subclause3[fs.class.file.status.general]{General}
...
\subclause3[fs.file.status.cons]{Constructors}
...
\subclause3[fs.file.status.obs]{Observers}
...
\subclause3[fs.file.status.mods]{Modifiers}
...
\subclause2[fs.class.directory.entry]{Class \tcode{directory_entry}}

\subclause3[fs.class.directory.entry.general]{General}
...
\subclause3[fs.dir.entry.cons]{Constructors}
...
\subclause3[fs.dir.entry.mods]{Modifiers}
...
\subclause3[fs.dir.entry.obs]{Observers}
...
\subclause3[fs.dir.entry.io]{Inserter}
...
\subclause2[fs.class.directory.iterator]{Class \tcode{directory_iterator}}

\subclause3[fs.class.directory.iterator.general]{General}
...
\subclause3[fs.dir.itr.members]{Members}
...
\subclause3[fs.dir.itr.nonmembers]{Non-member functions}
...
\subclause2[fs.class.rec.dir.itr]{Class \tcode{recursive_directory_iterator}}

\subclause3[fs.class.rec.dir.itr.general]{General}
...
\subclause3[fs.rec.dir.itr.members]{Members}
...
\subclause3[fs.rec.dir.itr.nonmembers]{Non-member functions}
...
\subclause2[fs.op.funcs]{Filesystem operation functions}

\subclause3[fs.op.funcs.general]{General}
...
\subclause3[fs.op.absolute]{Absolute}
...
\subclause3[fs.op.canonical]{Canonical}
...
\subclause3[fs.op.copy.file]{Copy file}
...
\subclause3[fs.op.copy.symlink]{Copy symlink}
...
\subclause3[fs.op.create.directories]{Create directories}
...
\subclause3[fs.op.create.directory]{Create directory}
...
\subclause3[fs.op.create.dir.symlk]{Create directory symlink}
...
\subclause3[fs.op.create.hard.lk]{Create hard link}
...
\subclause3[fs.op.create.symlink]{Create symlink}
...
\subclause3[fs.op.current.path]{Current path}
...
\subclause3[fs.op.equivalent]{Equivalent}
...
\subclause3[fs.op.exists]{Exists}
...
\subclause3[fs.op.file.size]{File size}
...
\subclause3[fs.op.hard.lk.ct]{Hard link count}
...
\subclause3[fs.op.is.block.file]{Is block file}
...
\subclause3[fs.op.is.char.file]{Is character file}
...
\subclause3[fs.op.is.directory]{Is directory}
...
\subclause3[fs.op.is.empty]{Is empty}
...
\subclause3[fs.op.is.fifo]{Is fifo}
...
\subclause3[fs.op.is.other]{Is other}
...
\subclause3[fs.op.is.regular.file]{Is regular file}
...
\subclause3[fs.op.is.socket]{Is socket}
...
\subclause3[fs.op.is.symlink]{Is symlink}
...
\subclause3[fs.op.last.write.time]{Last write time}
...
\subclause3[fs.op.permissions]{Permissions}
...
\subclause3[fs.op.proximate]{Proximate}
...
\subclause3[fs.op.read.symlink]{Read symlink}
...
\subclause3[fs.op.relative]{Relative}
...
\subclause3[fs.op.remove]{Remove}
...
\subclause3[fs.op.remove.all]{Remove all}
...
\subclause3[fs.op.rename]{Rename}
...
\subclause3[fs.op.resize.file]{Resize file}
...
\subclause3[fs.op.status]{Status}
...
\subclause3[fs.op.status.known]{Status known}
...
\subclause3[fs.op.symlink.status]{Symlink status}
...
\subclause3[fs.op.temp.dir.path]{Temporary directory path}
...
\subclause3[fs.op.weakly.canonical]{Weakly canonical}
...
\subclause1[c.files]{C library files}

\subclause2[cstdio.syn]{Header \tcode{<cstdio>} synopsis}
...
\subclause2[cinttypes.syn]{Header \tcode{<cinttypes>} synopsis}
