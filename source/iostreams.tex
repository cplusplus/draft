...
\indexlibrary{\idxhdr{cstdio}}%
The contents of the header \tcode{<cstdio>} are the same as the C
standard library header \tcode{<stdio.h>}.
The meaning of the content of this header is the same as in 7.21 in the C standard.
...
namespace std {
  ...
  intmax_t abs(intmax_t);  // See \ref{cinttypes.syn}
  imaxdiv_t div(intmax_t, intmax_t);  // See \ref{cinttypes.syn}
}
...
The contents of header \tcode{<cinttypes>} are the same as the C standard library header
...
%% \pnum
%% Table~\ref{tab:iostreams.hdr.cinttypes} describes header \tcode{<cinttypes>}.
