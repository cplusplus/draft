...
namespace std {
  // \ref{fs.path.fmtr}, formatter support
...
\rSec3[fs.path.fmtr]{Formatter support}

\rSec4[fs.path.fmtr.general]{Formatter support overview}
...
\rSec4[fs.path.fmtr.funcs]{Formatter support functions}
