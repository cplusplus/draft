%!TEX root = std.tex
\subclause0[dcl.dcl]{Declarations}%
...
\subclause1[dcl.spec]{Specifiers}%

\subclause2[dcl.spec.general]{General}%
\indextext{specifier|(}
...
\subclause2[dcl.stc]{Storage class specifiers}%
...
\subclause2[dcl.fct.spec]{Function specifiers}%
...
\subclause2[dcl.typedef]{The \tcode{typedef} specifier}%
...
\subclause2[dcl.friend]{The \tcode{friend} specifier}%
...
\subclause2[dcl.constexpr]{The \tcode{constexpr} and \tcode{consteval} specifiers}%
...
\subclause2[dcl.constinit]{The \tcode{constinit} specifier}
...
\subclause2[dcl.inline]{The \tcode{inline} specifier}%
...
\subclause2[dcl.type]{Type specifiers}%

\subclause3[dcl.type.general]{General}%
...
\subclause3[dcl.type.cv]{The \fakegrammarterm{cv-qualifier}{s}}%
...
\subclause3[dcl.type.simple]{Simple type specifiers}%
...
\subclause3[dcl.type.elab]{Elaborated type specifiers}%
...
\subclause3[dcl.type.decltype]{Decltype specifiers}%
...
\subclause3[dcl.spec.auto]{Placeholder type specifiers}%

\subclause4[dcl.spec.auto.general]{General}%
...
\subclause4[dcl.type.auto.deduct]{Placeholder type deduction}
...
\subclause3[dcl.type.class.deduct]{Deduced class template specialization types}
\indextext{deduction!class template arguments}%
...
\subclause1[dcl.decl]{Declarators}%

\subclause2[dcl.decl.general]{General}%
\indextext{declarator|(}
...
\subclause2[dcl.name]{Type names}
...
\subclause2[dcl.ambig.res]{Ambiguity resolution}%
...
\subclause2[dcl.meaning]{Meaning of declarators}%

\subclause3[dcl.meaning.general]{General}%
...
\subclause3[dcl.mptr]{Pointers to members}%
...
\subclause3[dcl.fct.default]{Default arguments}%
...
\subclause1[dcl.init]{Initializers}%

\subclause2[dcl.init.general]{General}%
...
\subclause2[dcl.init.aggr]{Aggregates}%
\indextext{aggregate}%
...
\subclause2[dcl.init.string]{Character arrays}%
...
\subclause2[dcl.init.ref]{References}%
\indextext{initialization!reference}
...
\subclause2[dcl.init.list]{List-initialization}%
...
\subclause1[dcl.fct.def]{Function definitions}%
\indextext{definition!function|(}

\subclause2[dcl.fct.def.general]{In general}
...
\subclause2[dcl.fct.def.default]{Explicitly-defaulted functions}%
...
\subclause2[dcl.fct.def.delete]{Deleted definitions}%
...
\subclause2[dcl.fct.def.coroutine]{Coroutine definitions}%
...
\subclause1[dcl.struct.bind]{Structured binding declarations}%
...
\subclause1[enum]{Enumerations}%

\subclause2[dcl.enum]{Enumeration declarations}%
...
\subclause2[enum.udecl]{The \tcode{using enum} declaration}%
...
\subclause1[basic.namespace]{Namespaces}%

\subclause2[basic.namespace.general]{General}%
...
\subclause2[namespace.def]{Namespace definition}%

\subclause3[namespace.def.general]{General}%
...
\subclause3[namespace.unnamed]{Unnamed namespaces}%
...
\subclause2[namespace.alias]{Namespace alias}%
...
\subclause2[namespace.udir]{Using namespace directive}%
...
\subclause1[namespace.udecl]{The \tcode{using} declaration}%
...
\subclause1[dcl.asm]{The \tcode{asm} declaration}%
...
\subclause1[dcl.link]{Linkage specifications}%
...
\subclause1[dcl.attr]{Attributes}%
\indextext{attribute|(}

\subclause2[dcl.attr.grammar]{Attribute syntax and semantics}
...
\subclause2[dcl.align]{Alignment specifier}%
...
\subclause2[dcl.attr.depend]{Carries dependency attribute}%
...
\subclause2[dcl.attr.deprecated]{Deprecated attribute}%
...
\subclause2[dcl.attr.fallthrough]{Fallthrough attribute}
...
\subclause2[dcl.attr.likelihood]{Likelihood attributes}%
...
\subclause2[dcl.attr.unused]{Maybe unused attribute}%
...
\subclause2[dcl.attr.nodiscard]{Nodiscard attribute}%
...
\subclause2[dcl.attr.noreturn]{Noreturn attribute}%
...
\subclause2[dcl.attr.nouniqueaddr]{No unique address attribute}%
