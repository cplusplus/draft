...
\pnum
If the list of declarators contains more than one declarator, they
shall all form declarations of variables. The type of each declared
variable is determined as described above, and if the type deduced for
the template parameter \tcode{U} is not the same in each deduction,
