...
@\placeholder{final-suspend}@:
  co_await @\placeholdernc{p}@.final_suspend(); // final suspend point
}
\end{codeblock}
...
called the \term{resumer}. Invoking a resumption member function for a coroutine
...
\pnum
The expression \tcode{co_await} \placeholdernc{p}\tcode{.final_suspend()}
