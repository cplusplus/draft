...
\begin{itemize}
\item the operand of a \tcode{return}\iref{stmt.return} or
\tcode{co_return}\iref{stmt.return.coroutine} statement
that is a (possibly parenthesized) \grammarterm{id-expression}
...
\item the operand of a \grammarterm{throw-expression}\iref{expr.throw}
that is a (possibly parenthesized) \grammarterm{id-expression}
...
The applicable constructors are enumerated\iref{over.match.ctor}
