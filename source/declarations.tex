...
In that context, the choice is between a function declaration with a redundant set of parentheses
around a parameter name, or, an object or reference declaration with a function-style cast as the initializer.
The resolution is to consider any construct that could possibly
be a function declaration a function declaration.
\begin{note}
