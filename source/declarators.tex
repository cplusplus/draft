...
\grammarterm{noexcept-specifier} that does not produce
...
\pnum
A decomposition declaration introduces the \grammarterm{identifier}{s}
...
designated by \tcode{std::tuple_element<i, E>::type}, each \tcode{v}$_i$
