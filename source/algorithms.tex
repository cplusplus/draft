...
namespace std {
  ...
  namespace ranges {
    template<input_iterator I1, sentinel_for<I1> S1, ForwardIterator I2, sentinel_for<I2> S2,
  ...
  namespace ranges {
    ...
    template<input_iterator I, sentinel_for<I> S, class T1, class T2, OutputIterator<const T2&> O,
             class Proj = identity>
      requires IndirectlyCopyable<I, O> &&
               IndirectRelation<ranges::equal_to, projected<I, Proj>, const T1*>
    ...
    template<input_iterator I, sentinel_for<I> S, class T, OutputIterator<const T&> O,
  ...
  namespace ranges {
    ...
    template<input_iterator I1, sentinel_for<I1> S1, RandomAccessIterator I2, sentinel_for<I2> S2,
