...
namespace std {
  ...
  namespace ranges {
    ...
    template<InputIterator I, Sentinel<I> S, weakly_incrementable O, class Proj = identity,
             IndirectUnaryPredicate<projected<I, Proj>> Pred>
      requires IndirectlyCopyable<I, O>
  ...
  namespace ranges {
    template<input_or_output_iterator O, Sentinel<O> S, copy_constructible F>
  ...
  namespace ranges {
    ...
    template<InputIterator I, Sentinel<I> S, weakly_incrementable O, class T,
             class Proj = identity>
      requires IndirectlyCopyable<I, O> &&
  ...
  namespace ranges {
    ...
    template<BidirectionalIterator I, Sentinel<I> S, weakly_incrementable O>
      requires IndirectlyCopyable<I, O>
  ...
  namespace ranges {
    ...
    template<ForwardIterator I, Sentinel<I> S, weakly_incrementable O>
      requires IndirectlyCopyable<I, O>
  ...
  namespace ranges {
    ...
    template<InputIterator I, Sentinel<I> S, weakly_incrementable O1, weakly_incrementable O2,
             class Proj = identity, IndirectUnaryPredicate<projected<I, Proj>> Pred>
