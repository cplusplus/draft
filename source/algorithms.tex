%!TEX root = std.tex
\subclause0[algorithms]{Algorithms library}

\subclause1[algorithms.general]{General}
...
\subclause1[algorithms.requirements]{Algorithms requirements}
\pnum
...
\subclause1[algorithms.parallel]{Parallel algorithms}

\subclause2[algorithms.parallel.defns]{Preamble}
\pnum
...
\subclause2[algorithms.parallel.user]{Requirements on user-provided function objects}
...
\subclause2[algorithms.parallel.exec]{Effect of execution policies on algorithm execution}
...
\subclause2[algorithms.parallel.exceptions]{Parallel algorithm exceptions}
...
\subclause2[algorithms.parallel.overloads]{\tcode{ExecutionPolicy} algorithm overloads}
...
\subclause1[algorithm.syn]{Header \tcode{<algorithm>} synopsis}
...
\subclause1[algorithms.results]{Algorithm result types}
...
\subclause1[alg.nonmodifying]{Non-modifying sequence operations}

\subclause2[alg.all.of]{All of}
...
\subclause2[alg.none.of]{None of}
...
\subclause2[alg.foreach]{For each}
...
\subclause2[alg.find.end]{Find end}
...
\subclause2[alg.find.first.of]{Find first}
...
\subclause2[alg.adjacent.find]{Adjacent find}
...
\subclause2[alg.is.permutation]{Is permutation}
...
\subclause2[alg.starts.with]{Starts with}
...
\subclause2[alg.ends.with]{Ends with}
...
\subclause1[alg.modifying.operations]{Mutating sequence operations}

\subclause2[alg.copy]{Copy}
...
\subclause2[alg.transform]{Transform}
...
\subclause2[alg.replace]{Replace}
...
\subclause2[alg.generate]{Generate}
...
\subclause2[alg.reverse]{Reverse}
...
\subclause2[alg.random.sample]{Sample}
...
\subclause2[alg.random.shuffle]{Shuffle}
...
\subclause1[alg.sorting]{Sorting and related operations}

\subclause2[alg.sorting.general]{General}
...
\subclause2[alg.sort]{Sorting}

\subclause3[sort]{\tcode{sort}}
...
\subclause3[stable.sort]{\tcode{stable_sort}}
...
\subclause3[partial.sort]{\tcode{partial_sort}}
...
\subclause3[partial.sort.copy]{\tcode{partial_sort_copy}}
...
\subclause3[is.sorted]{\tcode{is_sorted}}
...
\subclause2[alg.nth.element]{Nth element}
...
\subclause2[alg.binary.search]{Binary search}

\subclause3[alg.binary.search.general]{General}
...
\subclause3[lower.bound]{\tcode{lower_bound}}
...
\subclause3[upper.bound]{\tcode{upper_bound}}
...
\subclause3[equal.range]{\tcode{equal_range}}
...
\subclause3[binary.search]{\tcode{binary_search}}
...
\subclause2[alg.partitions]{Partitions}
...
\subclause2[alg.set.operations]{Set operations on sorted structures}

\subclause3[alg.set.operations.general]{General}
...
\subclause3[includes]{\tcode{includes}}
...
\subclause3[set.union]{\tcode{set_union}}
...
\subclause3[set.intersection]{\tcode{set_intersection}}
...
\subclause3[set.difference]{\tcode{set_difference}}
...
\subclause3[set.symmetric.difference]{\tcode{set_symmetric_difference}}
...
\subclause2[alg.heap.operations]{Heap operations}

\subclause3[alg.heap.operations.general]{General}
...
\subclause3[push.heap]{\tcode{push_heap}}
...
\subclause3[pop.heap]{\tcode{pop_heap}}
...
\subclause3[make.heap]{\tcode{make_heap}}
...
\subclause3[sort.heap]{\tcode{sort_heap}}
...
\subclause3[is.heap]{\tcode{is_heap}}
...
\subclause2[alg.min.max]{Minimum and maximum}
...
\subclause2[alg.clamp]{Bounded value}
...
\subclause2[alg.lex.comparison]{Lexicographical comparison}
...
\subclause2[alg.three.way]{Three-way comparison algorithms}
...
\subclause2[alg.permutation.generators]{Permutation generators}
...
\subclause1[numeric.ops.overview]{Header \tcode{<numeric>} synopsis}
...
\subclause1[numeric.ops]{Generalized numeric operations}

\subclause2[numeric.ops.general]{General}
...
\subclause2[numerics.defns]{Definitions}
...
\subclause2[accumulate]{Accumulate}
...
\subclause2[inner.product]{Inner product}
...
\subclause2[transform.reduce]{Transform reduce}
...
\subclause2[partial.sum]{Partial sum}
...
\subclause2[exclusive.scan]{Exclusive scan}
...
\subclause2[inclusive.scan]{Inclusive scan}
...
\subclause2[transform.exclusive.scan]{Transform exclusive scan}
...
\subclause2[transform.inclusive.scan]{Transform inclusive scan}
...
\subclause2[adjacent.difference]{Adjacent difference}
...
\subclause2[numeric.ops.gcd]{Greatest common divisor}
...
\subclause2[numeric.ops.lcm]{Least common multiple}
...
\subclause2[numeric.ops.midpoint]{Midpoint}
...
\subclause1[specialized.algorithms]{Specialized \tcode{<memory>} algorithms}

\subclause2[specialized.algorithms.general]{General}
...
\subclause2[special.mem.concepts]{Special memory concepts}
...
\subclause2[uninitialized.construct.default]{\tcode{uninitialized_default_construct}}
...
\subclause2[uninitialized.construct.value]{\tcode{uninitialized_value_construct}}
...
\subclause2[uninitialized.copy]{\tcode{uninitialized_copy}}
...
\subclause2[uninitialized.move]{\tcode{uninitialized_move}}
...
\subclause2[uninitialized.fill]{\tcode{uninitialized_fill}}
...
\subclause2[specialized.construct]{\tcode{construct_at}}
...
\subclause2[specialized.destroy]{\tcode{destroy}}
...
\subclause1[alg.c.library]{C library algorithms}
