...
indeterminately sequenced~(\ref{intro.execution}) in the calling thread of execution.
...
\item
\tcode{remove_reference_t<UniformRandomNumberGenerator>}
shall meet the requirements of a uniform random number generator type (\ref{rand.req.urng})
