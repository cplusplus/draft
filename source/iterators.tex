...
namespace std {
  ...
  namespace ranges {
    ...
    template<input_or_output_iterator I, Sentinel<I> S>
...
\libconcept{OutputIterator}\iref{iterator.concept.output},
...
requirements on an \libconcept{input_or_output_iterator} and a \libconcept{Sentinel}
...
\libconcept{IndirectlyMovable},
\libconcept{IndirectlyCopyable}, and
\libconcept{IndirectlySwappable}.
...
\tcode{same_as<S, I> \&\& SizedSentinel<S, I>}.
...
\begin{codeblock}
template<InputIterator I, Sentinel<I> S, weakly_incrementable O,
...
namespace std {
  ...
  public:
    ...
    template<class I2, Sentinel<I> S2>
      requires Sentinel<S, I2> && equality_comparable_with<I, I2>
    friend bool operator==(
      const common_iterator& x, const common_iterator<I2, S2>& y);
