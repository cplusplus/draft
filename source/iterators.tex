...
template<class It>
  concept @\defexposconcept{constant-iterator}@ = @\libconcept{input_iterator}@<It> &&
                              @\libconcept{same_as}@<iter_const_reference_t<It>, iter_reference_t<It>>;
...
\pnum
\result
If \tcode{S} models \tcode{input_iterator}, \tcode{const_iterator<S>}.
Otherwise, \tcode{S}.
\end{itemdescr}
...
namespace std {
  ...
  class @\libglobal{basic_const_iterator}@ {
    ...
    using @\exposid{reference}@ = iter_const_reference_t<Iterator>;         // \expos
