%!TEX root = std.tex
\subclause0[iterators]{Iterators library}

\subclause1[iterators.general]{General}
...
\subclause1[iterator.synopsis]{Header \tcode{<iterator>}\ synopsis}
...
\subclause1[iterator.requirements]{Iterator requirements}

\subclause2[iterator.requirements.general]{In general}
...
\subclause2[iterator.assoc.types]{Associated types}

\subclause3[incrementable.traits]{Incrementable traits}
...
\subclause3[readable.traits]{Indirectly readable traits}
...
\subclause3[iterator.traits]{Iterator traits}
...
\subclause2[iterator.cust]{Customization point objects}

\subclause3[iterator.cust.move]{\tcode{ranges::iter_move}}
...
\subclause3[iterator.cust.swap]{\tcode{ranges::iter_swap}}
...
\subclause2[iterator.concepts]{Iterator concepts}

\subclause3[iterator.concepts.general]{General}
...
\subclause3[iterator.concept.readable]{Concept \cname{indirectly_readable}}
...
\subclause3[iterator.concept.writable]{Concept \cname{indirectly_writable}}
...
\subclause3[iterator.concept.winc]{Concept \cname{weakly_incrementable}}
...
\subclause3[iterator.concept.inc]{Concept \cname{incrementable}}
...
\subclause3[iterator.concept.iterator]{Concept \cname{input_or_output_iterator}}
...
\subclause3[iterator.concept.sentinel]{Concept \cname{sentinel_for}}
...
\subclause3[iterator.concept.sizedsentinel]{Concept \cname{sized_sentinel_for}}
...
\subclause3[iterator.concept.input]{Concept \cname{input_iterator}}
...
\subclause3[iterator.concept.output]{Concept \cname{output_iterator}}
...
\subclause3[iterator.concept.forward]{Concept \cname{forward_iterator}}
...
\subclause3[iterator.concept.bidir]{Concept \cname{bidirectional_iterator}}
...
\subclause3[iterator.concept.random.access]{Concept \cname{random_access_iterator}}
...
\subclause3[iterator.concept.contiguous]{Concept \cname{contiguous_iterator}}
...
\subclause2[iterator.cpp17]{\Cpp{}17 iterator requirements}

\subclause3[iterator.cpp17.general]{General}
...
\subclause3[iterator.iterators]{\oldconcept{Iterator}}
...
\subclause3[input.iterators]{Input iterators}
...
\subclause3[output.iterators]{Output iterators}
...
\subclause3[forward.iterators]{Forward iterators}
...
\subclause3[bidirectional.iterators]{Bidirectional iterators}
...
\subclause3[random.access.iterators]{Random access iterators}
...
\subclause2[indirectcallable]{Indirect callable requirements}

\subclause3[indirectcallable.general]{General}

\pnum
There are several concepts that group requirements of algorithms that
take callable objects\iref{func.def} as arguments.

\subclause3[indirectcallable.indirectinvocable]{Indirect callables}
...
\subclause3[projected]{Class template \tcode{projected}}
...
\subclause2[alg.req]{Common algorithm requirements}

\subclause3[alg.req.general]{General}
...
\subclause3[alg.req.ind.move]{Concept \cname{indirectly_movable}}
...
\subclause3[alg.req.ind.copy]{Concept \cname{indirectly_copyable}}
...
\subclause3[alg.req.ind.swap]{Concept \cname{indirectly_swappable}}
...
\subclause3[alg.req.ind.cmp]{Concept \cname{indirectly_comparable}}
...
\subclause3[alg.req.permutable]{Concept \cname{permutable}}
...
\subclause3[alg.req.mergeable]{Concept \cname{mergeable}}
...
\subclause3[alg.req.sortable]{Concept \cname{sortable}}
...
\subclause1[iterator.primitives]{Iterator primitives}

\subclause2[iterator.primitives.general]{General}

\pnum
To simplify the use of iterators, the library provides
several classes and functions.

\subclause2[std.iterator.tags]{Standard iterator tags}
...
\subclause2[iterator.operations]{Iterator operations}
...
\subclause2[range.iter.ops]{Range iterator operations}

\subclause3[range.iter.ops.general]{General}
...
\subclause3[range.iter.op.advance]{\tcode{ranges::advance}}
...
\subclause3[range.iter.op.distance]{\tcode{ranges::distance}}
\indexlibraryglobal{distance}%
\begin{itemdecl}
template<@\libconcept{input_or_output_iterator}@ I, @\libconcept{sentinel_for}@<I> S>
...
\subclause3[range.iter.op.next]{\tcode{ranges::next}}
...
\subclause3[range.iter.op.prev]{\tcode{ranges::prev}}
\indexlibraryglobal{prev}%
\begin{itemdecl}
template<@\libconcept{bidirectional_iterator}@ I>
...
\subclause1[predef.iterators]{Iterator adaptors}

\subclause2[reverse.iterators]{Reverse iterators}

\subclause3[reverse.iterators.general]{General}
...
\subclause3[reverse.iterator]{Class template \tcode{reverse_iterator}}
...
\subclause3[reverse.iter.requirements]{Requirements}
...
\subclause3[reverse.iter.cons]{Construction and assignment}
...
\subclause3[reverse.iter.conv]{Conversion}
...
\subclause3[reverse.iter.elem]{Element access}
...
\subclause3[reverse.iter.nav]{Navigation}
...
\subclause3[reverse.iter.cmp]{Comparisons}
...
\subclause3[reverse.iter.nonmember]{Non-member functions}
...
\subclause2[insert.iterators]{Insert iterators}

\subclause3[insert.iterators.general]{General}
...
\subclause3[back.insert.iterator]{Class template \tcode{back_insert_iterator}}
...
\subclause4[back.insert.iter.ops]{Operations}
...
\subclause4[back.inserter]{ \tcode{back_inserter}}
...
\subclause3[front.insert.iterator]{Class template \tcode{front_insert_iterator}}
...
\subclause4[front.insert.iter.ops]{Operations}
...
\subclause4[front.inserter]{\tcode{front_inserter}}
...
\subclause3[insert.iterator]{Class template \tcode{insert_iterator}}
...
\subclause4[insert.iter.ops]{Operations}
...
\subclause4[inserter]{\tcode{inserter}}
...
\subclause2[move.iterators]{Move iterators and sentinels}

\subclause3[move.iterators.general]{General}
...
\subclause3[move.iterator]{Class template \tcode{move_iterator}}
...
\subclause3[move.iter.requirements]{Requirements}
...
\subclause3[move.iter.cons]{Construction and assignment}
...
\subclause3[move.iter.op.conv]{Conversion}
...
\subclause3[move.iter.elem]{Element access}
...
\subclause3[move.iter.nav]{Navigation}
...
\subclause3[move.iter.op.comp]{Comparisons}
...
\subclause3[move.iter.nonmember]{Non-member functions}
...
\subclause3[move.sentinel]{Class template \tcode{move_sentinel}}
...
\subclause3[move.sent.ops]{Operations}
...
\subclause2[iterators.common]{Common iterators}

\subclause3[common.iterator]{Class template \tcode{common_iterator}}
...
\subclause3[common.iter.types]{Associated types}
...
\subclause3[common.iter.const]{Constructors and conversions}
...
\subclause3[common.iter.access]{Accessors}
...
\subclause3[common.iter.nav]{Navigation}
...
\subclause3[common.iter.cmp]{Comparisons}
...
\subclause3[common.iter.cust]{Customizations}
...
\subclause2[default.sentinel]{Default sentinel}
...
\subclause2[iterators.counted]{Counted iterators}

\subclause3[counted.iterator]{Class template \tcode{counted_iterator}}
...
\subclause3[counted.iter.const]{Constructors and conversions}
...
\subclause3[counted.iter.access]{Accessors}
...
\subclause3[counted.iter.elem]{Element access}
...
\subclause3[counted.iter.nav]{Navigation}
...
\subclause3[counted.iter.cmp]{Comparisons}
...
\subclause3[counted.iter.cust]{Customizations}
...
\subclause2[unreachable.sentinel]{Unreachable sentinel}
...
\subclause1[stream.iterators]{Stream iterators}

\subclause2[stream.iterators.general]{General}
...
\subclause2[istream.iterator]{Class template \tcode{istream_iterator}}

\subclause3[istream.iterator.general]{General}
...
\subclause3[istream.iterator.cons]{Constructors and destructor}
...
\subclause3[istream.iterator.ops]{Operations}
...
\subclause2[ostream.iterator]{Class template \tcode{ostream_iterator}}

\subclause3[ostream.iterator.general]{General}
...
\subclause3[ostream.iterator.cons.des]{Constructors and destructor}
...
\subclause3[ostream.iterator.ops]{Operations}
...
\subclause2[istreambuf.iterator]{Class template \tcode{istreambuf_iterator}}

\subclause3[istreambuf.iterator.general]{General}
...
\subclause3[istreambuf.iterator.proxy]{Class \tcode{istreambuf_iterator::\placeholder{proxy}}}
...
\subclause3[istreambuf.iterator.cons]{Constructors}
...
\subclause3[istreambuf.iterator.ops]{Operations}
...
\subclause2[ostreambuf.iterator]{Class template \tcode{ostreambuf_iterator}}

\subclause3[ostreambuf.iterator.general]{General}
...
\subclause3[ostreambuf.iter.cons]{Constructors}
...
\subclause3[ostreambuf.iter.ops]{Operations}
...
\subclause1[iterator.range]{Range access}
