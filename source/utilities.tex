...
\tcode{is_nothrow_invocable_r_v<R, VT \cv{} \placeholder{ref}, ArgTypes...> \&\&
is_nothrow_invocable_r_v<R, VT \placeholder{inv-quals}, ArgTypes...>}.
Otherwise, \tcode{\exposid{is-\linebreak{}callable-from}<VT>} is equal to
\tcode{is_invocable_r_v<R, VT \cv{} \placeholder{ref}, ArgTypes...> \&\&
is_invoca\-ble_r_v<R, VT \placeholder{inv-quals}, ArgTypes...>}.
\end{itemdescr}
