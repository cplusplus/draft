...
\begin{itemize}
\item
if \tcode{T} is a function pointer type,
...
\item
if \tcode{T} is a class type and the \grammarterm{qualified-id} \tcode{T::result_type}
is valid and denotes a type~(\ref{temp.deduct}),
...
\begin{itemize}
\item
a function type or a function pointer type taking one argument of type \tcode{T1}
...
\item
a class type where the \grammarterm{qualified-id} \tcode{T::argument_type} is valid and
denotes a type~(\ref{temp.deduct}); the type \tcode{T1} is
...
\begin{itemize}
\item
a function type or a function pointer type taking two arguments of types \tcode{T1} and
\tcode{T2}
...
\item
a class type where the \grammarterm{qualified-id}{s} \tcode{T::first_argument_type} and
\tcode{T::second_argument_type} are both valid and
