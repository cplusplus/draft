...
requirements (\tref{allocator.req}).
...
\pnum
\begin{example} Given an allocator type \tcode{X} (\tref{allocator.req}) and
...
satisfies the \oldconcept{Allocator} requirements (\tref{allocator.req}).
