%!TEX root = std.tex
\subclause0[utilities]{General utilities library}

\subclause1[utilities.general]{General}
...
\subclause1[utility]{Utility components}

\subclause2[utility.syn]{Header \tcode{<utility>} synopsis}
...
\subclause2[utility.swap]{\tcode{swap}}
...
\subclause2[utility.exchange]{\tcode{exchange}}
...
\subclause2[forward]{Forward/move helpers}
...
\subclause2[utility.as.const]{Function template \tcode{as_const}}
...
\subclause2[declval]{Function template \tcode{declval}}
...
\subclause2[utility.intcmp]{Integer comparison functions}
...
\subclause2[utility.underlying]{Function template \tcode{to_underlying}}
...
\subclause1[intseq]{Compile-time integer sequences}

\subclause2[intseq.general]{In general}
...
\subclause2[intseq.intseq]{Class template \tcode{integer_sequence}}
...
\subclause2[intseq.make]{Alias template \tcode{make_integer_sequence}}
...
\subclause1[pairs]{Pairs}

\subclause2[pairs.general]{In general}
...
\subclause2[pairs.pair]{Class template \tcode{pair}}
...
\subclause2[pairs.spec]{Specialized algorithms}
...
\subclause2[pair.astuple]{Tuple-like access to pair}
...
\subclause2[pair.piecewise]{Piecewise construction}
...
\subclause1[tuple]{Tuples}

\subclause2[tuple.general]{In general}
...
\subclause2[tuple.syn]{Header \tcode{<tuple>} synopsis}
...
\subclause2[tuple.tuple]{Class template \tcode{tuple}}
\indexlibraryglobal{tuple}%
...
\subclause3[tuple.cnstr]{Construction}
...
\subclause3[tuple.assign]{Assignment}
...
\subclause3[tuple.swap]{\tcode{swap}}
...
\subclause2[tuple.creation]{Tuple creation functions}
...
\subclause2[tuple.apply]{Calling a function with a \tcode{tuple} of arguments}
...
\subclause2[tuple.helper]{Tuple helper classes}
...
\subclause2[tuple.elem]{Element access}
...
\subclause2[tuple.rel]{Relational operators}
...
\subclause2[tuple.traits]{Tuple traits}
...
\subclause2[tuple.special]{Tuple specialized algorithms}
...
\subclause1[optional]{Optional objects}

\subclause2[optional.general]{In general}
...
\subclause2[optional.syn]{Header \tcode{<optional>} synopsis}
...
\subclause2[optional.optional]{Class template \tcode{optional}}

\subclause3[optional.optional.general]{General}
...
\subclause3[optional.ctor]{Constructors}
...
\subclause3[optional.dtor]{Destructor}
...
\subclause3[optional.assign]{Assignment}
...
\subclause3[optional.observe]{Observers}
...
\subclause3[optional.mod]{Modifiers}
...
\subclause2[optional.nullopt]{No-value state indicator}
...
\subclause2[optional.bad.access]{Class \tcode{bad_optional_access}}
...
\subclause2[optional.relops]{Relational operators}
...
\subclause2[optional.nullops]{Comparison with \tcode{nullopt}}
...
\subclause2[optional.comp.with.t]{Comparison with \tcode{T}}
...
\subclause2[optional.specalg]{Specialized algorithms}
...
\subclause2[optional.hash]{Hash support}
...
\subclause1[variant]{Variants}

\subclause2[variant.general]{In general}
...
\subclause2[variant.syn]{Header \tcode{<variant>} synopsis}
\indexheader{variant}%
...
\subclause2[variant.variant]{Class template \tcode{variant}}%
\indexlibraryglobal{variant}%

\subclause3[variant.variant.general]{General}
...
\subclause3[variant.ctor]{Constructors}
...
\subclause3[variant.dtor]{Destructor}
...
\subclause3[variant.assign]{Assignment}
...
\subclause3[variant.mod]{Modifiers}
...
\subclause3[variant.status]{Value status}
...
\subclause2[variant.helper]{\tcode{variant} helper classes}
...
\subclause2[variant.get]{Value access}
...
\subclause2[variant.relops]{Relational operators}
...
\subclause2[variant.visit]{Visitation}
...
\subclause2[variant.monostate]{Class \tcode{monostate}}%
...
\subclause2[variant.monostate.relops]{\tcode{monostate} relational operators}
...
\subclause2[variant.specalg]{Specialized algorithms}
...
\subclause2[variant.bad.access]{Class \tcode{bad_variant_access}}%
...
\subclause2[variant.hash]{Hash support}
...
\subclause1[any]{Storage for any type}

\subclause2[any.general]{General}
...
\subclause2[any.synop]{Header \tcode{<any>} synopsis}
...
\subclause2[any.bad.any.cast]{Class \tcode{bad_any_cast}}
...
\subclause2[any.class]{Class \tcode{any}}

\subclause3[any.class.general]{General}
...
\subclause3[any.cons]{Construction and destruction}
...
\subclause3[any.assign]{Assignment}
...
\subclause3[any.modifiers]{Modifiers}
...
\subclause3[any.observers]{Observers}
...
\subclause2[any.nonmembers]{Non-member functions}
...
\subclause1[bitset]{Bitsets}
\indexlibraryglobal{bitset}%

\subclause2[bitset.syn]{Header \tcode{<bitset>} synopsis}%
...
\subclause2[template.bitset]{Class template \tcode{bitset}}%

\subclause3[template.bitset.general]{General}%
\indexlibraryglobal{bitset}%
\begin{codeblock}
namespace std {
  template<size_t N> class bitset {
...
\subclause3[bitset.cons]{Constructors}
...
\subclause3[bitset.members]{Members}
...
\subclause2[bitset.hash]{\tcode{bitset} hash support}
...
\subclause2[bitset.operators]{\tcode{bitset} operators}
...
\subclause1[memory]{Memory}

\subclause2[memory.general]{In general}
...
\subclause2[memory.syn]{Header \tcode{<memory>} synopsis}
...
\subclause2[pointer.traits]{Pointer traits}

\subclause3[pointer.traits.general]{General}
...
\subclause3[pointer.traits.types]{Member types}
...
\subclause3[pointer.traits.functions]{Member functions}
...
\subclause3[pointer.traits.optmem]{Optional members}
...
\subclause2[pointer.conversion]{Pointer conversion}
...
\subclause2[ptr.align]{Pointer alignment}
...
\subclause2[allocator.tag]{Allocator argument tag}
...
\subclause2[allocator.uses]{\tcode{uses_allocator}}

\subclause3[allocator.uses.trait]{\tcode{uses_allocator} trait}
...
\subclause3[allocator.uses.construction]{Uses-allocator construction}
...
\subclause2[allocator.traits]{Allocator traits}

\subclause3[allocator.traits.general]{General}
...
\subclause3[allocator.traits.types]{Member types}
...
\subclause3[allocator.traits.members]{Static member functions}
...
\subclause3[allocator.traits.other]{Other}
...
\subclause2[default.allocator]{The default allocator}

\subclause3[default.allocator.general]{General}
...
\subclause3[allocator.members]{Members}
...
\subclause3[allocator.globals]{Operators}
...
\subclause2[specialized.addressof]{\tcode{addressof}}
...
\subclause2[c.malloc]{C library memory allocation}
...
\subclause1[smartptr]{Smart pointers}

\subclause2[unique.ptr]{Class template \tcode{unique_ptr}}

\subclause3[unique.ptr.general]{General}
...
\subclause3[unique.ptr.dltr]{Default deleters}

\subclause4[unique.ptr.dltr.general]{In general}
...
\subclause4[unique.ptr.dltr.dflt]{\tcode{default_delete}}
...
\subclause4[unique.ptr.dltr.dflt1]{\tcode{default_delete<T[]>}}
...
\subclause3[unique.ptr.single]{\tcode{unique_ptr} for single objects}

\subclause4[unique.ptr.single.general]{General}
...
\subclause4[unique.ptr.single.ctor]{Constructors}
...
\subclause4[unique.ptr.single.dtor]{Destructor}
...
\subclause4[unique.ptr.single.asgn]{Assignment}
...
\subclause4[unique.ptr.single.observers]{Observers}
...
\subclause4[unique.ptr.single.modifiers]{Modifiers}
...
\subclause3[unique.ptr.runtime]{\tcode{unique_ptr} for array objects with a runtime length}

\subclause4[unique.ptr.runtime.general]{General}
...
\subclause4[unique.ptr.runtime.ctor]{Constructors}
...
\subclause4[unique.ptr.runtime.asgn]{Assignment}
...
\subclause4[unique.ptr.runtime.observers]{Observers}
...
\subclause4[unique.ptr.runtime.modifiers]{Modifiers}
...
\subclause3[unique.ptr.create]{Creation}
...
\subclause3[unique.ptr.special]{Specialized algorithms}
...
\subclause2[util.smartptr.weak.bad]{Class \tcode{bad_weak_ptr}}%
...
\subclause2[util.smartptr.shared]{Class template \tcode{shared_ptr}}

\subclause3[util.smartptr.shared.general]{General}
...
\subclause3[util.smartptr.shared.const]{Constructors}
...
\subclause3[util.smartptr.shared.dest]{Destructor}
...
\subclause3[util.smartptr.shared.assign]{Assignment}
...
\subclause3[util.smartptr.shared.mod]{Modifiers}
...
\subclause3[util.smartptr.shared.obs]{Observers}
...
\subclause3[util.smartptr.shared.create]{Creation}
...
\subclause3[util.smartptr.shared.cmp]{Comparison}
...
\subclause3[util.smartptr.shared.spec]{Specialized algorithms}
...
\subclause3[util.smartptr.shared.cast]{Casts}
...
\subclause3[util.smartptr.getdeleter]{\tcode{get_deleter}}
...
\subclause3[util.smartptr.shared.io]{I/O}
...
\subclause2[util.smartptr.weak]{Class template \tcode{weak_ptr}}

\subclause3[util.smartptr.weak.general]{General}
...
\subclause3[util.smartptr.weak.const]{Constructors}
...
\subclause3[util.smartptr.weak.dest]{Destructor}
...
\subclause3[util.smartptr.weak.assign]{Assignment}
...
\subclause3[util.smartptr.weak.mod]{Modifiers}
...
\subclause3[util.smartptr.weak.obs]{Observers}
...
\subclause3[util.smartptr.weak.spec]{Specialized algorithms}
...
\subclause2[util.smartptr.ownerless]{Class template \tcode{owner_less}}
...
\subclause2[util.smartptr.enab]{Class template \tcode{enable_shared_from_this}}
...
\subclause2[util.smartptr.hash]{Smart pointer hash support}
...
\subclause2[out.ptr.t]{Class template \tcode{out_ptr_t}}
...
\subclause2[out.ptr]{Function template \tcode{out_ptr}}
...
\subclause2[inout.ptr.t]{Class template \tcode{inout_ptr_t}}
...
\subclause2[inout.ptr]{Function template \tcode{inout_ptr}}
...
\subclause1[mem.res]{Memory resources}

\subclause2[mem.res.syn]{Header \tcode{<memory_resource>} synopsis}
...
\subclause2[mem.res.class]{Class \tcode{memory_resource}}

\subclause3[mem.res.class.general]{General}
...
\subclause3[mem.res.public]{Public member functions}
...
\subclause3[mem.res.private]{Private virtual member functions}
...
\subclause3[mem.res.eq]{Equality}
...
\subclause2[mem.poly.allocator.class]{Class template \tcode{polymorphic_allocator}}

\subclause3[mem.poly.allocator.class.general]{General}
...
\subclause3[mem.poly.allocator.ctor]{Constructors}
...
\subclause3[mem.poly.allocator.mem]{Member functions}
...
\subclause3[mem.poly.allocator.eq]{Equality}
...
\subclause2[mem.res.global]{Access to program-wide \tcode{memory_resource} objects}
...
\subclause2[mem.res.pool]{Pool resource classes}

\subclause3[mem.res.pool.overview]{Classes \tcode{synchronized_pool_resource} and \tcode{unsynchronized_pool_resource}}
...
\subclause3[mem.res.pool.options]{\tcode{pool_options} data members}
...
\subclause3[mem.res.pool.ctor]{Constructors and destructors}
...
\subclause3[mem.res.pool.mem]{Members}
...
\subclause2[mem.res.monotonic.buffer]{Class \tcode{monotonic_buffer_resource}}

\subclause3[mem.res.monotonic.buffer.general]{General}
...
\subclause3[mem.res.monotonic.buffer.ctor]{Constructors and destructor}
...
\subclause3[mem.res.monotonic.buffer.mem]{Members}
...
\subclause1[allocator.adaptor]{Class template \tcode{scoped_allocator_adaptor}}

\subclause2[allocator.adaptor.syn]{Header \tcode{<scoped_allocator>} synopsis}
...
\subclause2[allocator.adaptor.types]{Member types}
...
\subclause2[allocator.adaptor.cnstr]{Constructors}
...
\subclause2[allocator.adaptor.members]{Members}
...
\subclause2[scoped.adaptor.operators]{Operators}
...
\subclause1[function.objects]{Function objects}

\subclause2[function.objects.general]{General}
...
\subclause2[functional.syn]{Header \tcode{<functional>} synopsis}
...
\subclause2[func.def]{Definitions}
...
\subclause2[func.require]{Requirements}
...
\subclause2[func.invoke]{\tcode{invoke} functions}
...
\subclause2[refwrap]{Class template \tcode{reference_wrapper}}

\subclause3[refwrap.general]{General}
...
\subclause3[refwrap.const]{Constructors and destructor}
...
\subclause3[refwrap.assign]{Assignment}
...
\subclause3[refwrap.access]{Access}
...
\subclause3[refwrap.invoke]{Invocation}
...
\subclause3[refwrap.helpers]{Helper functions}
...
\subclause2[arithmetic.operations]{Arithmetic operations}

\subclause3[arithmetic.operations.general]{General}
...
\subclause3[arithmetic.operations.plus]{Class template \tcode{plus}}
...
\subclause3[arithmetic.operations.minus]{Class template \tcode{minus}}
...
\subclause3[arithmetic.operations.multiplies]{Class template \tcode{multiplies}}
...
\subclause3[arithmetic.operations.divides]{Class template \tcode{divides}}
...
\subclause3[arithmetic.operations.modulus]{Class template \tcode{modulus}}
...
\subclause3[arithmetic.operations.negate]{Class template \tcode{negate}}
...
\subclause2[comparisons]{Comparisons}

\subclause3[comparisons.general]{General}
...
\subclause3[comparisons.equal.to]{Class template \tcode{equal_to}}
...
\subclause3[comparisons.not.equal.to]{Class template \tcode{not_equal_to}}
...
\subclause3[comparisons.greater]{Class template \tcode{greater}}
...
\subclause3[comparisons.less]{Class template \tcode{less}}
...
\subclause3[comparisons.greater.equal]{Class template \tcode{greater_equal}}
...
\subclause3[comparisons.less.equal]{Class template \tcode{less_equal}}
...
\subclause3[comparisons.three.way]{Class \tcode{compare_three_way}}
...
\subclause2[range.cmp]{Concept-constrained comparisons}
...
\subclause2[logical.operations]{Logical operations}

\subclause3[logical.operations.general]{General}
...
\subclause3[logical.operations.and]{Class template \tcode{logical_and}}
...
\subclause3[logical.operations.or]{Class template \tcode{logical_or}}
...
\subclause3[logical.operations.not]{Class template \tcode{logical_not}}
...
\subclause2[bitwise.operations]{Bitwise operations}

\subclause3[bitwise.operations.general]{General}
...
\subclause3[bitwise.operations.and]{Class template \tcode{bit_and}}
...
\subclause3[bitwise.operations.or]{Class template \tcode{bit_or}}
...
\subclause3[bitwise.operations.xor]{Class template \tcode{bit_xor}}
...
\subclause3[bitwise.operations.not]{Class template \tcode{bit_not}}
...
\subclause2[func.identity]{Class \tcode{identity}}
...
\subclause2[func.not.fn]{Function template \tcode{not_fn}}
...
\subclause2[func.bind.front]{Function template \tcode{bind_front}}
...
\subclause2[func.bind]{Function object binders}%

\subclause3[func.bind.general]{General}%
...
\subclause3[func.bind.isbind]{Class template \tcode{is_bind_expression}}
...
\subclause3[func.bind.isplace]{Class template \tcode{is_placeholder}}
...
\subclause3[func.bind.bind]{Function template \tcode{bind}}
...
\subclause3[func.bind.place]{Placeholders}
...
\subclause2[func.memfn]{Function template \tcode{mem_fn}}%
...
\subclause2[func.wrap]{Polymorphic function wrappers}%

\subclause3[func.wrap.general]{General}%
...
\subclause3[func.wrap.badcall]{Class \tcode{bad_function_call}}%
...
\subclause3[func.wrap.func]{Class template \tcode{function}}

\subclause4[func.wrap.func.general]{General}
...
\subclause4[func.wrap.func.con]{Constructors and destructor}
...
\subclause4[func.wrap.func.mod]{Modifiers}
...
\subclause4[func.wrap.func.cap]{Capacity}
...
\subclause4[func.wrap.func.inv]{Invocation}
...
\subclause4[func.wrap.func.targ]{Target access}
...
\subclause4[func.wrap.func.nullptr]{Null pointer comparison operator functions}
...
\subclause4[func.wrap.func.alg]{Specialized algorithms}
...
\subclause2[func.search]{Searchers}

\subclause3[func.search.general]{General}
...
\subclause3[func.search.default]{Class template \tcode{default_searcher}}
...
\subclause3[func.search.bm]{Class template \tcode{boyer_moore_searcher}}
...
\subclause3[func.search.bmh]{Class template \tcode{boyer_moore_horspool_searcher}}
...
\subclause2[unord.hash]{Class template \tcode{hash}}
...
\subclause1[meta]{Metaprogramming and type traits}

\subclause2[meta.general]{General}
...
\subclause2[meta.rqmts]{Requirements}
...
\subclause2[meta.type.synop]{Header \tcode{<type_traits>} synopsis}
...
\subclause2[meta.help]{Helper classes}
...
\subclause2[meta.unary]{Unary type traits}

\subclause3[meta.unary.general]{General}
...
\subclause3[meta.unary.cat]{Primary type categories}
...
\subclause3[meta.unary.comp]{Composite type traits}
...
\subclause3[meta.unary.prop]{Type properties}
...
\subclause2[meta.unary.prop.query]{Type property queries}
...
\subclause2[meta.rel]{Relationships between types}
...
\subclause2[meta.trans]{Transformations between types}

\subclause3[meta.trans.general]{General}
\pnum
...
\subclause3[meta.trans.cv]{Const-volatile modifications}
...
\subclause3[meta.trans.ref]{Reference modifications}
...
\subclause3[meta.trans.sign]{Sign modifications}
...
\subclause3[meta.trans.arr]{Array modifications}
...
\subclause3[meta.trans.ptr]{Pointer modifications}
...
\subclause3[meta.trans.other]{Other transformations}
...
\subclause2[meta.logical]{Logical operator traits}
...
\subclause2[meta.member]{Member relationships}
...
\subclause2[meta.const.eval]{Constant evaluation context}
\begin{itemdecl}
constexpr bool is_constant_evaluated() noexcept;
\end{itemdecl}
...
\subclause1[ratio]{Compile-time rational arithmetic}

\subclause2[ratio.general]{In general}
...
\subclause2[ratio.syn]{Header \tcode{<ratio>} synopsis}
...
\subclause2[ratio.ratio]{Class template \tcode{ratio}}
...
\subclause2[ratio.arithmetic]{Arithmetic on \tcode{ratio}{s}}
...
\subclause2[ratio.comparison]{Comparison of \tcode{ratio}{s}}
...
\subclause2[ratio.si]{SI types for \tcode{ratio}}
...
\subclause1[type.index]{Class \tcode{type_index}}

\subclause2[type.index.synopsis]{Header \tcode{<typeindex>} synopsis}
...
\subclause2[type.index.overview]{\tcode{type_index} overview}
...
\subclause2[type.index.members]{\tcode{type_index} members}
...
\subclause2[type.index.hash]{Hash support}
...
\subclause1[execpol]{Execution policies}
\subclause2[execpol.general]{In general}
...
\subclause2[execution.syn]{Header \tcode{<execution>} synopsis}
...
\subclause2[execpol.type]{Execution policy type trait}
...
\subclause2[execpol.seq]{Sequenced execution policy}
...
\subclause2[execpol.par]{Parallel execution policy}
...
\subclause2[execpol.parunseq]{Parallel and unsequenced execution policy}
...
\subclause2[execpol.unseq]{Unsequenced execution policy}
...
\subclause2[execpol.objects]{Execution policy objects}
...
\subclause1[charconv]{Primitive numeric conversions}

\subclause2[charconv.syn]{Header \tcode{<charconv>} synopsis}
...
\subclause2[charconv.to.chars]{Primitive numeric output conversion}
...
\subclause2[charconv.from.chars]{Primitive numeric input conversion}
...
\subclause1[format]{Formatting}

\subclause2[format.syn]{Header \tcode{<format>} synopsis}
...
\subclause2[format.string]{Format string}

\subclause3[format.string.general]{In general}
...
\subclause3[format.string.std]{Standard format specifiers}
...
\subclause2[format.err.report]{Error reporting}
...
\subclause2[format.fmt.string]{Class template \exposid{basic-format-string}}
...
\subclause2[format.functions]{Formatting functions}
...
\subclause2[format.formatter]{Formatter}

\subclause3[formatter.requirements]{Formatter requirements}
...
\subclause3[format.formatter.spec]{Formatter specializations}
...
\subclause3[format.parse.ctx]{Class template \tcode{basic_format_parse_context}}
...
\subclause3[format.context]{Class template \tcode{basic_format_context}}
...
\subclause2[format.arguments]{Arguments}

\subclause3[format.arg]{Class template \tcode{basic_format_arg}}
...
\subclause3[format.arg.store]{Class template \exposid{format-arg-store}}
...
\subclause3[format.args]{Class template \tcode{basic_format_args}}
...
\subclause2[format.error]{Class \tcode{format_error}}
...
\subclause1[stacktrace]{Stacktrace}

\subclause2[stacktrace.general]{General}
...
\subclause2[stacktrace.syn]{Header \tcode{<stacktrace>} synopsis}
...
\subclause2[stacktrace.entry]{Class \tcode{stacktrace_entry}}

\subclause3[stacktrace.entry.overview]{Overview}
...
\subclause3[stacktrace.entry.ctor]{Constructors}
...
\subclause3[stacktrace.entry.obs]{Observers}
...
\subclause3[stacktrace.entry.query]{Query}
...
\subclause3[stacktrace.entry.cmp]{Comparison}
...
\subclause2[stacktrace.basic]{Class template \tcode{basic_stacktrace}}

\subclause3[stacktrace.basic.overview]{Overview}
...
\subclause3[stacktrace.basic.ctor]{Creation and assignment}
...
\subclause3[stacktrace.basic.obs]{Observers}
...
\subclause3[stacktrace.basic.cmp]{Comparisons}
...
\subclause3[stacktrace.basic.mod]{Modifiers}
...
\subclause3[stacktrace.basic.nonmem]{Non-member functions}
...
\subclause3[stacktrace.basic.hash]{Hash support}
