...
\tcode{is_assignable_v<first_type\&, const U\&>} is \tcode{true}
...
\pnum
\remarks This operator shall not participate in overload resolution unless
\tcode{is_assignable_v<first_type\&, U\&\&>} is \tcode{true}
...
\pnum
\remarks This operator shall be defined as deleted unless
\tcode{is_copy_assignable_v<$T_i$>} is \tcode{true} for all $i$.
...
\pnum
\remarks This operator shall be defined as deleted unless
\tcode{is_move_assignable_v<$T_i$>} is \tcode{true} for all $i$.
...
\pnum
\remarks This operator shall not participate in overload resolution unless
\tcode{is_assignable_v<Ti\&, Ui\&\&> == true} for all \tcode{i} and
...
\begin{itemdecl}
template <class U = T>
  @\EXPLICIT@ constexpr optional(T&& v);
\end{itemdecl}
...
\remarks
This constructor shall not participate in overload resolution unless
\tcode{is_constructible_v<T, const U\&>} is \tcode{true},
\tcode{is_constructible_v<T, optional<U>\&>} is \tcode{false},
\tcode{is_constructible_v<T, const optional<U>\&>} is \tcode{false},
\tcode{is_constructible_v<T, const optional<U>\&\&>} is \tcode{false},
\tcode{is_constructible_v<T, optional<U>\&\&>} is \tcode{false},
\tcode{is_convertible_v<optional<U>\&, T>} is \tcode{false},
\tcode{is_convertible_v<const optional<U>\&, T>} is \tcode{false},
\tcode{is_convertible_v<const optional<U>\&\&, T>} is \tcode{false}, and
\tcode{is_convertible_v<optional<U>\&\&, T>} is \tcode{false}.
The constructor is explicit if and only if
...
\remarks
This constructor shall not participate in overload resolution unless
\tcode{is_constructible_v<T, U\&\&>} is true,
\tcode{is_constructible_v<T, optional<U>\&>} is \tcode{false},
\tcode{is_constructible_v<T, const optional<U>\&>} is \tcode{false},
\tcode{is_constructible_v<T, const optional<U>\&\&>} is \tcode{false},
\tcode{is_constructible_v<T, optional<U>\&\&>} is \tcode{false},
...
This function shall not participate in overload resolution unless
\tcode{is_constructible_v<T, const U\&>} is \tcode{true},
\tcode{is_assignable_v<T\&, const U\&>} is \tcode{true},
\tcode{is_constructible_v<T, optional<U>\&>} is \tcode{false},
\tcode{is_constructible_v<T, const optional<U>\&>} is \tcode{false},
\tcode{is_constructible_v<T, const optional<U>\&\&>} is \tcode{false},
\tcode{is_constructible_v<T, optional<U>\&\&>} is \tcode{false},
...
\tcode{is_convertible_v<const optional<U>\&\&, T>} is \tcode{false},
\tcode{is_convertible_v<optional<U>\&\&, T>} is \tcode{false},
\tcode{is_assignable_v<T\&, optional<U>\&>} is \tcode{false},
\tcode{is_assignable_v<T\&, const optional<U>\&>} is \tcode{false},
\tcode{is_assignable_v<T\&, const optional<U>\&\&>} is \tcode{false}, and
\tcode{is_assignable_v<T\&, optional<U>\&\&>} is \tcode{false}.
\end{itemdescr}
...
\tcode{is_convertible_v<optional<U>\&, T>} is \tcode{false},
\tcode{is_convertible_v<const optional<U>\&, T>} is \tcode{false},
\tcode{is_convertible<const optional<U>\&\&, T>} is \tcode{false},
\tcode{is_convertible<optional<U>\&\&, T>} is \tcode{false},
\tcode{is_assignable_v<T\&, optional<U>\&>} is \tcode{false},
\tcode{is_assignable_v<T\&, const optional<U>\&>} is \tcode{false},
\tcode{is_assignable_v<T\&, const optional<U>\&\&>} is \tcode{false}, and
\tcode{is_assignable_v<T\&, optional<U>\&\&>} is \tcode{false}.
...
\pnum
Type \tcode{nullopt_t} shall not have a default constructor or an initializer-list constructor.
It shall not be an aggregate and shall be a literal type.
Constant \tcode{nullopt} shall be initialized with an argument of literal type.
...
\pnum
For any type \tcode{T} that is not of integral or enumeration type, or
for which neither the library nor the user provides
an explicit or partial specialization of the class template \tcode{hash},
the specialization of \tcode{hash<T>} has the following properties:
\begin{itemize}
\item \tcode{is_default_constructible_v<hash<T>>} is \tcode{false}
\item \tcode{is_copy_constructible_v<hash<T>>} is \tcode{false}
\item \tcode{is_move_constructible_v<hash<T>>} is \tcode{false}
\item \tcode{is_copy_assignable_v<hash<T>>} is \tcode{false}
\item \tcode{is_move_assignable_v<hash<T>>} is \tcode{false}
\item \tcode{hash<T>} is not a function object type~(\ref{function.objects})
\end{itemize}
\begin{note} This means that the specialization of \tcode{hash} exists,
but any attempts to use it as a \tcode{Hash} will be ill-formed. \end{note}
\end{itemdescr}
...
\tcode{template <class T, class... Args>}\br
 ...
 for a (possibly cv-qualified) \tcode{void} type \tcode{T},
