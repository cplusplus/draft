...
namespace std {
  ...
  template<class T, class Alloc>
    constexpr bool @\libglobal{uses_allocator_v}@ = uses_allocator<T, Alloc>::value;
...
namespace std {
  ...
  template<class T>
    constexpr bool @\libglobal{is_bind_expression_v}@ = is_bind_expression<T>::value;
  template<class T> struct is_placeholder;
  template<class T>
    constexpr int @\libglobal{is_placeholder_v}@ = is_placeholder<T>::value;
