...
\pnum
\tcode{T} shall be an object type and shall satisfy the requirements of \tcode{Destructible} (\tref{destructible}).
...
the requirements of \tcode{Destructible} (\tref{destructible}).
...
satisfy the requirements of \tcode{DefaultConstructible} (\tref{defaultconstructible}),
...
requirements of \tcode{MoveAssignable} (\tref{moveassignable}) and assignment
...
satisfy the requirements of \tcode{EqualityCom\-parable} (\tref{equalitycomparable}),
...
\tcode{Destructible} (\tref{destructible}), and the requirements of
