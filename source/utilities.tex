...
\tcode{D} shall satisfy the requirements of \tcode{CopyConstructible} and
such construction shall not exit via an exception.
For the second constructor, if \tcode{D} is not a reference type,
\tcode{D} shall satisfy the requirements of \tcode{MoveConstructible} and
such construction shall not exit via an exception.
...
namespace std {
  ...
  namespace chrono {
    ...
    // \ref{time.calendar.last}, class \tcode{last_spec}
    struct last_spec;

    // \ref{time.calendar.day}, class \tcode{day}
    class day;
    ...
    // \ref{time.calendar.month}, class \tcode{month}
    class month;
    ...
    // \ref{time.calendar.year}, class \tcode{year}
    class year;
    ...
    // \ref{time.calendar.weekday}, class \tcode{weekday}
    class weekday;
    ...
    // \ref{time.calendar.weekday.indexed}, class \tcode{weekday_indexed}
    ...
    // \ref{time.calendar.weekday.last}, class \tcode{weekday_last}
    class weekday_last;
    ...
    // \ref{time.calendar.month.day}, class \tcode{month_day}
    class month_day;
    ...
    // \ref{time.calendar.month.day.last}, class \tcode{month_day_last}
    ...
    // \ref{time.calendar.month.weekday}, class \tcode{month_weekday}
    class month_weekday;
    ...
    // \ref{time.calendar.month.weekday.last}, class \tcode{month_weekday_last}
    ...
    // \ref{time.calendar.year.month}, class \tcode{year_month}
    class year_month;
    ...
    // \ref{time.calendar.year.month.day}, class \tcode{year_month_day}
    ...
    // \ref{time.calendar.year.month.day.last}, class \tcode{year_month_day_last}
    ...
    // \ref{time.calendar.year.month.weekday}, class \tcode{year_month_weekday}
    ...
    // \ref{time.calendar.year.month.weekday.last}, class \tcode{year_month_weekday_last}
    ...
    // \ref{time.calendar.operators}, civil calendar conventional syntax operators
...
meet the Clock requirements\iref{time.clock.req}
...
\tcode{sys_time} and calendar types\iref{time.calendar}.
\begin{example} \\
...
\rSec2[time.calendar]{The civil calendar}

\rSec3[time.calendar.general]{In general}

\pnum
The types in \ref{time.calendar} describe the civil (Gregorian) calendar
and its relationship to \tcode{sys_days} and \tcode{local_days}.

\rSec3[time.calendar.last]{Class \tcode{last_spec}}
...
\rSec3[time.calendar.day]{Class \tcode{day}}

\rSec4[time.calendar.day.overview]{Overview}
...
\rSec4[time.calendar.day.members]{Member functions}
...
\rSec4[time.calendar.day.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.month]{Class \tcode{month}}

\rSec4[time.calendar.month.overview]{Overview}
...
\rSec4[time.calendar.month.members]{Member functions}
...
\rSec4[time.calendar.month.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.year]{Class \tcode{year}}

\rSec4[time.calendar.year.overview]{Overview}
...
\rSec4[time.calendar.year.members]{Member functions}
...
\rSec4[time.calendar.year.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.weekday]{Class \tcode{weekday}}

\rSec4[time.calendar.weekday.overview]{Overview}
...
\rSec4[time.calendar.weekday.members]{Member functions}
...
\rSec4[time.calendar.weekday.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.weekday.indexed]{Class \tcode{weekday_indexed}}

\rSec4[time.calendar.weekday.indexed.overview]{Overview}
...
\rSec4[time.calendar.weekday.indexed.members]{Member functions}
...
\rSec4[time.calendar.weekday.indexed.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.weekday.last]{Class \tcode{weekday_last}}

\rSec4[time.calendar.weekday.last.overview]{Overview}
...
\rSec4[time.calendar.weekday.last.members]{Member functions}
...
\rSec4[time.calendar.weekday.last.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.month.day]{Class \tcode{month_day}}

\rSec4[time.calendar.month.day.overview]{Overview}
...
\rSec4[time.calendar.month.day.members]{Member functions}
...
\rSec4[time.calendar.month.day.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.month.day.last]{Class \tcode{month_day_last}}
...
\rSec3[time.calendar.month.weekday]{Class \tcode{month_weekday}}

\rSec4[time.calendar.month.weekday.overview]{Overview}
...
\rSec4[time.calendar.month.weekday.members]{Member functions}
...
\rSec4[time.calendar.month.weekday.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.month.weekday.last]{Class \tcode{month_weekday_last}}

\rSec4[time.calendar.month.weekday.last.overview]{Overview}
...
\rSec4[time.calendar.month.weekday.last.members]{Member functions}
...
\rSec4[time.calendar.month.weekday.last.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.year.month]{Class \tcode{year_month}}

\rSec4[time.calendar.year.month.overview]{Overview}
...
\rSec4[time.calendar.year.month.members]{Member functions}
...
\rSec4[time.calendar.year.month.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.year.month.day]{Class \tcode{year_month_day}}

\rSec4[time.calendar.year.month.day.overview]{Overview}
...
\rSec4[time.calendar.year.month.day.members]{Member functions}
...
\rSec4[time.calendar.year.month.day.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.year.month.day.last]{Class \tcode{year_month_day_last}}

\rSec4[time.calendar.year.month.day.last.overview]{Overview}
...
\rSec4[time.calendar.year.month.day.last.members]{Member functions}
...
\rSec4[time.calendar.year.month.day.last.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.year.month.weekday]{Class \tcode{year_month_weekday}}

\rSec4[time.calendar.year.month.weekday.overview]{Overview}
...
\rSec4[time.calendar.year.month.weekday.members]{Member functions}
...
\rSec4[time.calendar.year.month.weekday.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.year.month.weekday.last]{Class \tcode{year_month_weekday_last}}

\rSec4[time.calendar.year.month.weekday.last.overview]{Overview}
...
\rSec4[time.calendar.year.month.weekday.last.members]{Member functions}
...
\rSec4[time.calendar.year.month.weekday.last.nonmembers]{Non-member functions}
...
\rSec3[time.calendar.operators]{Conventional syntax operators}
...
both the civil calendar types\iref{time.calendar}
