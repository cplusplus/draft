...
\impldef{return value of \tcode{bad\_optional\_access::what}}
\ntbs.
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\returns An \impldef{return value of \tcode{bad\_variant\_access::what}} \ntbs.
\end{itemdescr}
...
\indeximpldef{whether \tcode{get\_pointer\_safety} returns
\tcode{pointer\_safety::relaxed} or
\tcode{pointer\_safety::preferred} if the implementation has relaxed pointer safety}
whether
...
\impldef{return value of \tcode{bad\_weak\_ptr::what}} \ntbs.
...
\pnum\throws \tcode{bad_alloc}, or an \impldef{exception type when \tcode{shared\_ptr}
...
\impldef{return value of \tcode{bad\_function\_call::what}} \ntbs.
\end{itemdescr}
...
required precision when converting between \tcode{time\_t} values and \tcode{time\_point} objects}
\end{itemdescr}
