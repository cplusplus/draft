...
expressions which occur as \termrefx{unevaluated operands}{unevaluated.operand}.
...
\pnum
\mandates
This function is not \termrefx{odr-used}{odr-use}.
...
when treated as an \termref{unevaluated operand}, then
...
\end{codeblock}
shall be well-formed when treated as an \termref{unevaluated operand}.
