...
namespace std {
  ...
  template<class T>
    [[nodiscard]] constexpr T&& forward(remove_reference_t<T>&& t) noexcept;
  template<class T>
    [[nodiscard]] constexpr remove_reference_t<T>&& move(T&&) noexcept;
  template<class T>
  ...
  template<class T>
    [[nodiscard]] constexpr add_const_t<T>& as_const(T& t) noexcept;
  template<class T>
...
\begin{itemdecl}
template<class T> [[nodiscard]] constexpr conditional_t<
    !is_nothrow_move_constructible_v<T> && is_copy_constructible_v<T>, const T&, T&&>
  move_if_noexcept(T& x) noexcept;
\end{itemdecl}
