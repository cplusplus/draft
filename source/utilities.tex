...
template<size_t I, class... Types>
  constexpr tuple_element_t<I, tuple<Types...>>&&
    get(tuple<Types...>&& t) noexcept;        // see Note 1
template<size_t I, class... Types>
  constexpr const tuple_element_t<I, tuple<Types...>>&
    get(const tuple<Types...>& t) noexcept;   // see Note 2
template<size_t I, class... Types>
...
\pnum
\begin{note}
For the overload with a parameter of type \tcode{tuple<Types...>\&\&},
...
For the overload with a parameter of type \tcode{const tuple<Types...>\&},
if a type \tcode{T} in \tcode{Types} is some reference type \tcode{X\&},
