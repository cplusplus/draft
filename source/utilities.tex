...
unless \tcode{is_same_v<remove_cvref_t<T>, variant>} is \tcode{false},
unless \tcode{remove_cvref_t<T>} is neither
...
\remarks
This function shall not participate in overload resolution unless
\tcode{is_same_v<remove_cvref_t<T>, variant>} is \tcode{false}, unless
