...
of the three partial specializations shall meet the \tcode{UnaryTypeTrait}
requirements~(\ref{meta.rqmts}) with a \tcode{BaseCharacteristic} of
\begin{codeblock}
...
each of the three partial specializations shall meet the
\tcode{TransformationTrait}
