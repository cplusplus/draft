...
and shall satisfy the \oldconcept{Destructible} requirements (\tref{cpp17.destructible}).
...
D>::pointer} shall
satisfy the \oldconcept{NullablePointer} requirements (\tref{cpp17.nullablepointer}).
...
satisfy the \oldconcept{DefaultConstructible} requirements (\tref{cpp17.defaultconstructible}),
...
satisfies the \oldconcept{Allocator} requirements (\tref{cpp17.allocator}).
...
\begin{itemize}
\item satisfy the \oldconcept{Hash} requirements (\tref{cpp17.hash}),
