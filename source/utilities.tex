...
\rSec3[format.range.fmtdef]{Class template \tcode{\exposid{range-default-formatter}}}
...
\rSec3[format.range.fmtmap]{Specialization of \tcode{\exposid{range-default-formatter}} for maps}
...
namespace std {
  ...
  private:
    using @\exposid{maybe-const-map}@ = @\exposid{fmt-maybe-const}@<R, charT>;                        // \expos
    using @\exposid{element-type}@ =                                                      // \expos
      remove_cvref_t<ranges::range_reference_t<@\exposid{maybe-const-map}@>>;
    range_formatter<@\exposid{element-type}@, charT> @\exposid{underlying_}@;                         // \expos
  public:
...
\rSec3[format.range.fmtset]{Specialization of \tcode{\exposid{range-default-formatter}} for sets}
...
namespace std {
  ...
  private:
    using @\exposid{maybe-const-set}@ = @\exposid{fmt-maybe-const}@<R, charT>;                          // \expos
...
\rSec3[format.range.fmtstr]{Specialization of \tcode{\exposid{range-default-formatter}} for strings}
