...
\begin{itemdescr}
\pnum\requires  \tcode{get() != nullptr}. % PS: should be: \tcode{get()} is dereferenceable.
...
\pnum
\postconditions \tcode{get() != nullptr \&\& use_count() == 1}
...
\begin{itemdescr}
\pnum
\requires \tcode{p != nullptr}. % PS: should be: \tcode{p} shall be dereferenceable.
