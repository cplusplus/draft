...
\pnum
For each \tcode{tuple} constructor, an exception is thrown if and only if the construction of
...
\pnum
For each \tcode{tuple} assignment operator, an exception is thrown if and only if the
