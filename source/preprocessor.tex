...
nor contain a \grammarterm{text-line}.
...
A \grammarterm{pp-module} whose first token is \tcode{export} shall not
appear in a context where \tcode{export}
is an identifier defined as an object-like macro.
...
is an identifier defined as an object-like macro.
A \grammarterm{pp-import} whose first token is \tcode{export} shall not
appear in a context where \tcode{export}
is an identifier defined as an object-like macro.
