%!TEX root = std.tex
\subclause0[cpp]{Preprocessing directives}%
...
\subclause1[cpp.cond]{Conditional inclusion}%
...
\subclause1[cpp.include]{Source file inclusion}
...
\subclause1[cpp.module]{Module directive}
...
\subclause1[cpp.import]{Header unit importation}
...
\subclause1[cpp.replace]{Macro replacement}%

\subclause2[cpp.replace.general]{General}%
...
\subclause2[cpp.subst]{Argument substitution}%
...
\subclause2[cpp.stringize]{The \tcode{\#} operator}%
\indextext{\#\#0 operator@\tcode{\#} operator}%
...
\subclause2[cpp.concat]{The \tcode{\#\#} operator}%
...
\subclause2[cpp.rescan]{Rescanning and further replacement}%
...
\subclause2[cpp.scope]{Scope of macro definitions}%
...
\subclause1[cpp.line]{Line control}%
...
\subclause1[cpp.error]{Error directive}%
...
\subclause1[cpp.pragma]{Pragma directive}%
...
\subclause1[cpp.null]{Null directive}%
...
\subclause1[cpp.predefined]{Predefined macro names}
...
\subclause1[cpp.pragma.op]{Pragma operator}%
