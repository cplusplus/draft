...
The preprocessing tokens comprising
the \grammarterm{pp-balanced-token-seq} of a \grammarterm{va-opt-replacement}
shall not contain \mname{VA_OPT}.
If the \grammarterm{pp-balanced-token-seq} would be ill-formed
...
the results of the expansion of the contained preprocessing tokens
as the replacement list of the current function-like macro
