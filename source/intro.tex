...
\indexdefn{name!unique}
\definition{unique name}{defns.unique}
name that is different from every other name in the program

\begin{defnote}
Such a name is suitably chosen by the implementation
so that the program cannot refer to the name.
\end{defnote}
