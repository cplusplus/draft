...
\subclause0[intro.refs]{Normative references}%
...
\subclause0[intro.defs]{Terms and definitions}
...
\subclause0[intro]{General principles}

\subclause1[intro.compliance]{Implementation compliance}%
...
\subclause2[intro.compliance.general]{General}
...
\subclause2[intro.abstract]{Abstract machine}
...
\subclause1[intro.structure]{Structure of this document}
...
\subclause1[syntax]{Syntax notation}
