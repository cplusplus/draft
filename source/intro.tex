...
\defncontext{non-template friend function with a trailing \grammarterm{requires-clause}}
name,
parameter-type-list\iref{dcl.fct},
enclosing class,
and
...
\defncontext{friend function template with one or more constraints involving enclosing template parameters}
name,
parameter-type-list\iref{dcl.fct},
return type,
enclosing class,
