...
\pnum
\returns
\tcode{substr(pos1, n1).compare(str.substr(pos2, n2))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{compare(basic_string_view(s))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{substr(pos1, n1).compare(basic_string_view(s))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{substr(pos1, n1).compare(basic_string_view(s, n2))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_string_view(data(), rlen) == x}.
\end{itemdescr}
...
\pnum
\returns
\tcode{starts_with(basic_string_view(x))}.
\end{itemdescr}
...
\pnum
\returns
\tcode{basic_string_view(data() + (size() - rlen), rlen) == x}.
\end{itemdescr}
...
\pnum
\returns
\tcode{ends_with(basic_string_view(x))}.
\end{itemdescr}
