...
\pnum
\effects
Equivalent to \tcode{basic_string<charT, traits, Allocator>(begin(), end())}.
...
\pnum
\effects
Equivalent to \tcode{substr(pos1, n1).compare(str)}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to \tcode{substr(pos1, n1).compare(str.substr(pos2, n2))}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to \tcode{compare(basic_string_view(s))}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to \tcode{substr(pos1, n1).compare(basic_string_view(s))}.
\end{itemdescr}
...
\pnum
\effects
Equivalent to \tcode{substr(pos1, n1).compare(basic_string_view(s, n2))}.
\end{itemdescr}
...
\end{codeblock}
is equivalent to \tcode{\placeholder{F}(basic_string_view(s), pos)}.
...
\end{codeblock}
is equivalent to \tcode{\placeholder{F}(basic_string_view(s, n), pos)}.
...
\end{codeblock}
is equivalent to \tcode{\placeholder{F}(basic_string_view(\&c, 1), pos)}.
...
\pnum
\effects
Equivalent to \tcode{os << str.to_string()}.
\end{itemdescr}
