%!TEX root = std.tex
\subclause0[strings]{Strings library}

\subclause1[strings.general]{General}
...
\subclause1[char.traits]{Character traits}

\subclause2[char.traits.general]{General}
...
\subclause2[char.traits.require]{Character traits requirements}
...
\subclause2[char.traits.typedefs]{Traits typedefs}
...
\subclause2[char.traits.specializations]{\tcode{char_traits} specializations}

\subclause3[char.traits.specializations.general]{General}
...
\subclause3[char.traits.specializations.char]{\tcode{struct char_traits<char>}}
...
\subclause3[char.traits.specializations.char8.t]{\tcode{struct char_traits<char8_t>}}
...
\subclause3[char.traits.specializations.char16.t]{\tcode{struct char_traits<char16_t>}}
...
\subclause3[char.traits.specializations.char32.t]{\tcode{struct char_traits<char32_t>}}
...
\subclause3[char.traits.specializations.wchar.t]{\tcode{struct char_traits<wchar_t>}}
...
\subclause1[string.classes]{String classes}

\subclause2[string.classes.general]{General}
...
\subclause2[string.syn]{Header \tcode{<string>} synopsis}
\indexheader{string}%
...
\subclause2[basic.string]{Class template \tcode{basic_string}}

\subclause3[basic.string.general]{General}
...
\subclause3[string.require]{General requirements}
...
\subclause3[string.cons]{Constructors and assignment operators}
...
\subclause3[string.iterators]{Iterator support}
...
\subclause3[string.capacity]{Capacity}
...
\subclause3[string.access]{Element access}
...
\subclause3[string.modifiers]{Modifiers}

\subclause4[string.op.append]{\tcode{basic_string::operator+=}}
...
\subclause4[string.append]{\tcode{basic_string::append}}
...
\subclause4[string.assign]{\tcode{basic_string::assign}}
...
\subclause4[string.insert]{\tcode{basic_string::insert}}
...
\subclause4[string.erase]{\tcode{basic_string::erase}}
...
\subclause4[string.replace]{\tcode{basic_string::replace}}
...
\subclause4[string.copy]{\tcode{basic_string::copy}}
...
\subclause4[string.swap]{\tcode{basic_string::swap}}
...
\subclause3[string.ops]{String operations}

\subclause4[string.accessors]{Accessors}
...
\subclause4[string.find]{Searching}
...
\subclause4[string.substr]{\tcode{basic_string::substr}}
...
\subclause4[string.compare]{\tcode{basic_string::compare}}
...
\subclause4[string.starts.with]{\tcode{basic_string::starts_with}}
...
\subclause4[string.ends.with]{\tcode{basic_string::ends_with}}
...
\subclause4[string.contains]{\tcode{basic_string::contains}}
...
\subclause2[string.nonmembers]{Non-member functions}

\indexlibraryglobal{basic_string}

\subclause3[string.op.plus]{\tcode{operator+}}
...
\subclause3[string.cmp]{Non-member comparison operator functions}
\begin{itemdecl}
template<class charT, class traits, class Allocator>
  constexpr bool
    operator==(const basic_string<charT, traits, Allocator>& lhs,
...
\subclause3[string.special]{\tcode{swap}}
...
\subclause3[string.io]{Inserters and extractors}
...
\subclause3[string.erasure]{Erasure}
...
\subclause2[string.conversions]{Numeric conversions}
...
\subclause2[basic.string.hash]{Hash support}
...
\subclause2[basic.string.literals]{Suffix for \tcode{basic_string} literals}
...
\subclause1[string.view]{String view classes}

\subclause2[string.view.general]{General}
...
\subclause2[string.view.synop]{Header \tcode{<string_view>} synopsis}
...
\subclause2[string.view.template]{Class template \tcode{basic_string_view}}

\subclause3[string.view.template.general]{General}
...
\subclause3[string.view.cons]{Construction and assignment}
...
\subclause3[string.view.iterators]{Iterator support}
...
\subclause3[string.view.capacity]{Capacity}
...
\subclause3[string.view.access]{Element access}
...
\subclause3[string.view.modifiers]{Modifiers}
...
\subclause3[string.view.ops]{String operations}
...
\subclause3[string.view.find]{Searching}
...
\subclause2[string.view.deduct]{Deduction guides}
...
\subclause2[string.view.comparison]{Non-member comparison functions}
...
\subclause2[string.view.io]{Inserters and extractors}
...
\subclause2[string.view.hash]{Hash support}
...
\subclause2[string.view.literals]{Suffix for \tcode{basic_string_view} literals}
...
\subclause1[c.strings]{Null-terminated sequence utilities}

\subclause2[cctype.syn]{Header \tcode{<cctype>} synopsis}
...
\subclause2[cwctype.syn]{Header \tcode{<cwctype>} synopsis}
...
\subclause2[cstring.syn]{Header \tcode{<cstring>} synopsis}
...
\subclause2[cwchar.syn]{Header \tcode{<cwchar>} synopsis}
...
\subclause2[cuchar.syn]{Header \tcode{<cuchar>} synopsis}
...
\subclause2[c.mb.wcs]{Multibyte / wide string and character conversion functions}
