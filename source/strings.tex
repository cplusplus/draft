...
\oldconcept{DefaultConstructible} (\tref{defaultconstructible}) requirements.
\end{itemdescr}
...
\rSec3[char.traits.specializations.char8_t]{\tcode{struct char_traits<char8_t>}}
...
the character traits requirements\iref{char.traits}, and
...
\begin{itemdescr}
\pnum
\effects Equivalent to: \tcode{return append(basic_string(n, c));}
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to: \tcode{return assign(basic_string(n, c));}
\end{itemdescr}
...
\begin{itemdescr}
\pnum
\effects Equivalent to: \tcode{return replace(pos1, n1, basic_string(n2, c));}
\end{itemdescr}
...
\pnum
\effects
Constructs a \tcode{basic_string_view}, with the postconditions in \tref{string.view.ctr.3}.
...
of a contiguous iterator\iref{iterator.requirements.general}
...
\end{codeblock}
is equivalent to \tcode{return \placeholder{F}(basic_string_view(addressof(c), 1), pos);}
