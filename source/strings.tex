...
\impldef{return value of \tcode{char\_traits<char16\_t>::eof}} constant that cannot appear
...
\pnum
The member \tcode{eof()} shall return an
\impldef{return value of \tcode{char\_traits<char32\_t>::eof}} constant that cannot appear as a Unicode
code point.
...
namespace std {
  ...
  public:
    ...
    using iterator               = @\impdefx{type of \tcode{basic\_string::iterator}}@; // see \ref{container.requirements}
    using const_iterator         = @\impdefx{type of \tcode{basic\_string::const\_iterator}}@; // see \ref{container.requirements}
...
public:
  ...
  using const_iterator         = @\impdefx{type of \tcode{basic\_string\_view::const\_iterator}}@; // see \ref{string.view.iterators}
...
\begin{itemdecl}
using const_iterator = @\impdefx{type of \tcode{basic\_string\_view::const\_iterator}}@;
\end{itemdecl}
