...
\begin{example}
\begin{codeblock}
// deprecated: a volatile return type has no meaning to the caller.
volatile amber jurassic();
// The volatile left_arm and right_arm parameter are useless to the caller.
...
void (linhenykus alvarezsauroid) {
  auto& [what_is_this] = alvarezsauroid; // deprecated: very confusing
  // ...
}
\end{codeblock}
\end{example}
