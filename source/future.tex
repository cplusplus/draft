...
\subclause1[depr.general]{General}
...
\subclause1[depr.arith.conv.enum]{Arithmetic conversion on enumerations}
...
\subclause1[depr.capture.this]{Implicit capture of \tcode{*this} by reference}
...
\subclause1[depr.comma.subscript]{Comma operator in subscript expressions}
...
\subclause1[depr.array.comp]{Array comparisons}
...
\subclause1[depr.volatile.type]{Deprecated \tcode{volatile} types}
...
\subclause1[depr.static.constexpr]{Redeclaration of \tcode{static constexpr} data members}
...
\subclause1[depr.local]{Non-local use of TU-local entities}
...
\subclause1[depr.impldec]{Implicit declaration of copy functions}
...
\subclause1[depr.template.template]{\tcode{template} keyword before qualified names}
...
\subclause1[depr.c.headers]{C headers}

\subclause2[depr.c.headers.general]{General}
...
\subclause2[depr.complex.h.syn]{Header \tcode{<complex.h>} synopsis}
...
\subclause2[depr.iso646.h.syn]{Header \tcode{<iso646.h>} synopsis}
...
\subclause2[depr.stdalign.h.syn]{Header \tcode{<stdalign.h>} synopsis}
...
\subclause2[depr.stdbool.h.syn]{Header \tcode{<stdbool.h>} synopsis}
...
\subclause2[depr.tgmath.h.syn]{Header \tcode{<tgmath.h>} synopsis}
...
\subclause2[depr.c.headers.other]{Other C headers}
...
\subclause1[depr.res.on.required]{Requires paragraph}
...
\subclause1[depr.relops]{Relational operators}%
...
\subclause1[depr.str.strstreams]{\tcode{char*} streams}

\subclause2[depr.strstream.syn]{Header \tcode{<strstream>} synopsis}
...
\subclause2[depr.strstreambuf]{Class \tcode{strstreambuf}}

\subclause3[depr.strstreambuf.general]{General}
...
\subclause3[depr.strstreambuf.cons]{\tcode{strstreambuf} constructors}
...
\subclause3[depr.strstreambuf.members]{Member functions}
...
\subclause3[depr.strstreambuf.virtuals]{\tcode{strstreambuf} overridden virtual functions}
...
\subclause2[depr.istrstream]{Class \tcode{istrstream}}

\subclause3[depr.istrstream.general]{General}
...
\subclause3[depr.istrstream.cons]{\tcode{istrstream} constructors}
...
\subclause3[depr.istrstream.members]{Member functions}
...
\subclause2[depr.ostrstream]{Class \tcode{ostrstream}}

\subclause3[depr.ostrstream.general]{General}
...
\subclause3[depr.ostrstream.cons]{\tcode{ostrstream} constructors}
...
\subclause3[depr.ostrstream.members]{Member functions}
...
\subclause2[depr.strstream]{Class \tcode{strstream}}

\subclause3[depr.strstream.general]{General}
...
\subclause3[depr.strstream.cons]{\tcode{strstream} constructors}
...
\subclause3[depr.strstream.dest]{\tcode{strstream} destructor}
...
\subclause3[depr.strstream.oper]{\tcode{strstream} operations}
...
\subclause1[depr.default.allocator]{The default allocator}
...
\subclause1[depr.mem.poly.allocator.mem]{Deprecated \tcode{polymorphic_allocator} member function}
...
\subclause1[depr.meta.types]{Deprecated type traits}
...
\subclause1[depr.variant]{Variant}
...
\subclause1[depr.iterator]{Deprecated \tcode{iterator} class template}
...
\subclause1[depr.move.iter.elem]{Deprecated \tcode{move_iterator} access}
...
\subclause1[depr.util.smartptr.shared.atomic]{Deprecated \tcode{shared_ptr} atomic access}
...
\subclause1[depr.string.capacity]{Deprecated \tcode{basic_string} capacity}
...
\subclause1[depr.locale.stdcvt]{Deprecated standard code conversion facets}

\subclause2[depr.locale.stdcvt.general]{General}

\pnum
The header \libheaderdef{codecvt} provides
code conversion facets for various character encodings.

\subclause2[depr.codecvt.syn]{Header \tcode{<codecvt>} synopsis}
...
\subclause2[depr.locale.stdcvt.req]{Requirements}
...
\subclause1[depr.conversions]{Deprecated convenience conversion interfaces}

\subclause2[depr.conversions.general]{General}
...
\subclause2[depr.conversions.string]{Class template \tcode{wstring_convert}}
...
\subclause2[depr.conversions.buffer]{Class template \tcode{wbuffer_convert}}
...
\subclause1[depr.locale.category]{Deprecated locale category facets}
...
\subclause1[depr.fs.path.factory]{Deprecated filesystem path factory functions}
...
\subclause1[depr.atomics]{Deprecated atomic operations}

\subclause2[depr.atomics.general]{General}
...
\subclause2[depr.atomics.volatile]{Volatile access}
...
\subclause2[depr.atomics.nonmembers]{Non-member functions}
...
\subclause2[depr.atomics.types.operations]{Operations on atomic types}
...
\subclause2[depr.atomics.flag]{Flag type and operations}
