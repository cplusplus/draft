...
%WORDINGTODO: SY, JMB: We need to produce an example for this case.
...
%WORDINGTODO: JMB: produce an example
...
%WORDINGTODO: JMB: Someone should confirm that the comments correctly describe why
