...
\rSec4[ifndr.constr.atomic]{Atomic constraints}
...
\rSec4[ifndr.temp.spec.partial]{Partial specialization}
...
\rSec3[ifndr.temp.names]{Names of template specializations}
...
\rSec4[ifndr.temp.res.general]{General}
