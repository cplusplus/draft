...
decltype(f()) g();
auto x = g();   // IFNDR, function \tcode{g} is used but not defined in this translation unit,
...
template<typename V> concept C = B<V&>; // IFNDR, it would form the invalid type V\&* in the parameter mapping
\end{codeblock}
\end{example}
