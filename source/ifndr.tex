...
that is
\begin{itemize}
\item not defined by an injected declaration\iref{expr.const.reflect},
\item not an inline or templated function or variable, and
\item are not attached to a named module or are not reachable from one another,
\end{itemize}
