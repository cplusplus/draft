...
\subclause1[temp.param]{Template parameters}
...
\subclause1[temp.names]{Names of template specializations}
...
\subclause1[temp.arg]{Template arguments}

\subclause2[temp.arg.general]{General}
...
\subclause2[temp.arg.type]{Template type arguments}
...
\subclause2[temp.arg.nontype]{Template non-type arguments}
...
\subclause2[temp.arg.template]{Template template arguments}
...
\subclause1[temp.constr]{Template constraints}

\subclause2[temp.constr.general]{General}
...
\subclause2[temp.constr.constr]{Constraints}

\subclause3[temp.constr.constr.general]{General}
...
\subclause3[temp.constr.op]{Logical operations}
...
\subclause3[temp.constr.atomic]{Atomic constraints}
...
\subclause2[temp.constr.decl]{Constrained declarations}
...
\subclause2[temp.constr.normal]{Constraint normalization}
...
\subclause2[temp.constr.order]{Partial ordering by constraints}
...
\subclause1[temp.type]{Type equivalence}
...
\subclause1[temp.decls]{Template declarations}

\subclause2[temp.decls.general]{General}
...
\subclause2[temp.class]{Class templates}

\subclause3[temp.class.general]{General}
...
\subclause3[temp.mem.func]{Member functions of class templates}
...
\subclause3[temp.deduct.guide]{Deduction guides}
...
\subclause3[temp.mem.class]{Member classes of class templates}
...
\subclause3[temp.static]{Static data members of class templates}
...
\subclause3[temp.mem.enum]{Enumeration members of class templates}
...
\subclause2[temp.mem]{Member templates}
...
\subclause2[temp.variadic]{Variadic templates}
...
\subclause2[temp.friend]{Friends}
...
\subclause2[temp.spec.partial]{Partial specialization}

\subclause3[temp.spec.partial.general]{General}
...
\subclause3[temp.spec.partial.match]{Matching of partial specializations}
...
\subclause3[temp.spec.partial.order]{Partial ordering of partial specializations}
...
\subclause3[temp.spec.partial.member]{Members of class template partial specializations}
...
\subclause2[temp.fct]{Function templates}

\subclause3[temp.fct.general]{General}
...
\subclause3[temp.over.link]{Function template overloading}
...
\subclause3[temp.func.order]{Partial ordering of function templates}
...
\subclause2[temp.alias]{Alias templates}
...
\subclause2[temp.concept]{Concept definitions}
...
\subclause1[temp.res]{Name resolution}

\subclause2[temp.res.general]{General}
...
\subclause2[temp.local]{Locally declared names}
...
\subclause2[temp.dep]{Dependent names}

\subclause3[temp.dep.general]{General}
...
\subclause3[temp.dep.type]{Dependent types}
...
\subclause3[temp.dep.expr]{Type-dependent expressions}
...
\subclause3[temp.dep.constexpr]{Value-dependent expressions}
...
\subclause3[temp.dep.temp]{Dependent template arguments}
...
\subclause2[temp.dep.res]{Dependent name resolution}
\subclause3[temp.point]{Point of instantiation}
...
\subclause3[temp.dep.candidate]{Candidate functions}
...
\subclause1[temp.spec]{Template instantiation and specialization}

\subclause2[temp.spec.general]{General}
...
\subclause2[temp.inst]{Implicit instantiation}
...
\subclause2[temp.explicit]{Explicit instantiation}
...
\subclause2[temp.expl.spec]{Explicit specialization}
...
\subclause1[temp.fct.spec]{Function template specializations}

\subclause2[temp.fct.spec.general]{General}
...
\subclause2[temp.arg.explicit]{Explicit template argument specification}
...
\subclause2[temp.deduct]{Template argument deduction}

\subclause3[temp.deduct.general]{General}
...
\subclause3[temp.deduct.call]{Deducing template arguments from a function call}
...
\subclause3[temp.deduct.funcaddr]{Deducing template arguments taking the address of a function template}
...
\subclause3[temp.deduct.conv]{Deducing conversion function template arguments}
...
\subclause3[temp.deduct.partial]{Deducing template arguments during partial ordering}
...
\subclause3[temp.deduct.type]{Deducing template arguments from a type}
...
\subclause3[temp.deduct.decl]{Deducing template arguments from a function declaration}
...
\subclause2[temp.over]{Overload resolution}
