...
\begin{itemize}
\item
\tcode{A} denotes a class template, an alias template, or a type template template parameter and
\tcode{P} is a type template template parameter,
\item
\tcode{A} denotes a variable template or a variable template template parameter and
\tcode{P} is a variable template template parameter, or
\item
\tcode{A} denotes a concept or a concept template parameter and
