...
\pnum
The inline, constexpr, and consteval properties of
an explicit specialization of a function or variable template
are determined by the explicit specialization and
are independent of those properties of the template.
\begin{example}
\begin{codeblock}
