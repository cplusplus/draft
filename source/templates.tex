...
\pnum
A non-type \grammarterm{template-parameter} shall not be declared to have
floating point, class, array of runtime bound, or void type.
\enterexample
...
\pnum
Except for inline functions, \tcode{const} variables of literal types,
