...
shall be satisfied\iref{temp.constr.constr}\ifndrdef{temp.names.sat.constraints}.
\begin{example}
\begin{codeblock}
...
program; otherwise the program is ill-formed, no diagnostic requiredi\ifndrdef{temp.explicit.decl.implicit.inst}.
\begin{note}
