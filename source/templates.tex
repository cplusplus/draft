...
\item
it names a static data member of the current instantiation that is not initialized in a \grammarterm{member-declarator},
\item
...
\pnum
An expression of the form \tcode{\&}\grammarterm{qualified-id} where the \grammarterm{qualified-id}{'s} \grammarterm{nested-name-specifier} names the current instantiation is value-dependent.
