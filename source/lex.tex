...
\item
\grammarterm{exception-declaration}\iref{except.pre},
\item
...
\item
\grammarterm{member-declarator}\iref{class.mem}, or
\item
...
linkage of the name specified in each translation unit.
