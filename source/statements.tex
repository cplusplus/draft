...
\nontermdef{iteration-statement}\br
    ...
    \terminal{for (} for-init-statement\opt \terminal{;} condition\opt \terminal{;} expression\opt \terminal{)} statement\br
...
\begin{ncbnf}
\terminal{for (} for-init-statement\opt \terminal{;} condition\opt \terminal{;} expression\opt \terminal{)} statement
\end{ncbnf}
...
\begin{ncbnf}
\terminal{for (} for-range-declaration \terminal{:} expression \terminal{)} statement
\end{ncbnf}
...
\pnum
The \grammarterm{expression} or \grammarterm{braced-init-list}
