...
a constructor,
a destructor, or
a function that is not a coroutine with a \cv{}~\tcode{void} return type is
...
and \placeholder{P} be the type of that object, 
then a \tcode{co_return} statement is equivalent to:
\begin{ncsimplebnf}
\terminal{\{} S\terminal{; goto} final-suspend\terminal{; \}}
\end{ncsimplebnf}

where \placeholdernc{final-suspend} is as defined in\iref{dcl.fct.def.coroutine}
