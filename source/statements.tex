...
an integral or enumeration type. If the (possibly converted) type is
subject to integral promotions (\ref{conv.prom}), the condition is
converted to the promoted type.  Any
