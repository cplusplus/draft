...
The operand can be moved instead of copied; see \ref{dcl.init}.
The copy or move operation can be elided
as specified in \ref{class.copy.elision}.
\end{note}
\begin{example}
\begin{codeblock}
...
see \ref{expr.call} and \ref{dcl.init}.
\end{note}
