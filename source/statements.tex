%!TEX root = std.tex
\subclause0[stmt.stmt]{Statements}%
\indextext{statement|(}
...
\subclause1[stmt.label]{Labeled statement}%
...
\subclause1[stmt.expr]{Expression statement}%
...
\subclause1[stmt.block]{Compound statement or block}%
...
\subclause1[stmt.select]{Selection statements}%

\subclause2[stmt.select.general]{General}%
...
\subclause2[stmt.if]{The \tcode{if} statement}%
\indextext{statement!\idxcode{if}}
...
\subclause2[stmt.switch]{The \tcode{switch} statement}%
\indextext{statement!\idxcode{switch}}
...
\subclause1[stmt.iter]{Iteration statements}%

\subclause2[stmt.iter.general]{General}%
...
\subclause2[stmt.while]{The \tcode{while} statement}%
\indextext{statement!\idxcode{while}}
...
\subclause2[stmt.do]{The \tcode{do} statement}%
\indextext{statement!\idxcode{do}}
...
\subclause2[stmt.for]{The \tcode{for} statement}%
\indextext{statement!\idxcode{for}}
...
\subclause2[stmt.ranged]{The range-based \tcode{for} statement}%
...
\subclause1[stmt.jump]{Jump statements}%

\subclause2[stmt.jump.general]{General}%
...
\subclause2[stmt.break]{The \tcode{break} statement}%
\indextext{statement!\idxcode{break}}
...
\subclause2[stmt.cont]{The \tcode{continue} statement}%
\indextext{statement!\idxcode{continue}}
...
\subclause2[stmt.return]{The \tcode{return} statement}%
\indextext{\idxcode{return}}%
...
\subclause2[stmt.return.coroutine]{The \tcode{co_return} statement}%
...
\subclause2[stmt.goto]{The \tcode{goto} statement}%
\indextext{statement!\idxcode{goto}}
...
\subclause1[stmt.dcl]{Declaration statement}%
...
\subclause1[stmt.ambig]{Ambiguity resolution}%
