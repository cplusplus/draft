...
that cannot represent the value is undefined behavior.
...
the bit-width of a type is undefined behavior.
...
\pnum
Invoking \tcode{destroy()} on a coroutine that is not suspended is undefined behavior.
...
in an abstract class is undefined behavior.
...
\pnum
It is undefined behavior to call a member function
before all the \grammarterm{mem-initializer}s for base classes have completed.
...
construction must have started and destruction must not have finished,
