...
#include <limits>
int main() {
  // Assuming $32$-bit \tcode{int} the range of values are: $-2,147,483,648$ to $2,147,483,647$
...
int main() {
  ...
  float f = d2; // undefined behavior on systems where the range of representable values
                ...
                // values are \tcode{[-inf,+inf]} this would not be undefined behavior
...
int main() {
  // Assuming $32$-bit \tcode{int} the range of values are: $-2,147,483,648$ to
...
int main() {
  ...
  double d = 1.0 / 0.0; // undefined behavior on systems where the range of
                        ...
                        // representable values are \tcode{[-inf,+inf]} this would not be undefined behavior
}
\end{codeblock}
\end{example}
