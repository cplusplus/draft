...
\rSec2[ub.basic.memobj]{Memory and objects}

\rSec3[ub.intro.object]{Object model}
...
%TODO: SY: These comments feel too loose.
%Shouldn't we be saying something along the lines of p1 points to an
%object of type X whose lifetime was started but not ended .... p2
%points to an object of type Y but its lifetime was not started ..."

\rSec3[ub.basic.align]{Alignment}
...
\rSec3[ub.basic.indet]{Indeterminate and erroneous values}
...
\rSec3[ub.basic.stc]{Storage duration}

\rSec4[ub.basic.stc.dynamic]{Dynamic storage duration}

\rSec5[ub.basic.stc.dynamic.general]{General}
...
\rSec5[ub.basic.stc.dynamic.deallocation]{Deallocation functions}
...
\rSec5[ub.basic.stc.dynamic.allocation]{Allocation functions}
...
\rSec2[ub.basic.types]{Types}

\rSec3[ub.basic.compound]{Compound types}
...
\rSec2[ub.basic.exec]{Program execution}

\rSec3[ub.intro.execution]{Sequential execution}
...
\rSec3[ub.intro.multithread]{Multi-threaded executions and data races}

\rSec4[ub.intro.races]{Data races}
...
\rSec4[ub.intro.progress]{Forward progress}
...
\rSec3[ub.basic.start]{Start and termination}

\rSec4[ub.basic.start.main]{\tcode{main} function}
...
\rSec4[ub.basic.start.term]{Termination}
...
C c;
B b;    // call to `f()` in constructor begins lifetime of \tcode{a}
...
%TODO: JMB/TD: This is really a general precondition imposed on the Standard
%Library, not a piece of core language undefined behavior.  It is also currently
%missing an example.  Should we retain this UB?  Should we have a core issue
%to move this wording into the library section somewhere?
%TODO: SY: If we keep this, we should have an example.

\rSec1[ub.expr]{\ref{expr}: Expressions}
\rSec2[ub.expr.pre]{Preamble}
...
\rSec2[ub.expr.prop]{Properties of expressions}

\rSec3[ub.basic.lval]{Value category}
...
defaulted copy/move assignment
...
\rSec2[ub.conv]{Standard conversions}

\rSec3[ub.conv.lval]{Lvalue-to-rvalue conversion}
...
\rSec3[ub.conv.double]{Floating-point conversions}
...
\rSec3[ub.conv.fpint]{Floating-integral conversions}
...
\rSec3[ub.conv.ptr]{Pointer conversions}
...
\rSec3[ub.conv.mem]{Pointer-to-member conversions}
...
\rSec2[ub.expr.compound]{Compound expressions}

\rSec3[ub.expr.post]{Postfix expressions}

\rSec4[ub.expr.call]{Function call}
...
\rSec4[ub.expr.ref]{Class member access}
...
%TODO: SY: The wording is not great, I don't have a good suggestion but we should
%get some opinions

\rSec4[ub.expr.dynamic.cast]{Dynamic cast}
...
\rSec4[ub.expr.static.cast]{Static cast}
...
\rSec3[ub.expr.unary]{Unary expressions}

\rSec4[ub.expr.unary.op]{Unary operators}
...
type and the selected deallocation function is not a destroying operator delete, the static type
...
\rSec3[ub.expr.mptr.oper]{Pointer-to-member operators}
...
\rSec3[ub.expr.mul]{Multiplicative operators}
...
\rSec3[ub.expr.add]{Additive operators}
...
if P or Q have type ``pointer to cv T'', where T and the array
...
\rSec3[ub.expr.shift]{Shift operators}
...
\rSec3[ub.expr.assign]{Assignment and compound assignment operators}
...
\rSec2[ub.stmt.jump]{Jump statements}

\rSec3[ub.stmt.return]{The \keyword{return} statement}

\pnum
\ubxref{stmt.return.flow.off}
Flowing off the end of a function other
than main or a coroutine results in undefined behavior if the return type
...
\rSec3[ub.stmt.return.coroutine]{The \keyword{co_return} statement}

\pnum
\ubxref{stmt.return.coroutine.flow.off}
Flowing off the end of a coroutine function body
that does not return void
has undefined behavior.
...
\rSec2[ub.dcl.spec]{Specifiers}

\rSec3[ub.dcl.type]{Type specifiers}

\rSec4[ub.dcl.type.cv]{The \fakegrammarterm{cv-qualifier}{s}}
...
\rSec2[ub.dcl.decl]{Declarators}

\rSec3[ub.dcl.meaning]{Meaning of declarators}

\rSec4[ub.dcl.ref]{References}
...
\rSec2[ub.dcl.fct.def]{Function definitions}

\rSec3[ub.dcl.fct.def.coroutine]{Coroutine definitions}
...
\rSec2[ub.dcl.attr]{Attributes}

\rSec3[ub.dcl.attr.assume]{Assumption attribute}
...
\rSec3[ub.dcl.attr.noreturn]{Noreturn attribute}
...
\rSec2[ub.class.mem]{Class members}

\rSec3[ub.class.dtor]{Destructors}
...
\rSec2[ub.class.derived]{Derived classes}

\rSec3[ub.class.abstract]{Abstract classes}
...
\rSec2[ub.class.init]{Initialization}

\rSec3[ub.class.base.init]{Initializing bases and members}
...
\rSec3[ub.class.cdtor]{Construction and destruction}
...
%TODO: CM: Can this example be shortened?
...
\rSec2[ub.temp.spec]{Template instantiation and specialization}

\rSec3[ub.temp.inst]{Implicit instantiation}
