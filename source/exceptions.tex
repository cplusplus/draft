...
A \tcode{(} token that follows \tcode{noexcept} is part of the \grammarterm{noexcept-specification}
(and does not commence an \grammarterm{initializer} (\ref{dcl.init})).
