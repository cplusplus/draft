%!TEX root = std.tex
\subclause0[except]{Exception handling}%
...
\subclause1[except.pre]{Preamble}
...
\subclause1[except.throw]{Throwing an exception}%
...
\subclause1[except.ctor]{Constructors and destructors}%
...
\subclause1[except.handle]{Handling an exception}
\indextext{exception handling!handler|(}%
...
\subclause1[except.spec]{Exception specifications}%
...
\subclause1[except.special]{Special functions}

\subclause2[except.special.general]{General}
...
\subclause2[except.terminate]{The \tcode{std::terminate} function}
...
\subclause2[except.uncaught]{The \tcode{std::uncaught_exceptions} function}%
