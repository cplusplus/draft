...
\pnum
Throwing an exception copy-initializes\iref{dcl.init} a temporary object,
called the \defnx{exception object}{exception handling!exception object}.
\begin{note}
The operand of a \grammarterm{throw-expression}
might be moved instead of copied; see \ref{dcl.init}.
