%!TEX root = std.tex
\subclause0[thread]{Thread support library}

\subclause1[thread.general]{General}
...
\subclause1[thread.req]{Requirements}

\subclause2[thread.req.paramname]{Template parameter names}
...
\subclause2[thread.req.exception]{Exceptions}
...
\subclause2[thread.req.native]{Native handles}
...
\subclause2[thread.req.timing]{Timing specifications}
...
\subclause2[thread.req.lockable]{Requirements for \oldconcept{Lockable} types}

\subclause3[thread.req.lockable.general]{In general}
...
\subclause3[thread.req.lockable.basic]{\oldconcept{BasicLockable} requirements}
...
\subclause3[thread.req.lockable.req]{\oldconcept{Lockable} requirements}
...
\subclause3[thread.req.lockable.timed]{\oldconcept{TimedLockable} requirements}
...
\subclause3[thread.req.lockable.shared]{\oldconcept{SharedLockable} requirements}
...
\subclause3[thread.req.lockable.shared.timed]{\oldconcept{SharedTimedLockable} requirements}
...
\subclause1[thread.stoptoken]{Stop tokens}

\subclause2[thread.stoptoken.intro]{Introduction}
...
\subclause2[thread.stoptoken.syn]{Header \tcode{<stop_token>} synopsis}
...
\subclause2[stoptoken]{Class \tcode{stop_token}}%
\indexlibraryglobal{stop_token}%

\subclause3[stoptoken.general]{General}
...
\subclause3[stoptoken.cons]{Constructors, copy, and assignment}
...
\subclause3[stoptoken.mem]{Members}
...
\subclause3[stoptoken.nonmembers]{Non-member functions}
...
\subclause2[stopsource]{Class \tcode{stop_source}}%
\indexlibraryglobal{stop_source}%

\subclause3[stopsource.general]{General}
...
\subclause3[stopsource.cons]{Constructors, copy, and assignment}
...
\subclause3[stopsource.mem]{Members}
...
\subclause3[stopsource.nonmembers]{Non-member functions}
...
\subclause2[stopcallback]{Class template \tcode{stop_callback}}%
\indexlibraryglobal{stop_callback}%

\subclause3[stopcallback.general]{General}
...
\subclause3[stopcallback.cons]{Constructors and destructor}
...
\subclause1[thread.threads]{Threads}

\subclause2[thread.threads.general]{General}
...
\subclause2[thread.syn]{Header \tcode{<thread>} synopsis}
...
\subclause2[thread.thread.class]{Class \tcode{thread}}

\subclause3[thread.thread.class.general]{General}
...
\subclause3[thread.thread.id]{Class \tcode{thread::id}}
...
\subclause3[thread.thread.constr]{Constructors}
...
\subclause3[thread.thread.destr]{Destructor}
...
\subclause3[thread.thread.assign]{Assignment}
...
\subclause3[thread.thread.member]{Members}
...
\subclause3[thread.thread.static]{Static members}
...
\subclause3[thread.thread.algorithm]{Specialized algorithms}
...
\subclause2[thread.jthread.class]{Class \tcode{jthread}}

\subclause3[thread.jthread.class.general]{General}
...
\subclause3[thread.jthread.cons]{Constructors, move, and assignment}
...
\subclause3[thread.jthread.mem]{Members}
...
\subclause3[thread.jthread.stop]{Stop token handling}
...
\subclause3[thread.jthread.special]{Specialized algorithms}
...
\subclause3[thread.jthread.static]{Static members}
...
\subclause2[thread.thread.this]{Namespace \tcode{this_thread}}
...
\subclause1[thread.mutex]{Mutual exclusion}

\subclause2[thread.mutex.general]{General}
...
\subclause2[mutex.syn]{Header \tcode{<mutex>} synopsis}
...
\subclause2[shared.mutex.syn]{Header \tcode{<shared_mutex>} synopsis}
...
\subclause2[thread.mutex.requirements]{Mutex requirements}

\subclause3[thread.mutex.requirements.general]{In general}
...
\subclause3[thread.mutex.requirements.mutex]{Mutex types}

\subclause4[thread.mutex.requirements.mutex.general]{General}
...
\subclause4[thread.mutex.class]{Class \tcode{mutex}}
...
\subclause4[thread.mutex.recursive]{Class \tcode{recursive_mutex}}
...
\subclause3[thread.timedmutex.requirements]{Timed mutex types}

\subclause4[thread.timedmutex.requirements.general]{General}
...
\subclause4[thread.timedmutex.class]{Class \tcode{timed_mutex}}
...
\subclause4[thread.timedmutex.recursive]{Class \tcode{recursive_timed_mutex}}
...
\subclause3[thread.sharedmutex.requirements]{Shared mutex types}

\subclause4[thread.sharedmutex.requirements.general]{General}
...
\subclause4[thread.sharedmutex.class]{Class \tcode{shared_mutex}}
...
\subclause3[thread.sharedtimedmutex.requirements]{Shared timed mutex types}

\subclause4[thread.sharedtimedmutex.requirements.general]{General}
...
\subclause4[thread.sharedtimedmutex.class]{Class \tcode{shared_timed_mutex}}
...
\subclause2[thread.lock]{Locks}

\subclause3[thread.lock.general]{General}
...
\subclause3[thread.lock.guard]{Class template \tcode{lock_guard}}
...
\subclause3[thread.lock.scoped]{Class template \tcode{scoped_lock}}
...
\subclause3[thread.lock.unique]{Class template \tcode{unique_lock}}

\subclause4[thread.lock.unique.general]{General}
...
\subclause4[thread.lock.unique.cons]{Constructors, destructor, and assignment}
...
\subclause4[thread.lock.unique.locking]{Locking}
...
\subclause4[thread.lock.unique.mod]{Modifiers}
...
\subclause4[thread.lock.unique.obs]{Observers}
...
\subclause3[thread.lock.shared]{Class template \tcode{shared_lock}}

\subclause4[thread.lock.shared.general]{General}
...
\subclause4[thread.lock.shared.cons]{Constructors, destructor, and assignment}
...
\subclause4[thread.lock.shared.locking]{Locking}
...
\subclause4[thread.lock.shared.mod]{Modifiers}
...
\subclause4[thread.lock.shared.obs]{Observers}
...
\subclause2[thread.lock.algorithm]{Generic locking algorithms}
...
\subclause2[thread.once]{Call once}

\subclause3[thread.once.onceflag]{Struct \tcode{once_flag}}
...
\subclause3[thread.once.callonce]{Function \tcode{call_once}}
...
\subclause1[thread.condition]{Condition variables}

\subclause2[thread.condition.general]{General}
...
\subclause2[condition.variable.syn]{Header \tcode{<condition_variable>} synopsis}
...
\subclause2[thread.condition.nonmember]{Non-member functions}
...
\subclause2[thread.condition.condvar]{Class \tcode{condition_variable}}
...
\subclause2[thread.condition.condvarany]{Class \tcode{condition_variable_any}}

\subclause3[thread.condition.condvarany.general]{General}
...
\subclause3[thread.condvarany.wait]{Noninterruptible waits}
...
\subclause3[thread.condvarany.intwait]{Interruptible waits}
...
\subclause1[thread.sema]{Semaphore}

\subclause2[thread.sema.general]{General}
...
\subclause2[semaphore.syn]{Header \tcode{<semaphore>} synopsis}
...
\subclause2[thread.sema.cnt]{Class template \tcode{counting_semaphore}}
...
\subclause1[thread.coord]{Coordination types}

\subclause2[thread.coord.general]{General}
...
\subclause2[thread.latch]{Latches}

\subclause3[thread.latch.general]{General}
...
\subclause3[latch.syn]{Header \tcode{<latch>} synopsis}
...
\subclause3[thread.latch.class]{Class \tcode{latch}}
...
\subclause2[thread.barrier]{Barriers}

\subclause3[thread.barrier.general]{General}
...
\subclause3[barrier.syn]{Header \tcode{<barrier>} synopsis}
...
\subclause3[thread.barrier.class]{Class template \tcode{barrier}}
...
\subclause1[futures]{Futures}

\subclause2[futures.overview]{Overview}
...
\subclause2[future.syn]{Header \tcode{<future>} synopsis}
...
\subclause2[futures.errors]{Error handling}
...
\subclause2[futures.future.error]{Class \tcode{future_error}}
...
\subclause2[futures.state]{Shared state}
...
\subclause2[futures.promise]{Class template \tcode{promise}}
...
\subclause2[futures.unique.future]{Class template \tcode{future}}
...
\subclause2[futures.shared.future]{Class template \tcode{shared_future}}
...
\subclause2[futures.async]{Function template \tcode{async}}
...
\subclause2[futures.task]{Class template \tcode{packaged_task}}

\subclause3[futures.task.general]{General}
...
\subclause3[futures.task.members]{Member functions}
...
\subclause3[futures.task.nonmembers]{Globals}
