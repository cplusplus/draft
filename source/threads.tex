...
\pnum
\constraints
\tcode{Callback} and \tcode{C} satisfy \libconcept{constructible_from<Callback, C>}.

\pnum
\expects
\tcode{Callback} and \tcode{C} model \libconcept{constructible_from<Callback, C>}.
...
\indexlibrary{\idxcode{counting_semaphore}!constructor}%
\begin{itemdecl}
constexpr explicit counting_semaphore(ptrdiff_t desired);
\end{itemdecl}
...
\indexlibrary{\idxcode{latch}!constructor}%
\begin{itemdecl}
constexpr explicit latch(ptrdiff_t expected);
\end{itemdecl}
