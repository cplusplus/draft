%!TEX root = std.tex
\subclause0[module]{Modules}%

\gramSec[gram.module]{Modules}

\subclause1[module.unit]{Module units and purviews}
...
\subclause1[module.interface]{Export declaration}%
...
\subclause1[module.import]{Import declaration}%
...
\subclause1[module.global.frag]{Global module fragment}
...
\subclause1[module.private.frag]{Private module fragment}
...
\subclause1[module.context]{Instantiation context}
...
\subclause1[module.reach]{Reachability}
