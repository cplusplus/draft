...
no diagnostic is required\ifndrdef{module.unit.reserved.identifiers}.
...
no diagnostic is required\ifndrdef{module.unit.named.module.no.partition}.
...
for a violation of these rules\ifndrdef{module.unit.unexported.module.partition}.
\begin{note}
...
the lookup for \tcode{\keyword{operator}!=}
when considering whether an \tcode{\keyword{operator}==} is a
rewrite target\iref{over.match.oper}.
\end{note}
...
no diagnostic is required\ifndrdef{module.private.frag.other.module.units}.
